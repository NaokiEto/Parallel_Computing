...
\-This program gets the \-V\-T\-K file, divides up it up, and performs \-M\-P\-I. \-It convert each piece to metaimage data so that vtk\-Marching\-Cubes class can be applied, apply marching cubes to each process, outputs the resulting vtk data as temporary files, and then conglomerates the data in the temporary files into 1 vtk file.  
...
\-This program gets the \-V\-T\-K file, divides up it up, and performs \-M\-P\-I. \-It convert each piece to metaimage data so that vtk\-Marching\-Cubes class can be applied, apply marching cubes to each process, outputs the resulting vtk data as temporary files, and then conglomerates the data in the temporary files into 1 vtk file. \-Do whatever you want with public license \-Version 1, \-August 11, 2013
