...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkExodusIICache(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkExodusIICache(PyObject *, const char *); }
#endif
...
extern PyTypeObject PyvtkExodusIICacheKey_Type;
...
static PyMethodDef PyvtkExodusIICacheEntry_Methods[] = {
  {(char*)"GetValue", PyvtkExodusIICacheEntry_GetValue, 1,
   (char*)"V.GetValue() -> vtkDataArray\nC++: vtkDataArray *GetValue()\n\n"},
  {NULL, NULL, 0, NULL}
};

#ifndef DECLARED_PyvtkExodusIICacheEntry_Type
extern PyTypeObject PyvtkExodusIICacheEntry_Type;
...
static PyMethodDef PyvtkExodusIICacheEntry_vtkExodusIICacheEntry_Methods[] = {
  {NULL, PyvtkExodusIICacheEntry_vtkExodusIICacheEntry_s2, 1,
   (char*)"O *vtkDataArray"},
  {NULL, NULL, 0, NULL}
};
...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkExodusIICacheNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkExodusIICacheNew(const char *); }
#endif
...
PyvtkExodusIICache_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkExodusIICache::GetClassName();
      }
...
PyvtkExodusIICache_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkExodusIICache::IsA(temp0);
      }
...
PyvtkExodusIICache_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkExodusIICache::NewInstance();
      }
...
PyvtkExodusIICache_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkExodusIICache::SafeDownCast(temp0);
...
PyvtkExodusIICache_GetSpaceLeft(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetSpaceLeft();
      }
    else
      {
      tempr = op->vtkExodusIICache::GetSpaceLeft();
      }
...
PyvtkExodusIICache_ReduceToSize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->ReduceToSize(temp0);
      }
    else
      {
      tempr = op->vtkExodusIICache::ReduceToSize(temp0);
      }
...
static PyMethodDef PyvtkExodusIICache_Methods[] = {
  {(char*)"GetClassName", PyvtkExodusIICache_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkExodusIICache_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkExodusIICache_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkExodusIICache\nC++: vtkExodusIICache *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkExodusIICache_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkExodusIICache\nC++: vtkExodusIICache *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Clear", PyvtkExodusIICache_Clear, 1,
   (char*)"V.Clear()\nC++: void Clear()\n\n"},
  {(char*)"SetCacheCapacity", PyvtkExodusIICache_SetCacheCapacity, 1,
   (char*)"V.SetCacheCapacity(float)\nC++: void SetCacheCapacity(double sizeInMiB)\n\n"},
  {(char*)"GetSpaceLeft", PyvtkExodusIICache_GetSpaceLeft, 1,
   (char*)"V.GetSpaceLeft() -> float\nC++: double GetSpaceLeft()\n\n"},
  {(char*)"ReduceToSize", PyvtkExodusIICache_ReduceToSize, 1,
