...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkRenderLargeImage(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkRenderLargeImage(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkRenderLargeImageNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkRenderLargeImageNew(const char *); }
#endif
...
PyvtkRenderLargeImage_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkRenderLargeImage::GetClassName();
      }
...
PyvtkRenderLargeImage_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkRenderLargeImage::IsA(temp0);
      }
...
PyvtkRenderLargeImage_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkRenderLargeImage::NewInstance();
      }
...
PyvtkRenderLargeImage_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkRenderLargeImage::SafeDownCast(temp0);
...
PyvtkRenderLargeImage_GetMagnification(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkRenderLargeImage::GetMagnification();
      }
...
PyvtkRenderLargeImage_GetInput(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkRenderLargeImage::GetInput();
      }
...
PyvtkRenderLargeImage_GetOutput(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkRenderLargeImage::GetOutput();
      }
