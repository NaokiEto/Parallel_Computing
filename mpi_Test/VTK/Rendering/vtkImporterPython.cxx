...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImporter(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImporter(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImporterNew(const char *); }
#else
...
PyvtkImporter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImporter::GetClassName();
      }
...
PyvtkImporter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImporter::IsA(temp0);
      }
...
PyvtkImporter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImporter::NewInstance();
      }
...
PyvtkImporter_GetRenderer(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImporter::GetRenderer();
      }
...
PyvtkImporter_GetRenderWindow(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImporter::GetRenderWindow();
      }
...
static PyMethodDef PyvtkImporter_Methods[] = {
  {(char*)"GetClassName", PyvtkImporter_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImporter_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImporter_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImporter\nC++: vtkImporter *NewInstance()\n\n"},
  {(char*)"GetRenderer", PyvtkImporter_GetRenderer, 1,
   (char*)"V.GetRenderer() -> vtkRenderer\nC++: vtkRenderer *GetRenderer()\n\n"},
  {(char*)"SetRenderWindow", PyvtkImporter_SetRenderWindow, 1,
   (char*)"V.SetRenderWindow(vtkRenderWindow)\nC++: virtual void SetRenderWindow(vtkRenderWindow *)\n\n"},
  {(char*)"GetRenderWindow", PyvtkImporter_GetRenderWindow, 1,
   (char*)"V.GetRenderWindow() -> vtkRenderWindow\nC++: vtkRenderWindow *GetRenderWindow()\n\n"},
  {(char*)"Read", PyvtkImporter_Read, 1,
   (char*)"V.Read()\nC++: void Read()\n\n"},
  {(char*)"Update", PyvtkImporter_Update, 1,
   (char*)"V.Update()\nC++: void Update()\n\n"},
  {NULL, NULL, 0, NULL}
};
