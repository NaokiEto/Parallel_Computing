...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkSobelGradientMagnitudePass(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkSobelGradientMagnitudePass(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkSobelGradientMagnitudePassNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkSobelGradientMagnitudePassNew(const char *); }
#endif
...
PyvtkSobelGradientMagnitudePass_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSobelGradientMagnitudePass::GetClassName();
      }
...
PyvtkSobelGradientMagnitudePass_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSobelGradientMagnitudePass::IsA(temp0);
      }
...
PyvtkSobelGradientMagnitudePass_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkSobelGradientMagnitudePass *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSobelGradientMagnitudePass::NewInstance();
      }
...
PyvtkSobelGradientMagnitudePass_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkSobelGradientMagnitudePass::SafeDownCast(temp0);
...
static PyMethodDef PyvtkSobelGradientMagnitudePass_Methods[] = {
  {(char*)"GetClassName", PyvtkSobelGradientMagnitudePass_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkSobelGradientMagnitudePass_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkSobelGradientMagnitudePass_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkSobelGradientMagnitudePass\nC++: vtkSobelGradientMagnitudePass *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkSobelGradientMagnitudePass_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkSobelGradientMagnitudePass\nC++: vtkSobelGradientMagnitudePass *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"ReleaseGraphicsResources", PyvtkSobelGradientMagnitudePass_ReleaseGraphicsResources, 1,
