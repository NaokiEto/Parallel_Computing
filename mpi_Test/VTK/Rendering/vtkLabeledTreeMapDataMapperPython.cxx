...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkLabeledTreeMapDataMapper(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkLabeledTreeMapDataMapper(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkLabeledTreeMapDataMapperNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkLabeledTreeMapDataMapperNew(const char *); }
#endif
...
PyvtkLabeledTreeMapDataMapper_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLabeledTreeMapDataMapper::GetClassName();
      }
...
PyvtkLabeledTreeMapDataMapper_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLabeledTreeMapDataMapper::IsA(temp0);
      }
...
PyvtkLabeledTreeMapDataMapper_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkLabeledTreeMapDataMapper *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLabeledTreeMapDataMapper::NewInstance();
      }
...
PyvtkLabeledTreeMapDataMapper_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkLabeledTreeMapDataMapper::SafeDownCast(temp0);
...
PyvtkLabeledTreeMapDataMapper_GetInputTree(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetInputTree();
      }
    else
      {
      tempr = op->vtkLabeledTreeMapDataMapper::GetInputTree();
      }
...
PyvtkLabeledTreeMapDataMapper_GetClipTextMode(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetClipTextMode();
      }
    else
      {
      tempr = op->vtkLabeledTreeMapDataMapper::GetClipTextMode();
      }
...
PyvtkLabeledTreeMapDataMapper_GetChildMotion(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetChildMotion();
      }
    else
      {
      tempr = op->vtkLabeledTreeMapDataMapper::GetChildMotion();
      }
...
PyvtkLabeledTreeMapDataMapper_GetDynamicLevel(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDynamicLevel();
      }
    else
      {
      tempr = op->vtkLabeledTreeMapDataMapper::GetDynamicLevel();
      }
...
static PyMethodDef PyvtkLabeledTreeMapDataMapper_Methods[] = {
  {(char*)"GetClassName", PyvtkLabeledTreeMapDataMapper_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkLabeledTreeMapDataMapper_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkLabeledTreeMapDataMapper_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkLabeledTreeMapDataMapper\nC++: vtkLabeledTreeMapDataMapper *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkLabeledTreeMapDataMapper_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkLabeledTreeMapDataMapper\nC++: vtkLabeledTreeMapDataMapper *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"RenderOpaqueGeometry", PyvtkLabeledTreeMapDataMapper_RenderOpaqueGeometry, 1,
   (char*)"V.RenderOpaqueGeometry(vtkViewport, vtkActor2D)\nC++: virtual void RenderOpaqueGeometry(vtkViewport *viewport,\n    vtkActor2D *actor)\n\nDraw the text to the screen at each input point.\n"},
  {(char*)"RenderOverlay", PyvtkLabeledTreeMapDataMapper_RenderOverlay, 1,
   (char*)"V.RenderOverlay(vtkViewport, vtkActor2D)\nC++: virtual void RenderOverlay(vtkViewport *viewport,\n    vtkActor2D *actor)\n\nDraw the text to the screen at each input point.\n"},
  {(char*)"GetInputTree", PyvtkLabeledTreeMapDataMapper_GetInputTree, 1,
   (char*)"V.GetInputTree() -> vtkTree\nC++: virtual vtkTree *GetInputTree()\n\nThe input to this filter.\n"},
  {(char*)"SetRectanglesArrayName", PyvtkLabeledTreeMapDataMapper_SetRectanglesArrayName, 1,
  ...
  {(char*)"GetClipTextMode", PyvtkLabeledTreeMapDataMapper_GetClipTextMode, 1,
  ...
  {(char*)"SetClipTextMode", PyvtkLabeledTreeMapDataMapper_SetClipTextMode, 1,
   (char*)"V.SetClipTextMode(int)\nC++: void SetClipTextMode(int a)\n\nIndicates if the label can be displayed clipped by the Window\nmode = 0 - ok to clip labels 1 - auto center labels w/r to the\narea of the vertex's clipped region\n"},
  {(char*)"GetChildMotion", PyvtkLabeledTreeMapDataMapper_GetChildMotion, 1,
   (char*)"V.GetChildMotion() -> int\nC++: int GetChildMotion()\n\nIndicates if the label can be moved by its ancestors\n"},
  {(char*)"SetChildMotion", PyvtkLabeledTreeMapDataMapper_SetChildMotion, 1,
   (char*)"V.SetChildMotion(int)\nC++: void SetChildMotion(int a)\n\nIndicates if the label can be moved by its ancestors\n"},
  {(char*)"GetDynamicLevel", PyvtkLabeledTreeMapDataMapper_GetDynamicLevel, 1,
   (char*)"V.GetDynamicLevel() -> int\nC++: int GetDynamicLevel()\n\nIndicates at which level labeling should be dynamic\n"},
  {(char*)"SetDynamicLevel", PyvtkLabeledTreeMapDataMapper_SetDynamicLevel, 1,
   (char*)"V.SetDynamicLevel(int)\nC++: void SetDynamicLevel(int a)\n\nIndicates at which level labeling should be dynamic\n"},
  {(char*)"ReleaseGraphicsResources", PyvtkLabeledTreeMapDataMapper_ReleaseGraphicsResources, 1,
   (char*)"V.ReleaseGraphicsResources(vtkWindow)\nC++: virtual void ReleaseGraphicsResources(vtkWindow *)\n\nRelease any graphics resources that are being consumed by this\nactor.\n"},
  {(char*)"SetFontSizeRange", PyvtkLabeledTreeMapDataMapper_SetFontSizeRange, 1,
  ...
  {(char*)"GetFontSizeRange", PyvtkLabeledTreeMapDataMapper_GetFontSizeRange, 1,
   (char*)"V.GetFontSizeRange([int, int, int])\nC++: void GetFontSizeRange(int range[3])\n\nThe range of font sizes to use when rendering the labels.\n"},
  {(char*)"SetLevelRange", PyvtkLabeledTreeMapDataMapper_SetLevelRange, 1,
  ...
  {(char*)"GetLevelRange", PyvtkLabeledTreeMapDataMapper_GetLevelRange, 1,
