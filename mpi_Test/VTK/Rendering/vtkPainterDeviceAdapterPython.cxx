...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPainterDeviceAdapter(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPainterDeviceAdapter(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPainterDeviceAdapterNew(const char *); }
#else
...
PyvtkPainterDeviceAdapter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPainterDeviceAdapter::GetClassName();
      }
...
PyvtkPainterDeviceAdapter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPainterDeviceAdapter::IsA(temp0);
      }
...
PyvtkPainterDeviceAdapter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPainterDeviceAdapter::NewInstance();
      }
...
PyvtkPainterDeviceAdapter_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPainterDeviceAdapter::SafeDownCast(temp0);
...
static PyObject *
PyvtkPainterDeviceAdapter_MakeVertexEmphasisWithStencilCheck(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPainterDeviceAdapter::MakeVertexEmphasisWithStencilCheck(temp0);
      }
...
static PyMethodDef PyvtkPainterDeviceAdapter_Methods[] = {
  {(char*)"GetClassName", PyvtkPainterDeviceAdapter_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPainterDeviceAdapter_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPainterDeviceAdapter_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPainterDeviceAdapter\nC++: vtkPainterDeviceAdapter *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPainterDeviceAdapter_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPainterDeviceAdapter\nC++: vtkPainterDeviceAdapter *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"BeginPrimitive", PyvtkPainterDeviceAdapter_BeginPrimitive, 1,
  ...
  {(char*)"EndPrimitive", PyvtkPainterDeviceAdapter_EndPrimitive, 1,
   (char*)"V.EndPrimitive()\nC++: virtual void EndPrimitive()\n\nSignals the end of sending a primitive to the graphics card.\n"},
  {(char*)"IsAttributesSupported", PyvtkPainterDeviceAdapter_IsAttributesSupported, 1,
  ...
  {(char*)"SendMultiTextureCoords", PyvtkPainterDeviceAdapter_SendMultiTextureCoords, 1,
  ...
  {(char*)"SendAttribute", PyvtkPainterDeviceAdapter_SendAttribute, 1,
  ...
  {(char*)"SetAttributePointer", PyvtkPainterDeviceAdapter_SetAttributePointer, 1,
  ...
  {(char*)"EnableAttributeArray", PyvtkPainterDeviceAdapter_EnableAttributeArray, 1,
  ...
  {(char*)"DisableAttributeArray", PyvtkPainterDeviceAdapter_DisableAttributeArray, 1,
   (char*)"V.DisableAttributeArray(int)\nC++: virtual void DisableAttributeArray(int index)\n\nEnable/disable the attribute array set with SetAttributePointer.\n"},
  {(char*)"DrawArrays", PyvtkPainterDeviceAdapter_DrawArrays, 1,
  ...
  {(char*)"DrawElements", PyvtkPainterDeviceAdapter_DrawElements, 1,
  ...
  {(char*)"Compatible", PyvtkPainterDeviceAdapter_Compatible, 1,
...
#if !defined(VTK_LEGACY_REMOVE)
  {(char*)"MakeVertexEmphasisWithStencilCheck", PyvtkPainterDeviceAdapter_MakeVertexEmphasisWithStencilCheck, 1,
   (char*)"V.MakeVertexEmphasisWithStencilCheck(int)\nC++: virtual void MakeVertexEmphasisWithStencilCheck(int mode)\n\n@deprecated\n"},
#endif
  {(char*)"Stencil", PyvtkPainterDeviceAdapter_Stencil, 1,
   (char*)"V.Stencil(int)\nC++: virtual void Stencil(int on)\n\nControl use of the stencil buffer (for vertex selection).\n"},
  {(char*)"WriteStencil", PyvtkPainterDeviceAdapter_WriteStencil, 1,
   (char*)"V.WriteStencil(int)\nC++: virtual void WriteStencil(vtkIdType value)\n\nControl use of the stencil buffer (for vertex selection).\n"},
  {(char*)"TestStencil", PyvtkPainterDeviceAdapter_TestStencil, 1,
