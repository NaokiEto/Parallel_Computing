...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkWorldPointPicker(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkWorldPointPicker(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkWorldPointPickerNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkWorldPointPickerNew(const char *); }
#endif
...
PyvtkWorldPointPicker_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkWorldPointPicker::GetClassName();
      }
...
PyvtkWorldPointPicker_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkWorldPointPicker::IsA(temp0);
      }
...
PyvtkWorldPointPicker_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkWorldPointPicker::NewInstance();
      }
...
PyvtkWorldPointPicker_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkWorldPointPicker::SafeDownCast(temp0);
...
PyvtkWorldPointPicker_Pick_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkWorldPointPicker::Pick(temp0, temp1, temp2, temp3);
      }
...
PyvtkWorldPointPicker_Pick_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkWorldPointPicker::Pick(temp0, temp1);
      }
...
static PyMethodDef PyvtkWorldPointPicker_Methods[] = {
  {(char*)"GetClassName", PyvtkWorldPointPicker_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkWorldPointPicker_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkWorldPointPicker_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkWorldPointPicker\nC++: vtkWorldPointPicker *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkWorldPointPicker_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkWorldPointPicker\nC++: vtkWorldPointPicker *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Pick", PyvtkWorldPointPicker_Pick, 1,
