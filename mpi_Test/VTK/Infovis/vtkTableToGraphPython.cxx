...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkTableToGraph(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkTableToGraph(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkTableToGraphNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkTableToGraphNew(const char *); }
#endif
...
PyvtkTableToGraph_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTableToGraph::GetClassName();
      }
...
PyvtkTableToGraph_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTableToGraph::IsA(temp0);
      }
...
PyvtkTableToGraph_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTableToGraph::NewInstance();
      }
...
PyvtkTableToGraph_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkTableToGraph::SafeDownCast(temp0);
...
PyvtkTableToGraph_GetLinkGraph(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetLinkGraph();
      }
    else
      {
      tempr = op->vtkTableToGraph::GetLinkGraph();
      }
...
PyvtkTableToGraph_GetDirected(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTableToGraph::GetDirected();
      }
...
PyvtkTableToGraph_GetMTime(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTableToGraph::GetMTime();
      }
...
static PyMethodDef PyvtkTableToGraph_Methods[] = {
  {(char*)"GetClassName", PyvtkTableToGraph_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkTableToGraph_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkTableToGraph_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkTableToGraph\nC++: vtkTableToGraph *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkTableToGraph_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkTableToGraph\nC++: vtkTableToGraph *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"AddLinkVertex", PyvtkTableToGraph_AddLinkVertex, 1,
  ...
  {(char*)"ClearLinkVertices", PyvtkTableToGraph_ClearLinkVertices, 1,
   (char*)"V.ClearLinkVertices()\nC++: void ClearLinkVertices()\n\nClear the link graph vertices.  This also clears all edges.\n"},
  {(char*)"AddLinkEdge", PyvtkTableToGraph_AddLinkEdge, 1,
  ...
  {(char*)"ClearLinkEdges", PyvtkTableToGraph_ClearLinkEdges, 1,
   (char*)"V.ClearLinkEdges()\nC++: void ClearLinkEdges()\n\nClear the link graph edges.  The graph vertices will remain.\n"},
  {(char*)"GetLinkGraph", PyvtkTableToGraph_GetLinkGraph, 1,
  ...
  {(char*)"SetLinkGraph", PyvtkTableToGraph_SetLinkGraph, 1,
   (char*)"V.SetLinkGraph(vtkMutableDirectedGraph)\nC++: void SetLinkGraph(vtkMutableDirectedGraph *g)\n\nThe graph describing how to link the columns in the table.\n"},
  {(char*)"LinkColumnPath", PyvtkTableToGraph_LinkColumnPath, 1,
  ...
  {(char*)"SetDirected", PyvtkTableToGraph_SetDirected, 1,
   (char*)"V.SetDirected(bool)\nC++: void SetDirected(bool a)\n\nSpecify the directedness of the output graph.\n"},
  {(char*)"GetDirected", PyvtkTableToGraph_GetDirected, 1,
   (char*)"V.GetDirected() -> bool\nC++: bool GetDirected()\n\nSpecify the directedness of the output graph.\n"},
  {(char*)"DirectedOn", PyvtkTableToGraph_DirectedOn, 1,
   (char*)"V.DirectedOn()\nC++: void DirectedOn()\n\nSpecify the directedness of the output graph.\n"},
  {(char*)"DirectedOff", PyvtkTableToGraph_DirectedOff, 1,
   (char*)"V.DirectedOff()\nC++: void DirectedOff()\n\nSpecify the directedness of the output graph.\n"},
  {(char*)"GetMTime", PyvtkTableToGraph_GetMTime, 1,
   (char*)"V.GetMTime() -> int\nC++: virtual unsigned long GetMTime()\n\nGet the current modified time.\n"},
  {(char*)"SetVertexTableConnection", PyvtkTableToGraph_SetVertexTableConnection, 1,
