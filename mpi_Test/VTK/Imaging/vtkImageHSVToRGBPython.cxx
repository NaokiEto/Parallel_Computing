...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImageHSVToRGB(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImageHSVToRGB(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImageHSVToRGBNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImageHSVToRGBNew(const char *); }
#endif
...
PyvtkImageHSVToRGB_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageHSVToRGB::GetClassName();
      }
...
PyvtkImageHSVToRGB_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageHSVToRGB::IsA(temp0);
      }
...
PyvtkImageHSVToRGB_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageHSVToRGB::NewInstance();
      }
...
PyvtkImageHSVToRGB_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImageHSVToRGB::SafeDownCast(temp0);
...
PyvtkImageHSVToRGB_GetMaximum(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageHSVToRGB::GetMaximum();
      }
...
static PyMethodDef PyvtkImageHSVToRGB_Methods[] = {
  {(char*)"GetClassName", PyvtkImageHSVToRGB_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImageHSVToRGB_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImageHSVToRGB_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImageHSVToRGB\nC++: vtkImageHSVToRGB *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImageHSVToRGB_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImageHSVToRGB\nC++: vtkImageHSVToRGB *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetMaximum", PyvtkImageHSVToRGB_SetMaximum, 1,
  ...
  {(char*)"GetMaximum", PyvtkImageHSVToRGB_GetMaximum, 1,
