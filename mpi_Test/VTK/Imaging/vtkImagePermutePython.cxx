...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImagePermute(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImagePermute(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImagePermuteNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImagePermuteNew(const char *); }
#endif
...
PyvtkImagePermute_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImagePermute::GetClassName();
      }
...
PyvtkImagePermute_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImagePermute::IsA(temp0);
      }
...
PyvtkImagePermute_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImagePermute::NewInstance();
      }
...
PyvtkImagePermute_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImagePermute::SafeDownCast(temp0);
...
PyvtkImagePermute_GetFilteredAxes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImagePermute::GetFilteredAxes();
      }
...
static PyMethodDef PyvtkImagePermute_Methods[] = {
  {(char*)"GetClassName", PyvtkImagePermute_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImagePermute_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImagePermute_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImagePermute\nC++: vtkImagePermute *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImagePermute_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImagePermute\nC++: vtkImagePermute *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetFilteredAxes", PyvtkImagePermute_SetFilteredAxes, 1,
  ...
  {(char*)"GetFilteredAxes", PyvtkImagePermute_GetFilteredAxes, 1,
