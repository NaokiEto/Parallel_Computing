...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImageRFFT(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImageRFFT(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImageRFFTNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImageRFFTNew(const char *); }
#endif
...
PyvtkImageRFFT_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageRFFT::GetClassName();
      }
...
PyvtkImageRFFT_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageRFFT::IsA(temp0);
      }
...
PyvtkImageRFFT_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageRFFT::NewInstance();
      }
...
PyvtkImageRFFT_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImageRFFT::SafeDownCast(temp0);
...
PyvtkImageRFFT_SplitExtent(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageRFFT::SplitExtent(temp0, temp1, temp2, temp3);
      }
...
static PyMethodDef PyvtkImageRFFT_Methods[] = {
  {(char*)"GetClassName", PyvtkImageRFFT_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImageRFFT_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImageRFFT_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImageRFFT\nC++: vtkImageRFFT *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImageRFFT_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImageRFFT\nC++: vtkImageRFFT *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SplitExtent", PyvtkImageRFFT_SplitExtent, 1,
