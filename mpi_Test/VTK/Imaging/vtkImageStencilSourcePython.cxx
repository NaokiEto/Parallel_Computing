...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImageStencilSource(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImageStencilSource(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImageStencilSourceNew(const char *); }
#else
...
PyvtkImageStencilSource_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageStencilSource::GetClassName();
      }
...
PyvtkImageStencilSource_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageStencilSource::IsA(temp0);
      }
...
PyvtkImageStencilSource_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageStencilSource::NewInstance();
      }
...
PyvtkImageStencilSource_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImageStencilSource::SafeDownCast(temp0);
...
PyvtkImageStencilSource_GetInformationInput(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageStencilSource::GetInformationInput();
      }
...
PyvtkImageStencilSource_GetOutputOrigin(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageStencilSource::GetOutputOrigin();
      }
...
PyvtkImageStencilSource_GetOutputSpacing(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageStencilSource::GetOutputSpacing();
      }
...
PyvtkImageStencilSource_GetOutputWholeExtent(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageStencilSource::GetOutputWholeExtent();
      }
...
static PyMethodDef PyvtkImageStencilSource_Methods[] = {
  {(char*)"GetClassName", PyvtkImageStencilSource_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImageStencilSource_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImageStencilSource_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImageStencilSource\nC++: vtkImageStencilSource *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImageStencilSource_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImageStencilSource\nC++: vtkImageStencilSource *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetInformationInput", PyvtkImageStencilSource_SetInformationInput, 1,
  ...
  {(char*)"GetInformationInput", PyvtkImageStencilSource_GetInformationInput, 1,
   (char*)"V.GetInformationInput() -> vtkImageData\nC++: vtkImageData *GetInformationInput()\n\nSet a vtkImageData that has the Spacing, Origin, and WholeExtent\nthat will be used for the stencil.  This input should be set to\nthe image that you wish to apply the stencil to.  If you use this\nmethod, then any values set with the SetOutputSpacing,\nSetOutputOrigin, and SetOutputWholeExtent methods will be\nignored.\n"},
  {(char*)"SetOutputOrigin", PyvtkImageStencilSource_SetOutputOrigin, 1,
  ...
  {(char*)"GetOutputOrigin", PyvtkImageStencilSource_GetOutputOrigin, 1,
   (char*)"V.GetOutputOrigin() -> (float, float, float)\nC++: double *GetOutputOrigin()\n\n"},
  {(char*)"SetOutputSpacing", PyvtkImageStencilSource_SetOutputSpacing, 1,
  ...
  {(char*)"GetOutputSpacing", PyvtkImageStencilSource_GetOutputSpacing, 1,
   (char*)"V.GetOutputSpacing() -> (float, float, float)\nC++: double *GetOutputSpacing()\n\n"},
  {(char*)"SetOutputWholeExtent", PyvtkImageStencilSource_SetOutputWholeExtent, 1,
  ...
  {(char*)"GetOutputWholeExtent", PyvtkImageStencilSource_GetOutputWholeExtent, 1,
   (char*)"V.GetOutputWholeExtent() -> (int, int, int, int, int, int)\nC++: int *GetOutputWholeExtent()\n\n"},
  {(char*)"ReportReferences", PyvtkImageStencilSource_ReportReferences, 1,
