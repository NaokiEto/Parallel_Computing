...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImageConnector(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImageConnector(PyObject *, const char *); }
#endif
...
extern PyTypeObject PyvtkImageConnectorSeed_Type;
...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImageConnectorNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImageConnectorNew(const char *); }
#endif
...
PyvtkImageConnector_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageConnector::GetClassName();
      }
...
PyvtkImageConnector_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageConnector::IsA(temp0);
      }
...
PyvtkImageConnector_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageConnector::NewInstance();
      }
...
PyvtkImageConnector_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImageConnector::SafeDownCast(temp0);
...
PyvtkImageConnector_GetConnectedValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetConnectedValue();
      }
    else
      {
      tempr = op->vtkImageConnector::GetConnectedValue();
      }
...
PyvtkImageConnector_GetUnconnectedValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetUnconnectedValue();
      }
    else
      {
      tempr = op->vtkImageConnector::GetUnconnectedValue();
      }
...
static PyMethodDef PyvtkImageConnector_Methods[] = {
  {(char*)"GetClassName", PyvtkImageConnector_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImageConnector_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImageConnector_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImageConnector\nC++: vtkImageConnector *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImageConnector_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImageConnector\nC++: vtkImageConnector *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"RemoveAllSeeds", PyvtkImageConnector_RemoveAllSeeds, 1,
   (char*)"V.RemoveAllSeeds()\nC++: void RemoveAllSeeds()\n\n"},
  {(char*)"SetConnectedValue", PyvtkImageConnector_SetConnectedValue, 1,
   (char*)"V.SetConnectedValue(int)\nC++: void SetConnectedValue(unsigned char a)\n\nValues used by the MarkRegion method\n"},
  {(char*)"GetConnectedValue", PyvtkImageConnector_GetConnectedValue, 1,
   (char*)"V.GetConnectedValue() -> int\nC++: unsigned char GetConnectedValue()\n\nValues used by the MarkRegion method\n"},
  {(char*)"SetUnconnectedValue", PyvtkImageConnector_SetUnconnectedValue, 1,
   (char*)"V.SetUnconnectedValue(int)\nC++: void SetUnconnectedValue(unsigned char a)\n\nValues used by the MarkRegion method\n"},
  {(char*)"GetUnconnectedValue", PyvtkImageConnector_GetUnconnectedValue, 1,
   (char*)"V.GetUnconnectedValue() -> int\nC++: unsigned char GetUnconnectedValue()\n\nValues used by the MarkRegion method\n"},
  {(char*)"MarkData", PyvtkImageConnector_MarkData, 1,
