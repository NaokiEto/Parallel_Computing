...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImageRange3D(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImageRange3D(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImageRange3DNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImageRange3DNew(const char *); }
#endif
...
PyvtkImageRange3D_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageRange3D::GetClassName();
      }
...
PyvtkImageRange3D_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageRange3D::IsA(temp0);
      }
...
PyvtkImageRange3D_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageRange3D::NewInstance();
      }
...
PyvtkImageRange3D_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImageRange3D::SafeDownCast(temp0);
...
static PyMethodDef PyvtkImageRange3D_Methods[] = {
  {(char*)"GetClassName", PyvtkImageRange3D_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImageRange3D_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImageRange3D_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImageRange3D\nC++: vtkImageRange3D *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImageRange3D_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImageRange3D\nC++: vtkImageRange3D *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetKernelSize", PyvtkImageRange3D_SetKernelSize, 1,
