...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImageCursor3D(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImageCursor3D(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImageCursor3DNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImageCursor3DNew(const char *); }
#endif
...
PyvtkImageCursor3D_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageCursor3D::GetClassName();
      }
...
PyvtkImageCursor3D_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageCursor3D::IsA(temp0);
      }
...
PyvtkImageCursor3D_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageCursor3D::NewInstance();
      }
...
PyvtkImageCursor3D_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImageCursor3D::SafeDownCast(temp0);
...
PyvtkImageCursor3D_GetCursorPosition(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageCursor3D::GetCursorPosition();
      }
...
PyvtkImageCursor3D_GetCursorValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetCursorValue();
      }
    else
      {
      tempr = op->vtkImageCursor3D::GetCursorValue();
      }
...
PyvtkImageCursor3D_GetCursorRadius(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetCursorRadius();
      }
    else
      {
      tempr = op->vtkImageCursor3D::GetCursorRadius();
      }
...
static PyMethodDef PyvtkImageCursor3D_Methods[] = {
  {(char*)"GetClassName", PyvtkImageCursor3D_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImageCursor3D_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImageCursor3D_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImageCursor3D\nC++: vtkImageCursor3D *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImageCursor3D_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImageCursor3D\nC++: vtkImageCursor3D *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetCursorPosition", PyvtkImageCursor3D_SetCursorPosition, 1,
  ...
  {(char*)"GetCursorPosition", PyvtkImageCursor3D_GetCursorPosition, 1,
   (char*)"V.GetCursorPosition() -> (float, float, float)\nC++: double *GetCursorPosition()\n\n"},
  {(char*)"SetCursorValue", PyvtkImageCursor3D_SetCursorValue, 1,
   (char*)"V.SetCursorValue(float)\nC++: void SetCursorValue(double a)\n\nSets/Gets what pixel value to draw the cursor in.\n"},
  {(char*)"GetCursorValue", PyvtkImageCursor3D_GetCursorValue, 1,
   (char*)"V.GetCursorValue() -> float\nC++: double GetCursorValue()\n\nSets/Gets what pixel value to draw the cursor in.\n"},
  {(char*)"SetCursorRadius", PyvtkImageCursor3D_SetCursorRadius, 1,
  ...
  {(char*)"GetCursorRadius", PyvtkImageCursor3D_GetCursorRadius, 1,
