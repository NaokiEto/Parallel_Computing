...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkVolumeTextureMapper3D(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkVolumeTextureMapper3D(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkVolumeTextureMapper3DNew(const char *); }
#else
...
PyvtkVolumeTextureMapper3D_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkVolumeTextureMapper3D::GetClassName();
      }
...
PyvtkVolumeTextureMapper3D_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkVolumeTextureMapper3D::IsA(temp0);
      }
...
PyvtkVolumeTextureMapper3D_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkVolumeTextureMapper3D *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkVolumeTextureMapper3D::NewInstance();
      }
...
PyvtkVolumeTextureMapper3D_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkVolumeTextureMapper3D::SafeDownCast(temp0);
...
PyvtkVolumeTextureMapper3D_GetSampleDistance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkVolumeTextureMapper3D::GetSampleDistance();
      }
...
PyvtkVolumeTextureMapper3D_GetVolumeDimensions(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetVolumeDimensions();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetVolumeDimensions();
      }
...
PyvtkVolumeTextureMapper3D_GetVolumeSpacing(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetVolumeSpacing();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetVolumeSpacing();
      }
...
PyvtkVolumeTextureMapper3D_IsRenderSupported(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkVolumeTextureMapper3D::IsRenderSupported(temp0, temp1);
      }
...
PyvtkVolumeTextureMapper3D_GetNumberOfPolygons(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNumberOfPolygons();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetNumberOfPolygons();
      }
...
PyvtkVolumeTextureMapper3D_GetActualSampleDistance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetActualSampleDistance();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetActualSampleDistance();
      }
...
PyvtkVolumeTextureMapper3D_GetPreferredRenderMethodMinValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetPreferredRenderMethodMinValue();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetPreferredRenderMethodMinValue();
      }
...
PyvtkVolumeTextureMapper3D_GetPreferredRenderMethodMaxValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetPreferredRenderMethodMaxValue();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetPreferredRenderMethodMaxValue();
      }
...
PyvtkVolumeTextureMapper3D_GetPreferredRenderMethod(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetPreferredRenderMethod();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetPreferredRenderMethod();
      }
...
PyvtkVolumeTextureMapper3D_GetUseCompressedTexture(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetUseCompressedTexture();
      }
    else
      {
      tempr = op->vtkVolumeTextureMapper3D::GetUseCompressedTexture();
      }
...
static PyMethodDef PyvtkVolumeTextureMapper3D_Methods[] = {
  {(char*)"GetClassName", PyvtkVolumeTextureMapper3D_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkVolumeTextureMapper3D_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkVolumeTextureMapper3D_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkVolumeTextureMapper3D\nC++: vtkVolumeTextureMapper3D *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkVolumeTextureMapper3D_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkVolumeTextureMapper3D\nC++: vtkVolumeTextureMapper3D *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetSampleDistance", PyvtkVolumeTextureMapper3D_SetSampleDistance, 1,
  ...
  {(char*)"GetSampleDistance", PyvtkVolumeTextureMapper3D_GetSampleDistance, 1,
   (char*)"V.GetSampleDistance() -> float\nC++: float GetSampleDistance()\n\nThe distance at which to space sampling planes. This may not be\nhonored for interactive renders. An interactive render is defined\nas one that has less than 1 second of allocated render time.\n"},
  {(char*)"GetVolumeDimensions", PyvtkVolumeTextureMapper3D_GetVolumeDimensions, 1,
   (char*)"V.GetVolumeDimensions() -> (int, int, int)\nC++: int *GetVolumeDimensions()\n\nThese are the dimensions of the 3D texture\n"},
  {(char*)"GetVolumeSpacing", PyvtkVolumeTextureMapper3D_GetVolumeSpacing, 1,
   (char*)"V.GetVolumeSpacing() -> (float, float, float)\nC++: float *GetVolumeSpacing()\n\nThis is the spacing of the 3D texture\n"},
  {(char*)"IsRenderSupported", PyvtkVolumeTextureMapper3D_IsRenderSupported, 1,
  ...
  {(char*)"GetNumberOfPolygons", PyvtkVolumeTextureMapper3D_GetNumberOfPolygons, 1,
   (char*)"V.GetNumberOfPolygons() -> int\nC++: int GetNumberOfPolygons()\n\nAllow access to the number of polygons used for the rendering.\n"},
  {(char*)"GetActualSampleDistance", PyvtkVolumeTextureMapper3D_GetActualSampleDistance, 1,
  ...
  {(char*)"Render", PyvtkVolumeTextureMapper3D_Render, 1,
  ...
  {(char*)"SetPreferredRenderMethod", PyvtkVolumeTextureMapper3D_SetPreferredRenderMethod, 1,
  ...
  {(char*)"GetPreferredRenderMethodMinValue", PyvtkVolumeTextureMapper3D_GetPreferredRenderMethodMinValue, 1,
   (char*)"V.GetPreferredRenderMethodMinValue() -> int\nC++: int GetPreferredRenderMethodMinValue()\n\nSet the preferred render method. If it is supported, this one\nwill be used. Don't allow ATI_METHOD - it is not actually\nsupported.\n"},
  {(char*)"GetPreferredRenderMethodMaxValue", PyvtkVolumeTextureMapper3D_GetPreferredRenderMethodMaxValue, 1,
   (char*)"V.GetPreferredRenderMethodMaxValue() -> int\nC++: int GetPreferredRenderMethodMaxValue()\n\nSet the preferred render method. If it is supported, this one\nwill be used. Don't allow ATI_METHOD - it is not actually\nsupported.\n"},
  {(char*)"SetPreferredMethodToFragmentProgram", PyvtkVolumeTextureMapper3D_SetPreferredMethodToFragmentProgram, 1,
   (char*)"V.SetPreferredMethodToFragmentProgram()\nC++: void SetPreferredMethodToFragmentProgram()\n\nSet the preferred render method. If it is supported, this one\nwill be used. Don't allow ATI_METHOD - it is not actually\nsupported.\n"},
  {(char*)"SetPreferredMethodToNVidia", PyvtkVolumeTextureMapper3D_SetPreferredMethodToNVidia, 1,
   (char*)"V.SetPreferredMethodToNVidia()\nC++: void SetPreferredMethodToNVidia()\n\nSet the preferred render method. If it is supported, this one\nwill be used. Don't allow ATI_METHOD - it is not actually\nsupported.\n"},
  {(char*)"GetPreferredRenderMethod", PyvtkVolumeTextureMapper3D_GetPreferredRenderMethod, 1,
   (char*)"V.GetPreferredRenderMethod() -> int\nC++: int GetPreferredRenderMethod()\n\nSet the preferred render method. If it is supported, this one\nwill be used. Don't allow ATI_METHOD - it is not actually\nsupported.\n"},
  {(char*)"SetUseCompressedTexture", PyvtkVolumeTextureMapper3D_SetUseCompressedTexture, 1,
  ...
  {(char*)"GetUseCompressedTexture", PyvtkVolumeTextureMapper3D_GetUseCompressedTexture, 1,
...
PyObject *PyVTKClass_vtkVolumeTextureMapper3DNew(const char *modulename)
{
  ...
  if (cls)
    ...
    o = PyInt_FromLong(0);
    if (o && PyDict_SetItemString(d, (char *)"FRAGMENT_PROGRAM_METHOD", o) != 0)
      {
      Py_DECREF(o);
      }

    o = PyInt_FromLong(1);
    if (o && PyDict_SetItemString(d, (char *)"NVIDIA_METHOD", o) != 0)
      {
      Py_DECREF(o);
      }

    o = PyInt_FromLong(2);
    if (o && PyDict_SetItemString(d, (char *)"ATI_METHOD", o) != 0)
      {
      Py_DECREF(o);
      }

    o = PyInt_FromLong(3);
    if (o && PyDict_SetItemString(d, (char *)"NO_METHOD", o) != 0)
      {
      Py_DECREF(o);
      }
