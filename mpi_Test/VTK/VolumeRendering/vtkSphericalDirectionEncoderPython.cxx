...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkSphericalDirectionEncoder(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkSphericalDirectionEncoder(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkSphericalDirectionEncoderNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkSphericalDirectionEncoderNew(const char *); }
#endif
...
PyvtkSphericalDirectionEncoder_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphericalDirectionEncoder::GetClassName();
      }
...
PyvtkSphericalDirectionEncoder_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphericalDirectionEncoder::IsA(temp0);
      }
...
PyvtkSphericalDirectionEncoder_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkSphericalDirectionEncoder *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphericalDirectionEncoder::NewInstance();
      }
...
PyvtkSphericalDirectionEncoder_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkSphericalDirectionEncoder::SafeDownCast(temp0);
...
PyvtkSphericalDirectionEncoder_GetEncodedDirection(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphericalDirectionEncoder::GetEncodedDirection(temp0);
      }
...
PyvtkSphericalDirectionEncoder_GetDecodedGradient(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphericalDirectionEncoder::GetDecodedGradient(temp0);
      }
...
PyvtkSphericalDirectionEncoder_GetNumberOfEncodedDirections(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphericalDirectionEncoder::GetNumberOfEncodedDirections();
      }
...
static PyMethodDef PyvtkSphericalDirectionEncoder_Methods[] = {
  {(char*)"GetClassName", PyvtkSphericalDirectionEncoder_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkSphericalDirectionEncoder_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkSphericalDirectionEncoder_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkSphericalDirectionEncoder\nC++: vtkSphericalDirectionEncoder *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkSphericalDirectionEncoder_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkSphericalDirectionEncoder\nC++: vtkSphericalDirectionEncoder *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetEncodedDirection", PyvtkSphericalDirectionEncoder_GetEncodedDirection, 1,
   (char*)"V.GetEncodedDirection([float, float, float]) -> int\nC++: int GetEncodedDirection(float n[3])\n\nGiven a normal vector n, return the encoded direction\n"},
  {(char*)"GetDecodedGradient", PyvtkSphericalDirectionEncoder_GetDecodedGradient, 1,
   (char*)"V.GetDecodedGradient(int) -> (float, float, float)\nC++: float *GetDecodedGradient(int value)\n\n/ Given an encoded value, return a pointer to the normal vector\n"},
  {(char*)"GetNumberOfEncodedDirections", PyvtkSphericalDirectionEncoder_GetNumberOfEncodedDirections, 1,
