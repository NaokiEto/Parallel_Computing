...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkOpenGLHAVSVolumeMapper(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkOpenGLHAVSVolumeMapper(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkOpenGLHAVSVolumeMapperNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkOpenGLHAVSVolumeMapperNew(const char *); }
#endif
...
PyvtkOpenGLHAVSVolumeMapper_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOpenGLHAVSVolumeMapper::GetClassName();
      }
...
PyvtkOpenGLHAVSVolumeMapper_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOpenGLHAVSVolumeMapper::IsA(temp0);
      }
...
PyvtkOpenGLHAVSVolumeMapper_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkOpenGLHAVSVolumeMapper *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOpenGLHAVSVolumeMapper::NewInstance();
      }
...
PyvtkOpenGLHAVSVolumeMapper_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkOpenGLHAVSVolumeMapper::SafeDownCast(temp0);
...
PyvtkOpenGLHAVSVolumeMapper_SupportedByHardware(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOpenGLHAVSVolumeMapper::SupportedByHardware(temp0);
      }
...
static PyMethodDef PyvtkOpenGLHAVSVolumeMapper_Methods[] = {
  {(char*)"GetClassName", PyvtkOpenGLHAVSVolumeMapper_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkOpenGLHAVSVolumeMapper_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkOpenGLHAVSVolumeMapper_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkOpenGLHAVSVolumeMapper\nC++: vtkOpenGLHAVSVolumeMapper *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkOpenGLHAVSVolumeMapper_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkOpenGLHAVSVolumeMapper\nC++: vtkOpenGLHAVSVolumeMapper *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Render", PyvtkOpenGLHAVSVolumeMapper_Render, 1,
   (char*)"V.Render(vtkRenderer, vtkVolume)\nC++: virtual void Render(vtkRenderer *ren, vtkVolume *vol)\n\nRender the volume\n"},
  {(char*)"ReleaseGraphicsResources", PyvtkOpenGLHAVSVolumeMapper_ReleaseGraphicsResources, 1,
   (char*)"V.ReleaseGraphicsResources(vtkWindow)\nC++: virtual void ReleaseGraphicsResources(vtkWindow *)\n\n"},
  {(char*)"SetGPUDataStructures", PyvtkOpenGLHAVSVolumeMapper_SetGPUDataStructures, 1,
  ...
  {(char*)"SupportedByHardware", PyvtkOpenGLHAVSVolumeMapper_SupportedByHardware, 1,
