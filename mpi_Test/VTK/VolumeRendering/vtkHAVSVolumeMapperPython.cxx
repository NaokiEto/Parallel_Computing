...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkHAVSVolumeMapper(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkHAVSVolumeMapper(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkHAVSVolumeMapperNew(const char *); }
#else
...
PyvtkHAVSVolumeMapper_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkHAVSVolumeMapper::GetClassName();
      }
...
PyvtkHAVSVolumeMapper_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkHAVSVolumeMapper::IsA(temp0);
      }
...
PyvtkHAVSVolumeMapper_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkHAVSVolumeMapper::NewInstance();
      }
...
PyvtkHAVSVolumeMapper_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkHAVSVolumeMapper::SafeDownCast(temp0);
...
PyvtkHAVSVolumeMapper_GetPartiallyRemoveNonConvexities(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetPartiallyRemoveNonConvexities();
      }
    else
      {
      tempr = op->vtkHAVSVolumeMapper::GetPartiallyRemoveNonConvexities();
      }
...
PyvtkHAVSVolumeMapper_GetLevelOfDetailTargetTime(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetLevelOfDetailTargetTime();
      }
    else
      {
      tempr = op->vtkHAVSVolumeMapper::GetLevelOfDetailTargetTime();
      }
...
PyvtkHAVSVolumeMapper_GetLevelOfDetail(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetLevelOfDetail();
      }
    else
      {
      tempr = op->vtkHAVSVolumeMapper::GetLevelOfDetail();
      }
...
PyvtkHAVSVolumeMapper_GetLevelOfDetailMethod(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetLevelOfDetailMethod();
      }
    else
      {
      tempr = op->vtkHAVSVolumeMapper::GetLevelOfDetailMethod();
      }
...
PyvtkHAVSVolumeMapper_GetKBufferSize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetKBufferSize();
      }
    else
      {
      tempr = op->vtkHAVSVolumeMapper::GetKBufferSize();
      }
...
PyvtkHAVSVolumeMapper_SupportedByHardware(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->SupportedByHardware(temp0);
      }
    else
      {
      tempr = op->vtkHAVSVolumeMapper::SupportedByHardware(temp0);
      }
...
PyvtkHAVSVolumeMapper_GetGPUDataStructures(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetGPUDataStructures();
      }
    else
      {
      tempr = op->vtkHAVSVolumeMapper::GetGPUDataStructures();
      }
...
static PyMethodDef PyvtkHAVSVolumeMapper_Methods[] = {
  {(char*)"GetClassName", PyvtkHAVSVolumeMapper_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkHAVSVolumeMapper_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkHAVSVolumeMapper_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkHAVSVolumeMapper\nC++: vtkHAVSVolumeMapper *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkHAVSVolumeMapper_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkHAVSVolumeMapper\nC++: vtkHAVSVolumeMapper *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetPartiallyRemoveNonConvexities", PyvtkHAVSVolumeMapper_SetPartiallyRemoveNonConvexities, 1,
  ...
  {(char*)"GetPartiallyRemoveNonConvexities", PyvtkHAVSVolumeMapper_GetPartiallyRemoveNonConvexities, 1,
   (char*)"V.GetPartiallyRemoveNonConvexities() -> bool\nC++: bool GetPartiallyRemoveNonConvexities()\n\nregions by removing ray segments larger than the max cell size.\n"},
  {(char*)"SetLevelOfDetailTargetTime", PyvtkHAVSVolumeMapper_SetLevelOfDetailTargetTime, 1,
  ...
  {(char*)"GetLevelOfDetailTargetTime", PyvtkHAVSVolumeMapper_GetLevelOfDetailTargetTime, 1,
   (char*)"V.GetLevelOfDetailTargetTime() -> float\nC++: float GetLevelOfDetailTargetTime()\n\nSet/get the desired level of detail target time measured in\nframes/sec.\n"},
  {(char*)"SetLevelOfDetail", PyvtkHAVSVolumeMapper_SetLevelOfDetail, 1,
   (char*)"V.SetLevelOfDetail(bool)\nC++: void SetLevelOfDetail(bool a)\n\nTurn on/off level-of-detail volume rendering\n"},
  {(char*)"GetLevelOfDetail", PyvtkHAVSVolumeMapper_GetLevelOfDetail, 1,
   (char*)"V.GetLevelOfDetail() -> bool\nC++: bool GetLevelOfDetail()\n\nTurn on/off level-of-detail volume rendering\n"},
  {(char*)"SetLevelOfDetailMethod", PyvtkHAVSVolumeMapper_SetLevelOfDetailMethod, 1,
   (char*)"V.SetLevelOfDetailMethod(int)\nC++: void SetLevelOfDetailMethod(int)\n\nSet/get the current level-of-detail method\n"},
  {(char*)"GetLevelOfDetailMethod", PyvtkHAVSVolumeMapper_GetLevelOfDetailMethod, 1,
   (char*)"V.GetLevelOfDetailMethod() -> int\nC++: int GetLevelOfDetailMethod()\n\nSet/get the current level-of-detail method\n"},
  {(char*)"SetLevelOfDetailMethodField", PyvtkHAVSVolumeMapper_SetLevelOfDetailMethodField, 1,
   (char*)"V.SetLevelOfDetailMethodField()\nC++: void SetLevelOfDetailMethodField()\n\nSet/get the current level-of-detail method\n"},
  {(char*)"SetLevelOfDetailMethodArea", PyvtkHAVSVolumeMapper_SetLevelOfDetailMethodArea, 1,
   (char*)"V.SetLevelOfDetailMethodArea()\nC++: void SetLevelOfDetailMethodArea()\n\nSet/get the current level-of-detail method\n"},
  {(char*)"SetKBufferSize", PyvtkHAVSVolumeMapper_SetKBufferSize, 1,
   (char*)"V.SetKBufferSize(int)\nC++: void SetKBufferSize(int a)\n\nSet the kbuffer size\n"},
  {(char*)"GetKBufferSize", PyvtkHAVSVolumeMapper_GetKBufferSize, 1,
   (char*)"V.GetKBufferSize() -> int\nC++: int GetKBufferSize()\n\nSet the kbuffer size\n"},
  {(char*)"SetKBufferSizeTo2", PyvtkHAVSVolumeMapper_SetKBufferSizeTo2, 1,
   (char*)"V.SetKBufferSizeTo2()\nC++: void SetKBufferSizeTo2()\n\nSet the kbuffer size\n"},
  {(char*)"SetKBufferSizeTo6", PyvtkHAVSVolumeMapper_SetKBufferSizeTo6, 1,
   (char*)"V.SetKBufferSizeTo6()\nC++: void SetKBufferSizeTo6()\n\nSet the kbuffer size\n"},
  {(char*)"SupportedByHardware", PyvtkHAVSVolumeMapper_SupportedByHardware, 1,
  ...
  {(char*)"SetGPUDataStructures", PyvtkHAVSVolumeMapper_SetGPUDataStructures, 1,
  ...
  {(char*)"GetGPUDataStructures", PyvtkHAVSVolumeMapper_GetGPUDataStructures, 1,
  ...
  PyObject *dict, const char *modulename)
{
  ...
  o = PyInt_FromLong(0);
  if (o && PyDict_SetItemString(dict, (char *)"VTK_KBUFFER_SIZE_2", o) != 0)
    {
    Py_DECREF(o);
    }

  o = PyInt_FromLong(1);
  if (o && PyDict_SetItemString(dict, (char *)"VTK_KBUFFER_SIZE_6", o) != 0)
    {
    Py_DECREF(o);
    }

  o = PyInt_FromLong(0);
  if (o && PyDict_SetItemString(dict, (char *)"VTK_FIELD_LEVEL_OF_DETAIL", o) != 0)
    {
    Py_DECREF(o);
    }

  o = PyInt_FromLong(1);
  if (o && PyDict_SetItemString(dict, (char *)"VTK_AREA_LEVEL_OF_DETAIL", o) != 0)
    {
    Py_DECREF(o);
    }
