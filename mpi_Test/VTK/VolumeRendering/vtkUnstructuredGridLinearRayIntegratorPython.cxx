...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkUnstructuredGridLinearRayIntegrator(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkUnstructuredGridLinearRayIntegrator(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkUnstructuredGridLinearRayIntegratorNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkUnstructuredGridLinearRayIntegratorNew(const char *); }
#endif
...
PyvtkUnstructuredGridLinearRayIntegrator_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUnstructuredGridLinearRayIntegrator::GetClassName();
      }
...
PyvtkUnstructuredGridLinearRayIntegrator_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUnstructuredGridLinearRayIntegrator::IsA(temp0);
      }
...
PyvtkUnstructuredGridLinearRayIntegrator_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkUnstructuredGridLinearRayIntegrator *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUnstructuredGridLinearRayIntegrator::NewInstance();
      }
...
PyvtkUnstructuredGridLinearRayIntegrator_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkUnstructuredGridLinearRayIntegrator::SafeDownCast(temp0);
...
static PyMethodDef PyvtkUnstructuredGridLinearRayIntegrator_IntegrateRay_Methods[] = {
  {NULL, PyvtkUnstructuredGridLinearRayIntegrator_IntegrateRay_s1, 1,
   (char*)"dddddO *f"},
  {NULL, PyvtkUnstructuredGridLinearRayIntegrator_IntegrateRay_s2, 1,
   (char*)"dOdOdO *d *d *f"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkUnstructuredGridLinearRayIntegrator_Psi(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(3) &&
      ...
      ap.GetValue(temp2))
    {
    tempr = vtkUnstructuredGridLinearRayIntegrator::Psi(temp0, temp1, temp2);
...
static PyMethodDef PyvtkUnstructuredGridLinearRayIntegrator_Methods[] = {
  {(char*)"GetClassName", PyvtkUnstructuredGridLinearRayIntegrator_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkUnstructuredGridLinearRayIntegrator_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkUnstructuredGridLinearRayIntegrator_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkUnstructuredGridLinearRayIntegrator\nC++: vtkUnstructuredGridLinearRayIntegrator *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkUnstructuredGridLinearRayIntegrator_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject)\n    -> vtkUnstructuredGridLinearRayIntegrator\nC++: vtkUnstructuredGridLinearRayIntegrator *SafeDownCast(\n    vtkObject* o)\n\n"},
  {(char*)"Initialize", PyvtkUnstructuredGridLinearRayIntegrator_Initialize, 1,
   (char*)"V.Initialize(vtkVolume, vtkDataArray)\nC++: virtual void Initialize(vtkVolume *volume,\n    vtkDataArray *scalars)\n\n"},
  {(char*)"Integrate", PyvtkUnstructuredGridLinearRayIntegrator_Integrate, 1,
  ...
  {(char*)"IntegrateRay", PyvtkUnstructuredGridLinearRayIntegrator_IntegrateRay, 1,
  ...
  {(char*)"Psi", PyvtkUnstructuredGridLinearRayIntegrator_Psi, 1,
