...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkUTF8TextCodec(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkUTF8TextCodec(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkUTF8TextCodecNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkUTF8TextCodecNew(const char *); }
#endif
...
PyvtkUTF8TextCodec_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUTF8TextCodec::GetClassName();
      }
...
PyvtkUTF8TextCodec_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUTF8TextCodec::IsA(temp0);
      }
...
PyvtkUTF8TextCodec_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUTF8TextCodec::NewInstance();
      }
...
PyvtkUTF8TextCodec_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkUTF8TextCodec::SafeDownCast(temp0);
...
PyvtkUTF8TextCodec_Name(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUTF8TextCodec::Name();
      }
...
PyvtkUTF8TextCodec_CanHandle(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUTF8TextCodec::CanHandle(temp0);
      }
