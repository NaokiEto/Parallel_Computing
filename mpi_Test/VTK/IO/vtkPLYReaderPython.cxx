...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPLYReader(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPLYReader(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPLYReaderNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkPLYReaderNew(const char *); }
#endif
...
PyvtkPLYReader_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPLYReader::GetClassName();
      }
...
PyvtkPLYReader_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPLYReader::IsA(temp0);
      }
...
PyvtkPLYReader_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPLYReader::NewInstance();
      }
...
PyvtkPLYReader_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPLYReader::SafeDownCast(temp0);
...
PyvtkPLYReader_GetFileName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPLYReader::GetFileName();
      }
...
PyvtkPLYReader_CanReadFile(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    tempr = vtkPLYReader::CanReadFile(temp0);
...
static PyMethodDef PyvtkPLYReader_Methods[] = {
  {(char*)"GetClassName", PyvtkPLYReader_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPLYReader_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPLYReader_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPLYReader\nC++: vtkPLYReader *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPLYReader_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPLYReader\nC++: vtkPLYReader *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetFileName", PyvtkPLYReader_SetFileName, 1,
   (char*)"V.SetFileName(string)\nC++: void SetFileName(char *)\n\nSpecify file name of stereo lithography file.\n"},
  {(char*)"GetFileName", PyvtkPLYReader_GetFileName, 1,
   (char*)"V.GetFileName() -> string\nC++: char *GetFileName()\n\nSpecify file name of stereo lithography file.\n"},
  {(char*)"CanReadFile", PyvtkPLYReader_CanReadFile, 1,
