...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkEnSight6Reader(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkEnSight6Reader(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkEnSight6ReaderNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkEnSight6ReaderNew(const char *); }
#endif
...
PyvtkEnSight6Reader_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEnSight6Reader::GetClassName();
      }
...
PyvtkEnSight6Reader_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEnSight6Reader::IsA(temp0);
      }
...
PyvtkEnSight6Reader_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEnSight6Reader::NewInstance();
      }
...
PyvtkEnSight6Reader_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkEnSight6Reader::SafeDownCast(temp0);
...
static PyMethodDef PyvtkEnSight6Reader_Methods[] = {
  {(char*)"GetClassName", PyvtkEnSight6Reader_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkEnSight6Reader_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkEnSight6Reader_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkEnSight6Reader\nC++: vtkEnSight6Reader *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkEnSight6Reader_SafeDownCast, 1,
