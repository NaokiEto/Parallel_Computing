...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPolyDataWriter(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPolyDataWriter(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPolyDataWriterNew(const char *); }
#else
...
PyvtkPolyDataWriter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyDataWriter::GetClassName();
      }
...
PyvtkPolyDataWriter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyDataWriter::IsA(temp0);
      }
...
PyvtkPolyDataWriter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyDataWriter::NewInstance();
      }
...
PyvtkPolyDataWriter_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPolyDataWriter::SafeDownCast(temp0);
...
PyvtkPolyDataWriter_GetInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyDataWriter::GetInput();
      }
...
PyvtkPolyDataWriter_GetInput_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyDataWriter::GetInput(temp0);
      }
...
static PyMethodDef PyvtkPolyDataWriter_Methods[] = {
  {(char*)"GetClassName", PyvtkPolyDataWriter_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPolyDataWriter_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPolyDataWriter_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPolyDataWriter\nC++: vtkPolyDataWriter *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPolyDataWriter_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPolyDataWriter\nC++: vtkPolyDataWriter *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetInput", PyvtkPolyDataWriter_GetInput, 1,
