...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkMutableDirectedGraph(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkMutableDirectedGraph(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkMutableDirectedGraphNew(const char *); }
#else
...
PyvtkMutableDirectedGraph_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMutableDirectedGraph::GetClassName();
      }
...
PyvtkMutableDirectedGraph_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMutableDirectedGraph::IsA(temp0);
      }
...
PyvtkMutableDirectedGraph_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMutableDirectedGraph::NewInstance();
      }
...
PyvtkMutableDirectedGraph_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkMutableDirectedGraph::SafeDownCast(temp0);
...
PyvtkMutableDirectedGraph_SetNumberOfVertices(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMutableDirectedGraph::SetNumberOfVertices(temp0);
      }
...
PyvtkMutableDirectedGraph_AddVertex_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMutableDirectedGraph::AddVertex();
      }
...
PyvtkMutableDirectedGraph_AddVertex_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMutableDirectedGraph::AddVertex(temp0);
      }
...
static PyMethodDef PyvtkMutableDirectedGraph_AddVertex_Methods[] = {
  {NULL, PyvtkMutableDirectedGraph_AddVertex_s2, 1,
   (char*)"@O *vtkVariantArray"},
  {NULL, PyvtkMutableDirectedGraph_AddVertex_s3, 1,
   (char*)"@O &vtkVariant"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMutableDirectedGraph_LazyAddVertex_Methods[] = {
  {NULL, PyvtkMutableDirectedGraph_LazyAddVertex_s2, 1,
   (char*)"@O *vtkVariantArray"},
  {NULL, PyvtkMutableDirectedGraph_LazyAddVertex_s3, 1,
   (char*)"@O &vtkVariant"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMutableDirectedGraph_LazyAddEdge_Methods[] = {
  {NULL, PyvtkMutableDirectedGraph_LazyAddEdge_s1, 1,
   (char*)"@LL|O *vtkVariantArray"},
  {NULL, PyvtkMutableDirectedGraph_LazyAddEdge_s2, 1,
   (char*)"@OL|O &vtkVariant *vtkVariantArray"},
  {NULL, PyvtkMutableDirectedGraph_LazyAddEdge_s3, 1,
   (char*)"@LO|O &vtkVariant *vtkVariantArray"},
  {NULL, PyvtkMutableDirectedGraph_LazyAddEdge_s4, 1,
...
PyvtkMutableDirectedGraph_AddGraphEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMutableDirectedGraph::AddGraphEdge(temp0, temp1);
      }
...
PyvtkMutableDirectedGraph_AddChild_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->AddChild(temp0, temp1);
      }
    else
      {
      tempr = op->vtkMutableDirectedGraph::AddChild(temp0, temp1);
      }
...
PyvtkMutableDirectedGraph_AddChild_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->AddChild(temp0);
      }
    else
      {
      tempr = op->vtkMutableDirectedGraph::AddChild(temp0);
      }
...
static PyMethodDef PyvtkMutableDirectedGraph_Methods[] = {
  {(char*)"GetClassName", PyvtkMutableDirectedGraph_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkMutableDirectedGraph_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkMutableDirectedGraph_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkMutableDirectedGraph\nC++: vtkMutableDirectedGraph *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkMutableDirectedGraph_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkMutableDirectedGraph\nC++: vtkMutableDirectedGraph *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetNumberOfVertices", PyvtkMutableDirectedGraph_SetNumberOfVertices, 1,
  ...
  {(char*)"AddVertex", PyvtkMutableDirectedGraph_AddVertex, 1,
  ...
  {(char*)"LazyAddVertex", PyvtkMutableDirectedGraph_LazyAddVertex, 1,
  ...
  {(char*)"LazyAddEdge", PyvtkMutableDirectedGraph_LazyAddEdge, 1,
  ...
  {(char*)"AddGraphEdge", PyvtkMutableDirectedGraph_AddGraphEdge, 1,
  ...
  {(char*)"AddChild", PyvtkMutableDirectedGraph_AddChild, 1,
  ...
  {(char*)"RemoveVertex", PyvtkMutableDirectedGraph_RemoveVertex, 1,
  ...
  {(char*)"RemoveEdge", PyvtkMutableDirectedGraph_RemoveEdge, 1,
  ...
  {(char*)"RemoveVertices", PyvtkMutableDirectedGraph_RemoveVertices, 1,
  ...
  {(char*)"RemoveEdges", PyvtkMutableDirectedGraph_RemoveEdges, 1,
