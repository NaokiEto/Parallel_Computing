...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkIncrementalOctreeNode(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkIncrementalOctreeNode(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkIncrementalOctreeNodeNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkIncrementalOctreeNodeNew(const char *); }
#endif
...
PyvtkIncrementalOctreeNode_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::GetClassName();
      }
...
PyvtkIncrementalOctreeNode_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::IsA(temp0);
      }
...
PyvtkIncrementalOctreeNode_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkIncrementalOctreeNode *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::NewInstance();
      }
...
PyvtkIncrementalOctreeNode_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkIncrementalOctreeNode::SafeDownCast(temp0);
...
PyvtkIncrementalOctreeNode_GetNumberOfPoints(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::GetNumberOfPoints();
      }
...
PyvtkIncrementalOctreeNode_GetPointIdSet(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetPointIdSet();
      }
    else
      {
      tempr = op->vtkIncrementalOctreeNode::GetPointIdSet();
      }
...
PyvtkIncrementalOctreeNode_GetMinBounds(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::GetMinBounds();
      }
...
PyvtkIncrementalOctreeNode_GetMaxBounds(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::GetMaxBounds();
      }
...
PyvtkIncrementalOctreeNode_IsLeaf(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::IsLeaf();
      }
...
PyvtkIncrementalOctreeNode_GetChildIndex(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetChildIndex(temp0);
      }
    else
      {
      tempr = op->vtkIncrementalOctreeNode::GetChildIndex(temp0);
      }
...
PyvtkIncrementalOctreeNode_GetChild(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::GetChild(temp0);
      }
...
PyvtkIncrementalOctreeNode_ContainsPoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->ContainsPoint(temp0);
      }
    else
      {
      tempr = op->vtkIncrementalOctreeNode::ContainsPoint(temp0);
      }
...
PyvtkIncrementalOctreeNode_ContainsPointByData(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->ContainsPointByData(temp0);
      }
    else
      {
      tempr = op->vtkIncrementalOctreeNode::ContainsPointByData(temp0);
      }
...
PyvtkIncrementalOctreeNode_GetDistance2ToInnerBoundary(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDistance2ToInnerBoundary(temp0, temp1);
      }
    else
      {
      tempr = op->vtkIncrementalOctreeNode::GetDistance2ToInnerBoundary(temp0, temp1);
      }
...
PyvtkIncrementalOctreeNode_GetDistance2ToBoundary_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDistance2ToBoundary(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkIncrementalOctreeNode::GetDistance2ToBoundary(temp0, temp1, temp2);
      }
...
PyvtkIncrementalOctreeNode_GetDistance2ToBoundary_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIncrementalOctreeNode::GetDistance2ToBoundary(temp0, temp1, temp2, temp3);
      }
...
static PyMethodDef PyvtkIncrementalOctreeNode_Methods[] = {
  ...
  {(char*)"GetBounds", PyvtkIncrementalOctreeNode_GetBounds, 1,
  ...
  {(char*)"GetMinBounds", PyvtkIncrementalOctreeNode_GetMinBounds, 1,
   (char*)"V.GetMinBounds() -> (float, float, float)\nC++: double *GetMinBounds()\n\n"},
  {(char*)"GetMaxBounds", PyvtkIncrementalOctreeNode_GetMaxBounds, 1,
   (char*)"V.GetMaxBounds() -> (float, float, float)\nC++: double *GetMaxBounds()\n\n"},
  {(char*)"IsLeaf", PyvtkIncrementalOctreeNode_IsLeaf, 1,
   (char*)"V.IsLeaf() -> int\nC++: int IsLeaf()\n\nDetermine whether or not this node is a leaf.\n"},
  {(char*)"GetChildIndex", PyvtkIncrementalOctreeNode_GetChildIndex, 1,
  ...
  {(char*)"GetChild", PyvtkIncrementalOctreeNode_GetChild, 1,
  ...
  {(char*)"ContainsPoint", PyvtkIncrementalOctreeNode_ContainsPoint, 1,
  ...
  {(char*)"ContainsPointByData", PyvtkIncrementalOctreeNode_ContainsPointByData, 1,
  ...
  {(char*)"GetDistance2ToInnerBoundary", PyvtkIncrementalOctreeNode_GetDistance2ToInnerBoundary, 1,
  ...
  {(char*)"GetDistance2ToBoundary", PyvtkIncrementalOctreeNode_GetDistance2ToBoundary, 1,
  ...
  {(char*)"ExportAllPointIdsByInsertion", PyvtkIncrementalOctreeNode_ExportAllPointIdsByInsertion, 1,
