...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkStructuredGridAlgorithm(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkStructuredGridAlgorithm(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkStructuredGridAlgorithmNew(const char *); }
#else
...
PyvtkStructuredGridAlgorithm_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridAlgorithm::GetClassName();
      }
...
PyvtkStructuredGridAlgorithm_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridAlgorithm::IsA(temp0);
      }
...
PyvtkStructuredGridAlgorithm_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkStructuredGridAlgorithm *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridAlgorithm::NewInstance();
      }
...
PyvtkStructuredGridAlgorithm_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkStructuredGridAlgorithm::SafeDownCast(temp0);
...
PyvtkStructuredGridAlgorithm_GetOutput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridAlgorithm::GetOutput();
      }
...
PyvtkStructuredGridAlgorithm_GetOutput_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridAlgorithm::GetOutput(temp0);
      }
...
PyvtkStructuredGridAlgorithm_GetInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridAlgorithm::GetInput();
      }
...
PyvtkStructuredGridAlgorithm_GetInput_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridAlgorithm::GetInput(temp0);
      }
...
PyvtkStructuredGridAlgorithm_GetStructuredGridInput(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetStructuredGridInput(temp0);
      }
    else
      {
      tempr = op->vtkStructuredGridAlgorithm::GetStructuredGridInput(temp0);
      }
...
static PyObject *
PyvtkStructuredGridAlgorithm_SetInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkStructuredGridAlgorithm::SetInput(temp0);
      }
...
static PyObject *
PyvtkStructuredGridAlgorithm_SetInput_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SetInput");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkStructuredGridAlgorithm *op = static_cast<vtkStructuredGridAlgorithm *>(vp);
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkStructuredGridAlgorithm::SetInput(temp0, temp1);
      }
...
static PyObject *
PyvtkStructuredGridAlgorithm_SetInput(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  switch(nargs)
    {
    case 1:
      return PyvtkStructuredGridAlgorithm_SetInput_s1(self, args);
    case 2:
      return PyvtkStructuredGridAlgorithm_SetInput_s2(self, args);
    }
...
static PyObject *
PyvtkStructuredGridAlgorithm_AddInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkStructuredGridAlgorithm::AddInput(temp0);
      }
...
static PyObject *
PyvtkStructuredGridAlgorithm_AddInput_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "AddInput");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkStructuredGridAlgorithm *op = static_cast<vtkStructuredGridAlgorithm *>(vp);
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkStructuredGridAlgorithm::AddInput(temp0, temp1);
      }
...
static PyObject *
PyvtkStructuredGridAlgorithm_AddInput(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  switch(nargs)
    {
    case 1:
      return PyvtkStructuredGridAlgorithm_AddInput_s1(self, args);
    case 2:
      return PyvtkStructuredGridAlgorithm_AddInput_s2(self, args);
    }
...
static PyMethodDef PyvtkStructuredGridAlgorithm_Methods[] = {
  {(char*)"GetClassName", PyvtkStructuredGridAlgorithm_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkStructuredGridAlgorithm_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkStructuredGridAlgorithm_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkStructuredGridAlgorithm\nC++: vtkStructuredGridAlgorithm *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkStructuredGridAlgorithm_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkStructuredGridAlgorithm\nC++: vtkStructuredGridAlgorithm *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetOutput", PyvtkStructuredGridAlgorithm_GetOutput, 1,
  ...
  {(char*)"AddInput", PyvtkStructuredGridAlgorithm_AddInput, 1,
