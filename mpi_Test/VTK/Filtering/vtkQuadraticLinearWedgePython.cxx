...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkQuadraticLinearWedge(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkQuadraticLinearWedge(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkQuadraticLinearWedgeNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkQuadraticLinearWedgeNew(const char *); }
#endif
...
PyvtkQuadraticLinearWedge_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetClassName();
      }
...
PyvtkQuadraticLinearWedge_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::IsA(temp0);
      }
...
PyvtkQuadraticLinearWedge_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::NewInstance();
      }
...
PyvtkQuadraticLinearWedge_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkQuadraticLinearWedge::SafeDownCast(temp0);
...
PyvtkQuadraticLinearWedge_GetCellType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetCellType();
      }
...
PyvtkQuadraticLinearWedge_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetCellDimension();
      }
...
PyvtkQuadraticLinearWedge_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetNumberOfEdges();
      }
...
PyvtkQuadraticLinearWedge_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetNumberOfFaces();
      }
...
PyvtkQuadraticLinearWedge_GetEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetEdge(temp0);
      }
...
PyvtkQuadraticLinearWedge_GetFace(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetFace(temp0);
      }
...
PyvtkQuadraticLinearWedge_CellBoundary(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::CellBoundary(temp0, temp1, temp2);
      }
...
PyvtkQuadraticLinearWedge_Triangulate(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::Triangulate(temp0, temp1, temp2);
      }
...
PyvtkQuadraticLinearWedge_IntersectWithLine(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6);
      }
...
PyvtkQuadraticLinearWedge_GetParametricCenter(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticLinearWedge::GetParametricCenter(temp0);
      }
...
static PyMethodDef PyvtkQuadraticLinearWedge_Methods[] = {
  {(char*)"GetClassName", PyvtkQuadraticLinearWedge_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkQuadraticLinearWedge_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkQuadraticLinearWedge_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkQuadraticLinearWedge\nC++: vtkQuadraticLinearWedge *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkQuadraticLinearWedge_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkQuadraticLinearWedge\nC++: vtkQuadraticLinearWedge *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetCellType", PyvtkQuadraticLinearWedge_GetCellType, 1,
   (char*)"V.GetCellType() -> int\nC++: int GetCellType()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetCellDimension", PyvtkQuadraticLinearWedge_GetCellDimension, 1,
   (char*)"V.GetCellDimension() -> int\nC++: int GetCellDimension()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetNumberOfEdges", PyvtkQuadraticLinearWedge_GetNumberOfEdges, 1,
   (char*)"V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetNumberOfFaces", PyvtkQuadraticLinearWedge_GetNumberOfFaces, 1,
   (char*)"V.GetNumberOfFaces() -> int\nC++: int GetNumberOfFaces()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetEdge", PyvtkQuadraticLinearWedge_GetEdge, 1,
   (char*)"V.GetEdge(int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId)\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetFace", PyvtkQuadraticLinearWedge_GetFace, 1,
   (char*)"V.GetFace(int) -> vtkCell\nC++: vtkCell *GetFace(int faceId)\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"CellBoundary", PyvtkQuadraticLinearWedge_CellBoundary, 1,
   (char*)"V.CellBoundary(int, [float, float, float], vtkIdList) -> int\nC++: int CellBoundary(int subId, double pcoords[3],\n    vtkIdList *pts)\n\n"},
  {(char*)"Contour", PyvtkQuadraticLinearWedge_Contour, 1,
  ...
  {(char*)"Triangulate", PyvtkQuadraticLinearWedge_Triangulate, 1,
   (char*)"V.Triangulate(int, vtkIdList, vtkPoints) -> int\nC++: int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)\n\nThe quadratic linear wege is splitted into 4 linear wedges, each\nof them is contoured by a provided scalar value\n"},
  {(char*)"Clip", PyvtkQuadraticLinearWedge_Clip, 1,
  ...
  {(char*)"IntersectWithLine", PyvtkQuadraticLinearWedge_IntersectWithLine, 1,
  ...
  {(char*)"GetParametricCenter", PyvtkQuadraticLinearWedge_GetParametricCenter, 1,
  ...
  {(char*)"InterpolationFunctions", PyvtkQuadraticLinearWedge_InterpolationFunctions, 1,
  ...
  {(char*)"InterpolationDerivs", PyvtkQuadraticLinearWedge_InterpolationDerivs, 1,
  ...
  {(char*)"InterpolateFunctions", PyvtkQuadraticLinearWedge_InterpolateFunctions, 1,
  ...
  {(char*)"InterpolateDerivs", PyvtkQuadraticLinearWedge_InterpolateDerivs, 1,
