...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkTree(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkTree(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkTreeNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkTreeNew(const char *); }
#endif
...
PyvtkTree_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkTree::SafeDownCast(temp0);
...
PyvtkTree_GetDataObjectType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTree::GetDataObjectType();
      }
...
PyvtkTree_GetNumberOfChildren(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNumberOfChildren(temp0);
      }
    else
      {
      tempr = op->vtkTree::GetNumberOfChildren(temp0);
      }
...
PyvtkTree_GetChild(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetChild(temp0, temp1);
      }
    else
      {
      tempr = op->vtkTree::GetChild(temp0, temp1);
      }
...
PyvtkTree_GetParent(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetParent(temp0);
      }
    else
      {
      tempr = op->vtkTree::GetParent(temp0);
      }
...
PyvtkTree_GetLevel(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetLevel(temp0);
      }
    else
      {
      tempr = op->vtkTree::GetLevel(temp0);
      }
...
PyvtkTree_IsLeaf(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->IsLeaf(temp0);
      }
    else
      {
      tempr = op->vtkTree::IsLeaf(temp0);
      }
...
PyvtkTree_GetData_s2(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1, 2) &&
    ...
    {
    tempr = vtkTree::GetData(temp0, temp1);
...
static PyMethodDef PyvtkTree_GetData_Methods[] = {
  {NULL, PyvtkTree_GetData_s1, 1,
   (char*)"O *vtkInformation"},
  {NULL, PyvtkTree_GetData_s2, 1,
...
static PyMethodDef PyvtkTree_Methods[] = {
  ...
  {(char*)"GetParent", PyvtkTree_GetParent, 1,
   (char*)"V.GetParent(int) -> int\nC++: vtkIdType GetParent(vtkIdType v)\n\nGet the parent of a vertex.\n"},
  {(char*)"GetLevel", PyvtkTree_GetLevel, 1,
  ...
  {(char*)"ReorderChildren", PyvtkTree_ReorderChildren, 1,
