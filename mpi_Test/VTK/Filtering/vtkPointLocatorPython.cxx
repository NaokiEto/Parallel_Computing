...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPointLocator(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPointLocator(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPointLocatorNew(const char *); }
#else
...
PyvtkPointLocator_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::GetClassName();
      }
...
PyvtkPointLocator_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::IsA(temp0);
      }
...
PyvtkPointLocator_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::NewInstance();
      }
...
PyvtkPointLocator_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPointLocator::SafeDownCast(temp0);
...
PyvtkPointLocator_GetDivisions(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDivisions();
      }
    else
      {
      tempr = op->vtkPointLocator::GetDivisions();
      }
...
PyvtkPointLocator_GetNumberOfPointsPerBucketMinValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNumberOfPointsPerBucketMinValue();
      }
    else
      {
      tempr = op->vtkPointLocator::GetNumberOfPointsPerBucketMinValue();
      }
...
PyvtkPointLocator_GetNumberOfPointsPerBucketMaxValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNumberOfPointsPerBucketMaxValue();
      }
    else
      {
      tempr = op->vtkPointLocator::GetNumberOfPointsPerBucketMaxValue();
      }
...
PyvtkPointLocator_GetNumberOfPointsPerBucket(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNumberOfPointsPerBucket();
      }
    else
      {
      tempr = op->vtkPointLocator::GetNumberOfPointsPerBucket();
      }
...
PyvtkPointLocator_FindClosestPoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::FindClosestPoint(temp0);
      }
...
PyvtkPointLocator_FindClosestPointWithinRadius_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::FindClosestPointWithinRadius(temp0, temp1, temp2);
      }
...
PyvtkPointLocator_FindClosestPointWithinRadius_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->FindClosestPointWithinRadius(temp0, temp1, temp2, temp3);
      }
    else
      {
      tempr = op->vtkPointLocator::FindClosestPointWithinRadius(temp0, temp1, temp2, temp3);
      }
...
PyvtkPointLocator_InitPointInsertion_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::InitPointInsertion(temp0, temp1);
      }
...
PyvtkPointLocator_InitPointInsertion_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::InitPointInsertion(temp0, temp1, temp2);
      }
...
PyvtkPointLocator_InsertNextPoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::InsertNextPoint(temp0);
      }
...
PyvtkPointLocator_IsInsertedPoint_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::IsInsertedPoint(temp0, temp1, temp2);
      }
...
PyvtkPointLocator_IsInsertedPoint_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::IsInsertedPoint(temp0);
      }
...
PyvtkPointLocator_InsertUniquePoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::InsertUniquePoint(temp0, temp1);
      }
...
PyvtkPointLocator_FindClosestInsertedPoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::FindClosestInsertedPoint(temp0);
      }
...
PyvtkPointLocator_GetPointsInBucket(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetPointsInBucket(temp0, temp1);
      }
    else
      {
      tempr = op->vtkPointLocator::GetPointsInBucket(temp0, temp1);
      }
...
PyvtkPointLocator_GetPoints(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPointLocator::GetPoints();
      }
...
static PyMethodDef PyvtkPointLocator_Methods[] = {
  {(char*)"GetClassName", PyvtkPointLocator_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPointLocator_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPointLocator_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPointLocator\nC++: vtkPointLocator *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPointLocator_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPointLocator\nC++: vtkPointLocator *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetDivisions", PyvtkPointLocator_SetDivisions, 1,
   (char*)"V.SetDivisions(int, int, int)\nC++: void SetDivisions(int, int, int)\nV.SetDivisions((int, int, int))\nC++: void SetDivisions(int a[3])\n\n"},
  {(char*)"GetDivisions", PyvtkPointLocator_GetDivisions, 1,
   (char*)"V.GetDivisions() -> (int, int, int)\nC++: int *GetDivisions()\n\nSet the number of divisions in x-y-z directions.\n"},
  {(char*)"SetNumberOfPointsPerBucket", PyvtkPointLocator_SetNumberOfPointsPerBucket, 1,
   (char*)"V.SetNumberOfPointsPerBucket(int)\nC++: void SetNumberOfPointsPerBucket(int)\n\nSpecify the average number of points in each bucket.\n"},
  {(char*)"GetNumberOfPointsPerBucketMinValue", PyvtkPointLocator_GetNumberOfPointsPerBucketMinValue, 1,
   (char*)"V.GetNumberOfPointsPerBucketMinValue() -> int\nC++: int GetNumberOfPointsPerBucketMinValue()\n\nSpecify the average number of points in each bucket.\n"},
  {(char*)"GetNumberOfPointsPerBucketMaxValue", PyvtkPointLocator_GetNumberOfPointsPerBucketMaxValue, 1,
   (char*)"V.GetNumberOfPointsPerBucketMaxValue() -> int\nC++: int GetNumberOfPointsPerBucketMaxValue()\n\nSpecify the average number of points in each bucket.\n"},
  {(char*)"GetNumberOfPointsPerBucket", PyvtkPointLocator_GetNumberOfPointsPerBucket, 1,
   (char*)"V.GetNumberOfPointsPerBucket() -> int\nC++: int GetNumberOfPointsPerBucket()\n\nSpecify the average number of points in each bucket.\n"},
  {(char*)"FindClosestPoint", PyvtkPointLocator_FindClosestPoint, 1,
  ...
  {(char*)"FindClosestPointWithinRadius", PyvtkPointLocator_FindClosestPointWithinRadius, 1,
  ...
  {(char*)"InitPointInsertion", PyvtkPointLocator_InitPointInsertion, 1,
  ...
  {(char*)"InsertPoint", PyvtkPointLocator_InsertPoint, 1,
  ...
  {(char*)"InsertNextPoint", PyvtkPointLocator_InsertNextPoint, 1,
  ...
  {(char*)"IsInsertedPoint", PyvtkPointLocator_IsInsertedPoint, 1,
  ...
  {(char*)"InsertUniquePoint", PyvtkPointLocator_InsertUniquePoint, 1,
  ...
  {(char*)"FindClosestInsertedPoint", PyvtkPointLocator_FindClosestInsertedPoint, 1,
  ...
  {(char*)"FindClosestNPoints", PyvtkPointLocator_FindClosestNPoints, 1,
  ...
  {(char*)"FindDistributedPoints", PyvtkPointLocator_FindDistributedPoints, 1,
  ...
  {(char*)"FindPointsWithinRadius", PyvtkPointLocator_FindPointsWithinRadius, 1,
  ...
  {(char*)"GetPointsInBucket", PyvtkPointLocator_GetPointsInBucket, 1,
  ...
  {(char*)"GetPoints", PyvtkPointLocator_GetPoints, 1,
   (char*)"V.GetPoints() -> vtkPoints\nC++: vtkPoints *GetPoints()\n\nProvide an accessor to the points.\n"},
  {(char*)"Initialize", PyvtkPointLocator_Initialize, 1,
   (char*)"V.Initialize()\nC++: void Initialize()\n\nSee vtkLocator interface documentation. These methods are not\nthread safe.\n"},
  {(char*)"FreeSearchStructure", PyvtkPointLocator_FreeSearchStructure, 1,
   (char*)"V.FreeSearchStructure()\nC++: void FreeSearchStructure()\n\nSee vtkLocator interface documentation. These methods are not\nthread safe.\n"},
  {(char*)"BuildLocator", PyvtkPointLocator_BuildLocator, 1,
   (char*)"V.BuildLocator()\nC++: void BuildLocator()\n\nSee vtkLocator interface documentation. These methods are not\nthread safe.\n"},
  {(char*)"GenerateRepresentation", PyvtkPointLocator_GenerateRepresentation, 1,
