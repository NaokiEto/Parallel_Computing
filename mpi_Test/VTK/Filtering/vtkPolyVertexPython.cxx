...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPolyVertex(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPolyVertex(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPolyVertexNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkPolyVertexNew(const char *); }
#endif
...
PyvtkPolyVertex_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetClassName();
      }
...
PyvtkPolyVertex_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::IsA(temp0);
      }
...
PyvtkPolyVertex_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::NewInstance();
      }
...
PyvtkPolyVertex_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPolyVertex::SafeDownCast(temp0);
...
PyvtkPolyVertex_GetCellType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetCellType();
      }
...
PyvtkPolyVertex_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetCellDimension();
      }
...
PyvtkPolyVertex_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetNumberOfEdges();
      }
...
PyvtkPolyVertex_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetNumberOfFaces();
      }
...
PyvtkPolyVertex_GetEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetEdge(temp0);
      }
...
PyvtkPolyVertex_GetFace(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetFace(temp0);
      }
...
PyvtkPolyVertex_CellBoundary(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::CellBoundary(temp0, temp1, temp2);
      }
...
PyvtkPolyVertex_IntersectWithLine(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6);
      }
...
PyvtkPolyVertex_Triangulate(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::Triangulate(temp0, temp1, temp2);
      }
...
PyvtkPolyVertex_IsPrimaryCell(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::IsPrimaryCell();
      }
...
PyvtkPolyVertex_GetParametricCenter(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPolyVertex::GetParametricCenter(temp0);
      }
...
static PyMethodDef PyvtkPolyVertex_Methods[] = {
  ...
  {(char*)"IntersectWithLine", PyvtkPolyVertex_IntersectWithLine, 1,
  ...
  {(char*)"Triangulate", PyvtkPolyVertex_Triangulate, 1,
   (char*)"V.Triangulate(int, vtkIdList, vtkPoints) -> int\nC++: int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"IsPrimaryCell", PyvtkPolyVertex_IsPrimaryCell, 1,
   (char*)"V.IsPrimaryCell() -> int\nC++: int IsPrimaryCell()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetParametricCenter", PyvtkPolyVertex_GetParametricCenter, 1,
