...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPiecewiseFunctionAlgorithm(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPiecewiseFunctionAlgorithm(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPiecewiseFunctionAlgorithmNew(const char *); }
#else
...
PyvtkPiecewiseFunctionAlgorithm_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPiecewiseFunctionAlgorithm::GetClassName();
      }
...
PyvtkPiecewiseFunctionAlgorithm_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPiecewiseFunctionAlgorithm::IsA(temp0);
      }
...
PyvtkPiecewiseFunctionAlgorithm_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkPiecewiseFunctionAlgorithm *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPiecewiseFunctionAlgorithm::NewInstance();
      }
...
PyvtkPiecewiseFunctionAlgorithm_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPiecewiseFunctionAlgorithm::SafeDownCast(temp0);
...
PyvtkPiecewiseFunctionAlgorithm_GetOutput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPiecewiseFunctionAlgorithm::GetOutput();
      }
...
PyvtkPiecewiseFunctionAlgorithm_GetOutput_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPiecewiseFunctionAlgorithm::GetOutput(temp0);
      }
...
PyvtkPiecewiseFunctionAlgorithm_GetInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPiecewiseFunctionAlgorithm::GetInput();
      }
...
PyvtkPiecewiseFunctionAlgorithm_GetInput_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPiecewiseFunctionAlgorithm::GetInput(temp0);
      }
...
static PyObject *
PyvtkPiecewiseFunctionAlgorithm_SetInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPiecewiseFunctionAlgorithm::SetInput(temp0);
      }
...
static PyObject *
PyvtkPiecewiseFunctionAlgorithm_SetInput_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SetInput");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkPiecewiseFunctionAlgorithm *op = static_cast<vtkPiecewiseFunctionAlgorithm *>(vp);
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPiecewiseFunctionAlgorithm::SetInput(temp0, temp1);
      }
...
static PyObject *
PyvtkPiecewiseFunctionAlgorithm_SetInput(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  switch(nargs)
    {
    case 1:
      return PyvtkPiecewiseFunctionAlgorithm_SetInput_s1(self, args);
    case 2:
      return PyvtkPiecewiseFunctionAlgorithm_SetInput_s2(self, args);
    }
...
static PyObject *
PyvtkPiecewiseFunctionAlgorithm_AddInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPiecewiseFunctionAlgorithm::AddInput(temp0);
      }
...
static PyObject *
PyvtkPiecewiseFunctionAlgorithm_AddInput_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "AddInput");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkPiecewiseFunctionAlgorithm *op = static_cast<vtkPiecewiseFunctionAlgorithm *>(vp);
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPiecewiseFunctionAlgorithm::AddInput(temp0, temp1);
      }
...
static PyObject *
PyvtkPiecewiseFunctionAlgorithm_AddInput(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  switch(nargs)
    {
    case 1:
      return PyvtkPiecewiseFunctionAlgorithm_AddInput_s1(self, args);
    case 2:
      return PyvtkPiecewiseFunctionAlgorithm_AddInput_s2(self, args);
    }
...
static PyMethodDef PyvtkPiecewiseFunctionAlgorithm_Methods[] = {
  {(char*)"GetClassName", PyvtkPiecewiseFunctionAlgorithm_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPiecewiseFunctionAlgorithm_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPiecewiseFunctionAlgorithm_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPiecewiseFunctionAlgorithm\nC++: vtkPiecewiseFunctionAlgorithm *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPiecewiseFunctionAlgorithm_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPiecewiseFunctionAlgorithm\nC++: vtkPiecewiseFunctionAlgorithm *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetOutput", PyvtkPiecewiseFunctionAlgorithm_GetOutput, 1,
  ...
  {(char*)"SetOutput", PyvtkPiecewiseFunctionAlgorithm_SetOutput, 1,
   (char*)"V.SetOutput(vtkDataObject)\nC++: virtual void SetOutput(vtkDataObject *d)\n\nGet the output data object for a port on this algorithm.\n"},
  {(char*)"GetInput", PyvtkPiecewiseFunctionAlgorithm_GetInput, 1,
   (char*)"V.GetInput() -> vtkDataObject\nC++: vtkDataObject *GetInput()\nV.GetInput(int) -> vtkDataObject\nC++: vtkDataObject *GetInput(int port)\n\n"},
  {(char*)"SetInput", PyvtkPiecewiseFunctionAlgorithm_SetInput, 1,
  ...
  {(char*)"AddInput", PyvtkPiecewiseFunctionAlgorithm_AddInput, 1,
