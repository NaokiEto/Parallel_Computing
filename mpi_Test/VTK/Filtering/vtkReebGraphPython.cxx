...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkReebGraph(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkReebGraph(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkReebGraphNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkReebGraphNew(const char *); }
#endif
...
PyvtkReebGraph_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkReebGraph::GetClassName();
      }
...
PyvtkReebGraph_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkReebGraph::IsA(temp0);
      }
...
PyvtkReebGraph_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkReebGraph::NewInstance();
      }
...
PyvtkReebGraph_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkReebGraph::SafeDownCast(temp0);
...
PyvtkReebGraph_Build_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->Build(temp0, temp1);
      }
    else
      {
      tempr = op->vtkReebGraph::Build(temp0, temp1);
      }
...
static PyMethodDef PyvtkReebGraph_Build_Methods[] = {
  {NULL, PyvtkReebGraph_Build_s1, 1,
   (char*)"@OO *vtkPolyData *vtkDataArray"},
  {NULL, PyvtkReebGraph_Build_s2, 1,
   (char*)"@OO *vtkUnstructuredGrid *vtkDataArray"},
  {NULL, PyvtkReebGraph_Build_s3, 1,
   (char*)"@OL *vtkPolyData"},
  {NULL, PyvtkReebGraph_Build_s4, 1,
   (char*)"@OL *vtkUnstructuredGrid"},
  {NULL, PyvtkReebGraph_Build_s5, 1,
   (char*)"@Oz *vtkPolyData"},
  {NULL, PyvtkReebGraph_Build_s6, 1,
...
PyvtkReebGraph_StreamTriangle(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(6) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->StreamTriangle(temp0, temp1, temp2, temp3, temp4, temp5);
      }
    else
      {
      tempr = op->vtkReebGraph::StreamTriangle(temp0, temp1, temp2, temp3, temp4, temp5);
      }
...
PyvtkReebGraph_StreamTetrahedron(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(8) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->StreamTetrahedron(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7);
      }
    else
      {
      tempr = op->vtkReebGraph::StreamTetrahedron(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7);
      }
...
PyvtkReebGraph_Simplify(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->Simplify(temp0, temp1);
      }
    else
      {
      tempr = op->vtkReebGraph::Simplify(temp0, temp1);
      }
...
static PyMethodDef PyvtkReebGraph_Methods[] = {
  {(char*)"GetClassName", PyvtkReebGraph_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkReebGraph_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkReebGraph_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkReebGraph\nC++: vtkReebGraph *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkReebGraph_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkReebGraph\nC++: vtkReebGraph *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Build", PyvtkReebGraph_Build, 1,
  ...
  {(char*)"StreamTriangle", PyvtkReebGraph_StreamTriangle, 1,
  ...
  {(char*)"StreamTetrahedron", PyvtkReebGraph_StreamTetrahedron, 1,
  ...
  {(char*)"CloseStream", PyvtkReebGraph_CloseStream, 1,
  ...
  {(char*)"DeepCopy", PyvtkReebGraph_DeepCopy, 1,
   (char*)"V.DeepCopy(vtkDataObject)\nC++: void DeepCopy(vtkDataObject *src)\n\n"},
  {(char*)"Simplify", PyvtkReebGraph_Simplify, 1,
...
PyObject *PyVTKClass_vtkReebGraphNew(const char *modulename)
{
  ...
  if (cls)
    ...
    o = PyInt_FromLong(-3);
    if (o && PyDict_SetItemString(d, (char *)"ERR_NOT_A_SIMPLICIAL_MESH", o) != 0)
      {
      Py_DECREF(o);
      }
