...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPerlinNoise(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPerlinNoise(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPerlinNoiseNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkPerlinNoiseNew(const char *); }
#endif
...
PyvtkPerlinNoise_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerlinNoise::GetClassName();
      }
...
PyvtkPerlinNoise_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerlinNoise::IsA(temp0);
      }
...
PyvtkPerlinNoise_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerlinNoise::NewInstance();
      }
...
PyvtkPerlinNoise_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPerlinNoise::SafeDownCast(temp0);
...
PyvtkPerlinNoise_EvaluateFunction_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerlinNoise::EvaluateFunction(temp0);
      }
...
PyvtkPerlinNoise_EvaluateFunction_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerlinNoise::EvaluateFunction(temp0, temp1, temp2);
      }
...
PyvtkPerlinNoise_GetFrequency(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetFrequency();
      }
    else
      {
      tempr = op->vtkPerlinNoise::GetFrequency();
      }
...
PyvtkPerlinNoise_GetPhase(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerlinNoise::GetPhase();
      }
...
PyvtkPerlinNoise_GetAmplitude(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerlinNoise::GetAmplitude();
      }
...
static PyMethodDef PyvtkPerlinNoise_Methods[] = {
  {(char*)"GetClassName", PyvtkPerlinNoise_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPerlinNoise_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPerlinNoise_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPerlinNoise\nC++: vtkPerlinNoise *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPerlinNoise_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPerlinNoise\nC++: vtkPerlinNoise *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"EvaluateFunction", PyvtkPerlinNoise_EvaluateFunction, 1,
  ...
  {(char*)"EvaluateGradient", PyvtkPerlinNoise_EvaluateGradient, 1,
  ...
  {(char*)"SetFrequency", PyvtkPerlinNoise_SetFrequency, 1,
  ...
  {(char*)"GetFrequency", PyvtkPerlinNoise_GetFrequency, 1,
  ...
  {(char*)"SetPhase", PyvtkPerlinNoise_SetPhase, 1,
  ...
  {(char*)"GetPhase", PyvtkPerlinNoise_GetPhase, 1,
  ...
  {(char*)"SetAmplitude", PyvtkPerlinNoise_SetAmplitude, 1,
  ...
  {(char*)"GetAmplitude", PyvtkPerlinNoise_GetAmplitude, 1,
