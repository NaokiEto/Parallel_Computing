...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkSphere(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkSphere(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkSphereNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkSphereNew(const char *); }
#endif
...
PyvtkSphere_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphere::GetClassName();
      }
...
PyvtkSphere_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphere::NewInstance();
      }
...
PyvtkSphere_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkSphere::SafeDownCast(temp0);
...
PyvtkSphere_EvaluateFunction_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphere::EvaluateFunction(temp0);
      }
...
PyvtkSphere_EvaluateFunction_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSphere::EvaluateFunction(temp0, temp1, temp2);
      }
...
static PyMethodDef PyvtkSphere_Methods[] = {
  {(char*)"GetClassName", PyvtkSphere_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkSphere_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkSphere_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkSphere\nC++: vtkSphere *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkSphere_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkSphere\nC++: vtkSphere *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"EvaluateFunction", PyvtkSphere_EvaluateFunction, 1,
