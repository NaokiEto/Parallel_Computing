...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkUndirectedGraph(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkUndirectedGraph(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkUndirectedGraphNew(const char *); }
#else
...
PyvtkUndirectedGraph_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUndirectedGraph::GetClassName();
      }
...
PyvtkUndirectedGraph_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUndirectedGraph::IsA(temp0);
      }
...
PyvtkUndirectedGraph_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUndirectedGraph::NewInstance();
      }
...
PyvtkUndirectedGraph_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkUndirectedGraph::SafeDownCast(temp0);
...
PyvtkUndirectedGraph_GetDataObjectType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUndirectedGraph::GetDataObjectType();
      }
...
PyvtkUndirectedGraph_GetInDegree(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUndirectedGraph::GetInDegree(temp0);
      }
...
PyvtkUndirectedGraph_GetData_s1(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkUndirectedGraph::GetData(temp0);
...
PyvtkUndirectedGraph_GetData_s2(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1, 2) &&
    ...
    {
    tempr = vtkUndirectedGraph::GetData(temp0, temp1);
...
static PyMethodDef PyvtkUndirectedGraph_GetData_Methods[] = {
  {NULL, PyvtkUndirectedGraph_GetData_s1, 1,
   (char*)"O *vtkInformation"},
  {NULL, PyvtkUndirectedGraph_GetData_s2, 1,
...
PyvtkUndirectedGraph_IsStructureValid(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkUndirectedGraph::IsStructureValid(temp0);
      }
...
static PyMethodDef PyvtkUndirectedGraph_Methods[] = {
  {(char*)"GetClassName", PyvtkUndirectedGraph_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkUndirectedGraph_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkUndirectedGraph_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkUndirectedGraph\nC++: vtkUndirectedGraph *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkUndirectedGraph_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkUndirectedGraph\nC++: vtkUndirectedGraph *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetDataObjectType", PyvtkUndirectedGraph_GetDataObjectType, 1,
   (char*)"V.GetDataObjectType() -> int\nC++: virtual int GetDataObjectType()\n\nReturn what type of dataset this is.\n"},
  {(char*)"GetInDegree", PyvtkUndirectedGraph_GetInDegree, 1,
   (char*)"V.GetInDegree(int) -> int\nC++: virtual vtkIdType GetInDegree(vtkIdType v)\n\nReturns the full degree of the vertex.\n"},
  {(char*)"GetInEdge", PyvtkUndirectedGraph_GetInEdge, 1,
  ...
  {(char*)"GetData", PyvtkUndirectedGraph_GetData, 1,
  ...
  {(char*)"GetInEdges", PyvtkUndirectedGraph_GetInEdges, 1,
  ...
  {(char*)"IsStructureValid", PyvtkUndirectedGraph_IsStructureValid, 1,
