...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkInterpolatedVelocityField(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkInterpolatedVelocityField(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkInterpolatedVelocityFieldNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkInterpolatedVelocityFieldNew(const char *); }
#endif
...
PyvtkInterpolatedVelocityField_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInterpolatedVelocityField::GetClassName();
      }
...
PyvtkInterpolatedVelocityField_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInterpolatedVelocityField::IsA(temp0);
      }
...
PyvtkInterpolatedVelocityField_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkInterpolatedVelocityField *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInterpolatedVelocityField::NewInstance();
      }
...
PyvtkInterpolatedVelocityField_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkInterpolatedVelocityField::SafeDownCast(temp0);
...
static PyMethodDef PyvtkInterpolatedVelocityField_Methods[] = {
  {(char*)"GetClassName", PyvtkInterpolatedVelocityField_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkInterpolatedVelocityField_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkInterpolatedVelocityField_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkInterpolatedVelocityField\nC++: vtkInterpolatedVelocityField *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkInterpolatedVelocityField_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkInterpolatedVelocityField\nC++: vtkInterpolatedVelocityField *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"AddDataSet", PyvtkInterpolatedVelocityField_AddDataSet, 1,
  ...
  {(char*)"SetLastCellId", PyvtkInterpolatedVelocityField_SetLastCellId, 1,
