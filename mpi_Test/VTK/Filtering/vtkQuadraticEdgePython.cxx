...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkQuadraticEdge(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkQuadraticEdge(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkQuadraticEdgeNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkQuadraticEdgeNew(const char *); }
#endif
...
PyvtkQuadraticEdge_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetClassName();
      }
...
PyvtkQuadraticEdge_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::IsA(temp0);
      }
...
PyvtkQuadraticEdge_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::NewInstance();
      }
...
PyvtkQuadraticEdge_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkQuadraticEdge::SafeDownCast(temp0);
...
PyvtkQuadraticEdge_GetCellType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetCellType();
      }
...
PyvtkQuadraticEdge_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetCellDimension();
      }
...
PyvtkQuadraticEdge_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetNumberOfEdges();
      }
...
PyvtkQuadraticEdge_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetNumberOfFaces();
      }
...
PyvtkQuadraticEdge_GetEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetEdge(temp0);
      }
...
PyvtkQuadraticEdge_GetFace(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetFace(temp0);
      }
...
PyvtkQuadraticEdge_CellBoundary(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::CellBoundary(temp0, temp1, temp2);
      }
...
PyvtkQuadraticEdge_Triangulate(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::Triangulate(temp0, temp1, temp2);
      }
...
PyvtkQuadraticEdge_IntersectWithLine(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6);
      }
...
PyvtkQuadraticEdge_GetParametricCenter(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraticEdge::GetParametricCenter(temp0);
      }
...
static PyMethodDef PyvtkQuadraticEdge_Methods[] = {
  ...
  {(char*)"IntersectWithLine", PyvtkQuadraticEdge_IntersectWithLine, 1,
  ...
  {(char*)"GetParametricCenter", PyvtkQuadraticEdge_GetParametricCenter, 1,
  ...
  {(char*)"InterpolationFunctions", PyvtkQuadraticEdge_InterpolationFunctions, 1,
  ...
  {(char*)"InterpolationDerivs", PyvtkQuadraticEdge_InterpolationDerivs, 1,
  ...
  {(char*)"InterpolateFunctions", PyvtkQuadraticEdge_InterpolateFunctions, 1,
  ...
  {(char*)"InterpolateDerivs", PyvtkQuadraticEdge_InterpolateDerivs, 1,
