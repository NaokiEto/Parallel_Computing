...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkBalloonWidget(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkBalloonWidget(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkBalloonWidgetNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkBalloonWidgetNew(const char *); }
#endif
...
PyvtkBalloonWidget_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBalloonWidget::GetClassName();
      }
...
PyvtkBalloonWidget_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBalloonWidget::IsA(temp0);
      }
...
PyvtkBalloonWidget_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBalloonWidget::NewInstance();
      }
...
PyvtkBalloonWidget_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkBalloonWidget::SafeDownCast(temp0);
...
PyvtkBalloonWidget_GetBalloonRepresentation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetBalloonRepresentation();
      }
    else
      {
      tempr = op->vtkBalloonWidget::GetBalloonRepresentation();
      }
...
PyvtkBalloonWidget_GetBalloonString(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetBalloonString(temp0);
      }
    else
      {
      tempr = op->vtkBalloonWidget::GetBalloonString(temp0);
      }
...
PyvtkBalloonWidget_GetBalloonImage(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetBalloonImage(temp0);
      }
    else
      {
      tempr = op->vtkBalloonWidget::GetBalloonImage(temp0);
      }
...
PyvtkBalloonWidget_GetCurrentProp(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetCurrentProp();
      }
    else
      {
      tempr = op->vtkBalloonWidget::GetCurrentProp();
      }
...
PyvtkBalloonWidget_GetPicker(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBalloonWidget::GetPicker();
      }
...
static PyMethodDef PyvtkBalloonWidget_Methods[] = {
  {(char*)"GetClassName", PyvtkBalloonWidget_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\nStandard methods for a VTK class.\n"},
  {(char*)"IsA", PyvtkBalloonWidget_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\nStandard methods for a VTK class.\n"},
  {(char*)"NewInstance", PyvtkBalloonWidget_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkBalloonWidget\nC++: vtkBalloonWidget *NewInstance()\n\nStandard methods for a VTK class.\n"},
  {(char*)"SafeDownCast", PyvtkBalloonWidget_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkBalloonWidget\nC++: vtkBalloonWidget *SafeDownCast(vtkObject* o)\n\nStandard methods for a VTK class.\n"},
  {(char*)"SetEnabled", PyvtkBalloonWidget_SetEnabled, 1,
  ...
  {(char*)"SetRepresentation", PyvtkBalloonWidget_SetRepresentation, 1,
  ...
  {(char*)"GetBalloonRepresentation", PyvtkBalloonWidget_GetBalloonRepresentation, 1,
  ...
  {(char*)"CreateDefaultRepresentation", PyvtkBalloonWidget_CreateDefaultRepresentation, 1,
   (char*)"V.CreateDefaultRepresentation()\nC++: void CreateDefaultRepresentation()\n\nCreate the default widget representation if one is not set.\n"},
  {(char*)"AddBalloon", PyvtkBalloonWidget_AddBalloon, 1,
  ...
  {(char*)"RemoveBalloon", PyvtkBalloonWidget_RemoveBalloon, 1,
   (char*)"V.RemoveBalloon(vtkProp)\nC++: void RemoveBalloon(vtkProp *prop)\n\nAdd and remove text and/or an image to be associated with a\nvtkProp. You may add one or both of them.\n"},
  {(char*)"GetBalloonString", PyvtkBalloonWidget_GetBalloonString, 1,
  ...
  {(char*)"GetBalloonImage", PyvtkBalloonWidget_GetBalloonImage, 1,
   (char*)"V.GetBalloonImage(vtkProp) -> vtkImageData\nC++: vtkImageData *GetBalloonImage(vtkProp *prop)\n\nMethods to retrieve the information associated with each vtkProp\n(i.e., the information that makes up each balloon). A NULL will\nbe returned if the vtkProp does not exist, or if a string or\nimage have not been associated with the specified vtkProp.\n"},
  {(char*)"UpdateBalloonString", PyvtkBalloonWidget_UpdateBalloonString, 1,
  ...
  {(char*)"UpdateBalloonImage", PyvtkBalloonWidget_UpdateBalloonImage, 1,
   (char*)"V.UpdateBalloonImage(vtkProp, vtkImageData)\nC++: void UpdateBalloonImage(vtkProp *prop, vtkImageData *image)\n\nUpdate the balloon string or image. If the specified prop does\nnot exist, then nothing is added not changed.\n"},
  {(char*)"GetCurrentProp", PyvtkBalloonWidget_GetCurrentProp, 1,
  ...
  {(char*)"SetPicker", PyvtkBalloonWidget_SetPicker, 1,
  ...
  {(char*)"GetPicker", PyvtkBalloonWidget_GetPicker, 1,
