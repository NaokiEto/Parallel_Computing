...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImageActorPointPlacer(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImageActorPointPlacer(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImageActorPointPlacerNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImageActorPointPlacerNew(const char *); }
#endif
...
PyvtkImageActorPointPlacer_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::GetClassName();
      }
...
PyvtkImageActorPointPlacer_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::IsA(temp0);
      }
...
PyvtkImageActorPointPlacer_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkImageActorPointPlacer *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::NewInstance();
      }
...
PyvtkImageActorPointPlacer_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImageActorPointPlacer::SafeDownCast(temp0);
...
PyvtkImageActorPointPlacer_ComputeWorldPosition_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::ComputeWorldPosition(temp0, temp1, temp2, temp3);
      }
...
PyvtkImageActorPointPlacer_ComputeWorldPosition_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(5) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::ComputeWorldPosition(temp0, temp1, temp2, temp3, temp4);
      }
...
PyvtkImageActorPointPlacer_ValidateWorldPosition_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::ValidateWorldPosition(temp0);
      }
...
PyvtkImageActorPointPlacer_ValidateWorldPosition_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::ValidateWorldPosition(temp0, temp1);
      }
...
PyvtkImageActorPointPlacer_UpdateWorldPosition(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::UpdateWorldPosition(temp0, temp1, temp2);
      }
...
PyvtkImageActorPointPlacer_UpdateInternalState(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::UpdateInternalState();
      }
...
PyvtkImageActorPointPlacer_GetImageActor(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::GetImageActor();
      }
...
PyvtkImageActorPointPlacer_GetBounds(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImageActorPointPlacer::GetBounds();
      }
...
static PyMethodDef PyvtkImageActorPointPlacer_Methods[] = {
  {(char*)"GetClassName", PyvtkImageActorPointPlacer_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\nStandard methods for instances of this class.\n"},
  {(char*)"IsA", PyvtkImageActorPointPlacer_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\nStandard methods for instances of this class.\n"},
  {(char*)"NewInstance", PyvtkImageActorPointPlacer_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImageActorPointPlacer\nC++: vtkImageActorPointPlacer *NewInstance()\n\nStandard methods for instances of this class.\n"},
  {(char*)"SafeDownCast", PyvtkImageActorPointPlacer_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImageActorPointPlacer\nC++: vtkImageActorPointPlacer *SafeDownCast(vtkObject* o)\n\nStandard methods for instances of this class.\n"},
  {(char*)"ComputeWorldPosition", PyvtkImageActorPointPlacer_ComputeWorldPosition, 1,
  ...
  {(char*)"ValidateWorldPosition", PyvtkImageActorPointPlacer_ValidateWorldPosition, 1,
  ...
  {(char*)"UpdateWorldPosition", PyvtkImageActorPointPlacer_UpdateWorldPosition, 1,
  ...
  {(char*)"UpdateInternalState", PyvtkImageActorPointPlacer_UpdateInternalState, 1,
  ...
  {(char*)"SetImageActor", PyvtkImageActorPointPlacer_SetImageActor, 1,
  ...
  {(char*)"GetImageActor", PyvtkImageActorPointPlacer_GetImageActor, 1,
   (char*)"V.GetImageActor() -> vtkImageActor\nC++: vtkImageActor *GetImageActor()\n\nSet / get the reference vtkImageActor used to place the points.\nAn image actor must be set for this placer to work. An internal\nbounded plane point placer is created and set to match the bounds\nof the displayed image.\n"},
  {(char*)"SetBounds", PyvtkImageActorPointPlacer_SetBounds, 1,
  ...
  {(char*)"GetBounds", PyvtkImageActorPointPlacer_GetBounds, 1,
   (char*)"V.GetBounds() -> (float, float, float, float, float, float)\nC++: double *GetBounds()\n\n"},
  {(char*)"SetWorldTolerance", PyvtkImageActorPointPlacer_SetWorldTolerance, 1,
