...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkContourWidget(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkContourWidget(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkContourWidgetNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkContourWidgetNew(const char *); }
#endif
...
PyvtkContourWidget_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkContourWidget::GetClassName();
      }
...
PyvtkContourWidget_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkContourWidget::IsA(temp0);
      }
...
PyvtkContourWidget_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkContourWidget::NewInstance();
      }
...
PyvtkContourWidget_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkContourWidget::SafeDownCast(temp0);
...
PyvtkContourWidget_GetContourRepresentation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetContourRepresentation();
      }
    else
      {
      tempr = op->vtkContourWidget::GetContourRepresentation();
      }
...
PyvtkContourWidget_GetWidgetState(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkContourWidget::GetWidgetState();
      }
...
PyvtkContourWidget_GetAllowNodePicking(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetAllowNodePicking();
      }
    else
      {
      tempr = op->vtkContourWidget::GetAllowNodePicking();
      }
...
PyvtkContourWidget_GetFollowCursor(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetFollowCursor();
      }
    else
      {
      tempr = op->vtkContourWidget::GetFollowCursor();
      }
...
PyvtkContourWidget_GetContinuousDraw(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetContinuousDraw();
      }
    else
      {
      tempr = op->vtkContourWidget::GetContinuousDraw();
      }
...
PyvtkContourWidget_Initialize_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1, 2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkContourWidget::Initialize(temp0, temp1);
      }
...
static PyMethodDef PyvtkContourWidget_Methods[] = {
  {(char*)"GetClassName", PyvtkContourWidget_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\nStandard methods for a VTK class.\n"},
  {(char*)"IsA", PyvtkContourWidget_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\nStandard methods for a VTK class.\n"},
  {(char*)"NewInstance", PyvtkContourWidget_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkContourWidget\nC++: vtkContourWidget *NewInstance()\n\nStandard methods for a VTK class.\n"},
  {(char*)"SafeDownCast", PyvtkContourWidget_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkContourWidget\nC++: vtkContourWidget *SafeDownCast(vtkObject* o)\n\nStandard methods for a VTK class.\n"},
  {(char*)"SetEnabled", PyvtkContourWidget_SetEnabled, 1,
  ...
  {(char*)"SetRepresentation", PyvtkContourWidget_SetRepresentation, 1,
  ...
  {(char*)"GetContourRepresentation", PyvtkContourWidget_GetContourRepresentation, 1,
  ...
  {(char*)"GetAllowNodePicking", PyvtkContourWidget_GetAllowNodePicking, 1,
   (char*)"V.GetAllowNodePicking() -> int\nC++: int GetAllowNodePicking()\n\nSet / Get the AllowNodePicking value. This ivar indicates whether\nthe nodes and points between nodes can be picked/un-picked by\nCtrl+Click on the node.\n"},
  {(char*)"AllowNodePickingOn", PyvtkContourWidget_AllowNodePickingOn, 1,
   (char*)"V.AllowNodePickingOn()\nC++: void AllowNodePickingOn()\n\nSet / Get the AllowNodePicking value. This ivar indicates whether\nthe nodes and points between nodes can be picked/un-picked by\nCtrl+Click on the node.\n"},
  {(char*)"AllowNodePickingOff", PyvtkContourWidget_AllowNodePickingOff, 1,
   (char*)"V.AllowNodePickingOff()\nC++: void AllowNodePickingOff()\n\nSet / Get the AllowNodePicking value. This ivar indicates whether\nthe nodes and points between nodes can be picked/un-picked by\nCtrl+Click on the node.\n"},
  {(char*)"SetFollowCursor", PyvtkContourWidget_SetFollowCursor, 1,
  ...
  {(char*)"GetFollowCursor", PyvtkContourWidget_GetFollowCursor, 1,
   (char*)"V.GetFollowCursor() -> int\nC++: int GetFollowCursor()\n\nFollow the cursor ? If this is ON, during definition, the last\nnode of the contour will automatically follow the cursor, without\nwaiting for the the point to be dropped. This may be useful for\nsome interpolators, such as the live-wire interpolator to see the\nshape of the contour that will be placed as you move the mouse\ncursor.\n"},
  {(char*)"FollowCursorOn", PyvtkContourWidget_FollowCursorOn, 1,
   (char*)"V.FollowCursorOn()\nC++: void FollowCursorOn()\n\nFollow the cursor ? If this is ON, during definition, the last\nnode of the contour will automatically follow the cursor, without\nwaiting for the the point to be dropped. This may be useful for\nsome interpolators, such as the live-wire interpolator to see the\nshape of the contour that will be placed as you move the mouse\ncursor.\n"},
  {(char*)"FollowCursorOff", PyvtkContourWidget_FollowCursorOff, 1,
   (char*)"V.FollowCursorOff()\nC++: void FollowCursorOff()\n\nFollow the cursor ? If this is ON, during definition, the last\nnode of the contour will automatically follow the cursor, without\nwaiting for the the point to be dropped. This may be useful for\nsome interpolators, such as the live-wire interpolator to see the\nshape of the contour that will be placed as you move the mouse\ncursor.\n"},
  {(char*)"SetContinuousDraw", PyvtkContourWidget_SetContinuousDraw, 1,
