...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkImplicitPlaneWidget(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkImplicitPlaneWidget(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkImplicitPlaneWidgetNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkImplicitPlaneWidgetNew(const char *); }
#endif
...
PyvtkImplicitPlaneWidget_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetClassName();
      }
...
PyvtkImplicitPlaneWidget_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::IsA(temp0);
      }
...
PyvtkImplicitPlaneWidget_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::NewInstance();
      }
...
PyvtkImplicitPlaneWidget_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkImplicitPlaneWidget::SafeDownCast(temp0);
...
PyvtkImplicitPlaneWidget_GetOrigin_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetOrigin();
      }
...
PyvtkImplicitPlaneWidget_GetNormal_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetNormal();
      }
...
PyvtkImplicitPlaneWidget_GetNormalToXAxis(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetNormalToXAxis();
      }
...
PyvtkImplicitPlaneWidget_GetNormalToYAxis(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetNormalToYAxis();
      }
...
PyvtkImplicitPlaneWidget_GetNormalToZAxis(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetNormalToZAxis();
      }
...
PyvtkImplicitPlaneWidget_GetTubing(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetTubing();
      }
...
PyvtkImplicitPlaneWidget_GetDrawPlane(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetDrawPlane();
      }
...
PyvtkImplicitPlaneWidget_GetOutlineTranslation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetOutlineTranslation();
      }
...
PyvtkImplicitPlaneWidget_GetOutsideBounds(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetOutsideBounds();
      }
...
PyvtkImplicitPlaneWidget_GetScaleEnabled(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetScaleEnabled();
      }
...
PyvtkImplicitPlaneWidget_GetOriginTranslation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetOriginTranslation();
      }
...
PyvtkImplicitPlaneWidget_GetDiagonalRatioMinValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDiagonalRatioMinValue();
      }
    else
      {
      tempr = op->vtkImplicitPlaneWidget::GetDiagonalRatioMinValue();
      }
...
PyvtkImplicitPlaneWidget_GetDiagonalRatioMaxValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDiagonalRatioMaxValue();
      }
    else
      {
      tempr = op->vtkImplicitPlaneWidget::GetDiagonalRatioMaxValue();
      }
...
PyvtkImplicitPlaneWidget_GetDiagonalRatio(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDiagonalRatio();
      }
    else
      {
      tempr = op->vtkImplicitPlaneWidget::GetDiagonalRatio();
      }
...
PyvtkImplicitPlaneWidget_GetPolyDataAlgorithm(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetPolyDataAlgorithm();
      }
...
PyvtkImplicitPlaneWidget_GetNormalProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetNormalProperty();
      }
...
PyvtkImplicitPlaneWidget_GetSelectedNormalProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetSelectedNormalProperty();
      }
...
PyvtkImplicitPlaneWidget_GetPlaneProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetPlaneProperty();
      }
...
PyvtkImplicitPlaneWidget_GetSelectedPlaneProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetSelectedPlaneProperty();
      }
...
PyvtkImplicitPlaneWidget_GetOutlineProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetOutlineProperty();
      }
...
PyvtkImplicitPlaneWidget_GetSelectedOutlineProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetSelectedOutlineProperty();
      }
...
PyvtkImplicitPlaneWidget_GetEdgesProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkImplicitPlaneWidget::GetEdgesProperty();
      }
...
static PyMethodDef PyvtkImplicitPlaneWidget_Methods[] = {
  {(char*)"GetClassName", PyvtkImplicitPlaneWidget_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkImplicitPlaneWidget_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkImplicitPlaneWidget_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkImplicitPlaneWidget\nC++: vtkImplicitPlaneWidget *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkImplicitPlaneWidget_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkImplicitPlaneWidget\nC++: vtkImplicitPlaneWidget *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetEnabled", PyvtkImplicitPlaneWidget_SetEnabled, 1,
   (char*)"V.SetEnabled(int)\nC++: virtual void SetEnabled(int)\n\nMethods that satisfy the superclass' API.\n"},
  {(char*)"PlaceWidget", PyvtkImplicitPlaneWidget_PlaceWidget, 1,
  ...
  {(char*)"SetOrigin", PyvtkImplicitPlaneWidget_SetOrigin, 1,
  ...
  {(char*)"GetOrigin", PyvtkImplicitPlaneWidget_GetOrigin, 1,
   (char*)"V.GetOrigin() -> (float, float, float)\nC++: double *GetOrigin()\nV.GetOrigin([float, float, float])\nC++: void GetOrigin(double xyz[3])\n\nGet the origin of the plane.\n"},
  {(char*)"SetNormal", PyvtkImplicitPlaneWidget_SetNormal, 1,
  ...
  {(char*)"GetNormal", PyvtkImplicitPlaneWidget_GetNormal, 1,
   (char*)"V.GetNormal() -> (float, float, float)\nC++: double *GetNormal()\nV.GetNormal([float, float, float])\nC++: void GetNormal(double xyz[3])\n\nGet the normal to the plane.\n"},
  {(char*)"SetNormalToXAxis", PyvtkImplicitPlaneWidget_SetNormalToXAxis, 1,
  ...
  {(char*)"GetNormalToXAxis", PyvtkImplicitPlaneWidget_GetNormalToXAxis, 1,
   (char*)"V.GetNormalToXAxis() -> int\nC++: int GetNormalToXAxis()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"NormalToXAxisOn", PyvtkImplicitPlaneWidget_NormalToXAxisOn, 1,
   (char*)"V.NormalToXAxisOn()\nC++: void NormalToXAxisOn()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"NormalToXAxisOff", PyvtkImplicitPlaneWidget_NormalToXAxisOff, 1,
   (char*)"V.NormalToXAxisOff()\nC++: void NormalToXAxisOff()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"SetNormalToYAxis", PyvtkImplicitPlaneWidget_SetNormalToYAxis, 1,
   (char*)"V.SetNormalToYAxis(int)\nC++: void SetNormalToYAxis(int)\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"GetNormalToYAxis", PyvtkImplicitPlaneWidget_GetNormalToYAxis, 1,
   (char*)"V.GetNormalToYAxis() -> int\nC++: int GetNormalToYAxis()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"NormalToYAxisOn", PyvtkImplicitPlaneWidget_NormalToYAxisOn, 1,
   (char*)"V.NormalToYAxisOn()\nC++: void NormalToYAxisOn()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"NormalToYAxisOff", PyvtkImplicitPlaneWidget_NormalToYAxisOff, 1,
   (char*)"V.NormalToYAxisOff()\nC++: void NormalToYAxisOff()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"SetNormalToZAxis", PyvtkImplicitPlaneWidget_SetNormalToZAxis, 1,
   (char*)"V.SetNormalToZAxis(int)\nC++: void SetNormalToZAxis(int)\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"GetNormalToZAxis", PyvtkImplicitPlaneWidget_GetNormalToZAxis, 1,
   (char*)"V.GetNormalToZAxis() -> int\nC++: int GetNormalToZAxis()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"NormalToZAxisOn", PyvtkImplicitPlaneWidget_NormalToZAxisOn, 1,
   (char*)"V.NormalToZAxisOn()\nC++: void NormalToZAxisOn()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"NormalToZAxisOff", PyvtkImplicitPlaneWidget_NormalToZAxisOff, 1,
   (char*)"V.NormalToZAxisOff()\nC++: void NormalToZAxisOff()\n\nForce the plane widget to be aligned with one of the x-y-z axes.\nIf one axis is set on, the other two will be set off. Remember\nthat when the state changes, a ModifiedEvent is invoked. This can\nbe used to snap the plane to the axes if it is orginally not\naligned.\n"},
  {(char*)"SetTubing", PyvtkImplicitPlaneWidget_SetTubing, 1,
  ...
  {(char*)"GetTubing", PyvtkImplicitPlaneWidget_GetTubing, 1,
   (char*)"V.GetTubing() -> int\nC++: int GetTubing()\n\nTurn on/off tubing of the wire outline of the plane. The tube\nthickens the line by wrapping with a vtkTubeFilter.\n"},
  {(char*)"TubingOn", PyvtkImplicitPlaneWidget_TubingOn, 1,
   (char*)"V.TubingOn()\nC++: void TubingOn()\n\nTurn on/off tubing of the wire outline of the plane. The tube\nthickens the line by wrapping with a vtkTubeFilter.\n"},
  {(char*)"TubingOff", PyvtkImplicitPlaneWidget_TubingOff, 1,
   (char*)"V.TubingOff()\nC++: void TubingOff()\n\nTurn on/off tubing of the wire outline of the plane. The tube\nthickens the line by wrapping with a vtkTubeFilter.\n"},
  {(char*)"SetDrawPlane", PyvtkImplicitPlaneWidget_SetDrawPlane, 1,
   (char*)"V.SetDrawPlane(int)\nC++: void SetDrawPlane(int plane)\n\nEnable/disable the drawing of the plane. In some cases the plane\ninterferes with the object that it is operating on (i.e., the\nplane interferes with the cut surface it produces producing\nz-buffer artifacts.)\n"},
  {(char*)"GetDrawPlane", PyvtkImplicitPlaneWidget_GetDrawPlane, 1,
   (char*)"V.GetDrawPlane() -> int\nC++: int GetDrawPlane()\n\nEnable/disable the drawing of the plane. In some cases the plane\ninterferes with the object that it is operating on (i.e., the\nplane interferes with the cut surface it produces producing\nz-buffer artifacts.)\n"},
  {(char*)"DrawPlaneOn", PyvtkImplicitPlaneWidget_DrawPlaneOn, 1,
   (char*)"V.DrawPlaneOn()\nC++: void DrawPlaneOn()\n\nEnable/disable the drawing of the plane. In some cases the plane\ninterferes with the object that it is operating on (i.e., the\nplane interferes with the cut surface it produces producing\nz-buffer artifacts.)\n"},
  {(char*)"DrawPlaneOff", PyvtkImplicitPlaneWidget_DrawPlaneOff, 1,
   (char*)"V.DrawPlaneOff()\nC++: void DrawPlaneOff()\n\nEnable/disable the drawing of the plane. In some cases the plane\ninterferes with the object that it is operating on (i.e., the\nplane interferes with the cut surface it produces producing\nz-buffer artifacts.)\n"},
  {(char*)"SetOutlineTranslation", PyvtkImplicitPlaneWidget_SetOutlineTranslation, 1,
  ...
  {(char*)"GetOutlineTranslation", PyvtkImplicitPlaneWidget_GetOutlineTranslation, 1,
   (char*)"V.GetOutlineTranslation() -> int\nC++: int GetOutlineTranslation()\n\nTurn on/off the ability to translate the bounding box by grabbing\nit with the left mouse button.\n"},
  {(char*)"OutlineTranslationOn", PyvtkImplicitPlaneWidget_OutlineTranslationOn, 1,
   (char*)"V.OutlineTranslationOn()\nC++: void OutlineTranslationOn()\n\nTurn on/off the ability to translate the bounding box by grabbing\nit with the left mouse button.\n"},
  {(char*)"OutlineTranslationOff", PyvtkImplicitPlaneWidget_OutlineTranslationOff, 1,
   (char*)"V.OutlineTranslationOff()\nC++: void OutlineTranslationOff()\n\nTurn on/off the ability to translate the bounding box by grabbing\nit with the left mouse button.\n"},
  {(char*)"SetOutsideBounds", PyvtkImplicitPlaneWidget_SetOutsideBounds, 1,
  ...
  {(char*)"GetOutsideBounds", PyvtkImplicitPlaneWidget_GetOutsideBounds, 1,
   (char*)"V.GetOutsideBounds() -> int\nC++: int GetOutsideBounds()\n\nTurn on/off the ability to move the widget outside of the input's\nbound\n"},
  {(char*)"OutsideBoundsOn", PyvtkImplicitPlaneWidget_OutsideBoundsOn, 1,
   (char*)"V.OutsideBoundsOn()\nC++: void OutsideBoundsOn()\n\nTurn on/off the ability to move the widget outside of the input's\nbound\n"},
  {(char*)"OutsideBoundsOff", PyvtkImplicitPlaneWidget_OutsideBoundsOff, 1,
   (char*)"V.OutsideBoundsOff()\nC++: void OutsideBoundsOff()\n\nTurn on/off the ability to move the widget outside of the input's\nbound\n"},
  {(char*)"SetScaleEnabled", PyvtkImplicitPlaneWidget_SetScaleEnabled, 1,
   (char*)"V.SetScaleEnabled(int)\nC++: void SetScaleEnabled(int a)\n\nTurn on/off the ability to scale with the mouse\n"},
  {(char*)"GetScaleEnabled", PyvtkImplicitPlaneWidget_GetScaleEnabled, 1,
   (char*)"V.GetScaleEnabled() -> int\nC++: int GetScaleEnabled()\n\nTurn on/off the ability to scale with the mouse\n"},
  {(char*)"ScaleEnabledOn", PyvtkImplicitPlaneWidget_ScaleEnabledOn, 1,
   (char*)"V.ScaleEnabledOn()\nC++: void ScaleEnabledOn()\n\nTurn on/off the ability to scale with the mouse\n"},
  {(char*)"ScaleEnabledOff", PyvtkImplicitPlaneWidget_ScaleEnabledOff, 1,
   (char*)"V.ScaleEnabledOff()\nC++: void ScaleEnabledOff()\n\nTurn on/off the ability to scale with the mouse\n"},
  {(char*)"SetOriginTranslation", PyvtkImplicitPlaneWidget_SetOriginTranslation, 1,
  ...
  {(char*)"GetOriginTranslation", PyvtkImplicitPlaneWidget_GetOriginTranslation, 1,
   (char*)"V.GetOriginTranslation() -> int\nC++: int GetOriginTranslation()\n\nTurn on/off the ability to translate the origin (sphere) with the\nleft mouse button.\n"},
  {(char*)"OriginTranslationOn", PyvtkImplicitPlaneWidget_OriginTranslationOn, 1,
   (char*)"V.OriginTranslationOn()\nC++: void OriginTranslationOn()\n\nTurn on/off the ability to translate the origin (sphere) with the\nleft mouse button.\n"},
  {(char*)"OriginTranslationOff", PyvtkImplicitPlaneWidget_OriginTranslationOff, 1,
   (char*)"V.OriginTranslationOff()\nC++: void OriginTranslationOff()\n\nTurn on/off the ability to translate the origin (sphere) with the\nleft mouse button.\n"},
  {(char*)"SetDiagonalRatio", PyvtkImplicitPlaneWidget_SetDiagonalRatio, 1,
  ...
  {(char*)"GetDiagonalRatioMinValue", PyvtkImplicitPlaneWidget_GetDiagonalRatioMinValue, 1,
   (char*)"V.GetDiagonalRatioMinValue() -> float\nC++: double GetDiagonalRatioMinValue()\n\nBy default the arrow is 30% of the diagonal length. DiagonalRatio\ncontrol this ratio in the interval [0-2]\n"},
  {(char*)"GetDiagonalRatioMaxValue", PyvtkImplicitPlaneWidget_GetDiagonalRatioMaxValue, 1,
   (char*)"V.GetDiagonalRatioMaxValue() -> float\nC++: double GetDiagonalRatioMaxValue()\n\nBy default the arrow is 30% of the diagonal length. DiagonalRatio\ncontrol this ratio in the interval [0-2]\n"},
  {(char*)"GetDiagonalRatio", PyvtkImplicitPlaneWidget_GetDiagonalRatio, 1,
   (char*)"V.GetDiagonalRatio() -> float\nC++: double GetDiagonalRatio()\n\nBy default the arrow is 30% of the diagonal length. DiagonalRatio\ncontrol this ratio in the interval [0-2]\n"},
  {(char*)"GetPolyData", PyvtkImplicitPlaneWidget_GetPolyData, 1,
  ...
  {(char*)"GetPolyDataAlgorithm", PyvtkImplicitPlaneWidget_GetPolyDataAlgorithm, 1,
  ...
  {(char*)"GetPlane", PyvtkImplicitPlaneWidget_GetPlane, 1,
  ...
  {(char*)"UpdatePlacement", PyvtkImplicitPlaneWidget_UpdatePlacement, 1,
  ...
  {(char*)"SizeHandles", PyvtkImplicitPlaneWidget_SizeHandles, 1,
   (char*)"V.SizeHandles()\nC++: virtual void SizeHandles()\n\nControl widget appearance\n"},
  {(char*)"GetNormalProperty", PyvtkImplicitPlaneWidget_GetNormalProperty, 1,
   (char*)"V.GetNormalProperty() -> vtkProperty\nC++: vtkProperty *GetNormalProperty()\n\nGet the properties on the normal (line and cone).\n"},
  {(char*)"GetSelectedNormalProperty", PyvtkImplicitPlaneWidget_GetSelectedNormalProperty, 1,
   (char*)"V.GetSelectedNormalProperty() -> vtkProperty\nC++: vtkProperty *GetSelectedNormalProperty()\n\nGet the properties on the normal (line and cone).\n"},
  {(char*)"GetPlaneProperty", PyvtkImplicitPlaneWidget_GetPlaneProperty, 1,
  ...
  {(char*)"GetSelectedPlaneProperty", PyvtkImplicitPlaneWidget_GetSelectedPlaneProperty, 1,
   (char*)"V.GetSelectedPlaneProperty() -> vtkProperty\nC++: vtkProperty *GetSelectedPlaneProperty()\n\nGet the plane properties. The properties of the plane when\nselected and unselected can be manipulated.\n"},
  {(char*)"GetOutlineProperty", PyvtkImplicitPlaneWidget_GetOutlineProperty, 1,
   (char*)"V.GetOutlineProperty() -> vtkProperty\nC++: vtkProperty *GetOutlineProperty()\n\nGet the property of the outline.\n"},
  {(char*)"GetSelectedOutlineProperty", PyvtkImplicitPlaneWidget_GetSelectedOutlineProperty, 1,
   (char*)"V.GetSelectedOutlineProperty() -> vtkProperty\nC++: vtkProperty *GetSelectedOutlineProperty()\n\nGet the property of the outline.\n"},
  {(char*)"GetEdgesProperty", PyvtkImplicitPlaneWidget_GetEdgesProperty, 1,
