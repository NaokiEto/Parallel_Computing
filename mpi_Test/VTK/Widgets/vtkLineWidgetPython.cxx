...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkLineWidget(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkLineWidget(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkLineWidgetNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkLineWidgetNew(const char *); }
#endif
...
PyvtkLineWidget_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetClassName();
      }
...
PyvtkLineWidget_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::IsA(temp0);
      }
...
PyvtkLineWidget_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::NewInstance();
      }
...
PyvtkLineWidget_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkLineWidget::SafeDownCast(temp0);
...
PyvtkLineWidget_GetResolution(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetResolution();
      }
...
PyvtkLineWidget_GetPoint1_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetPoint1();
      }
...
PyvtkLineWidget_GetPoint2_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetPoint2();
      }
...
PyvtkLineWidget_GetAlignMinValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetAlignMinValue();
      }
    else
      {
      tempr = op->vtkLineWidget::GetAlignMinValue();
      }
...
PyvtkLineWidget_GetAlignMaxValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetAlignMaxValue();
      }
    else
      {
      tempr = op->vtkLineWidget::GetAlignMaxValue();
      }
...
PyvtkLineWidget_GetAlign(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetAlign();
      }
...
PyvtkLineWidget_GetClampToBounds(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetClampToBounds();
      }
    else
      {
      tempr = op->vtkLineWidget::GetClampToBounds();
      }
...
PyvtkLineWidget_GetHandleProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetHandleProperty();
      }
...
PyvtkLineWidget_GetSelectedHandleProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetSelectedHandleProperty();
      }
...
PyvtkLineWidget_GetLineProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetLineProperty();
      }
...
PyvtkLineWidget_GetSelectedLineProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLineWidget::GetSelectedLineProperty();
      }
...
static PyMethodDef PyvtkLineWidget_Methods[] = {
  {(char*)"GetClassName", PyvtkLineWidget_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkLineWidget_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkLineWidget_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkLineWidget\nC++: vtkLineWidget *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkLineWidget_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkLineWidget\nC++: vtkLineWidget *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetEnabled", PyvtkLineWidget_SetEnabled, 1,
   (char*)"V.SetEnabled(int)\nC++: virtual void SetEnabled(int)\n\nMethods that satisfy the superclass' API.\n"},
  {(char*)"PlaceWidget", PyvtkLineWidget_PlaceWidget, 1,
  ...
  {(char*)"SetResolution", PyvtkLineWidget_SetResolution, 1,
   (char*)"V.SetResolution(int)\nC++: void SetResolution(int r)\n\nSet/Get the resolution (number of subdivisions) of the line.\n"},
  {(char*)"GetResolution", PyvtkLineWidget_GetResolution, 1,
   (char*)"V.GetResolution() -> int\nC++: int GetResolution()\n\nSet/Get the resolution (number of subdivisions) of the line.\n"},
  {(char*)"SetPoint1", PyvtkLineWidget_SetPoint1, 1,
  ...
  {(char*)"GetAlignMinValue", PyvtkLineWidget_GetAlignMinValue, 1,
   (char*)"V.GetAlignMinValue() -> int\nC++: int GetAlignMinValue()\n\nForce the line widget to be aligned with one of the x-y-z axes.\nRemember that when the state changes, a ModifiedEvent is invoked.\nThis can be used to snap the line to the axes if it is orginally\nnot aligned.\n"},
  {(char*)"GetAlignMaxValue", PyvtkLineWidget_GetAlignMaxValue, 1,
   (char*)"V.GetAlignMaxValue() -> int\nC++: int GetAlignMaxValue()\n\nForce the line widget to be aligned with one of the x-y-z axes.\nRemember that when the state changes, a ModifiedEvent is invoked.\nThis can be used to snap the line to the axes if it is orginally\nnot aligned.\n"},
  {(char*)"GetAlign", PyvtkLineWidget_GetAlign, 1,
   (char*)"V.GetAlign() -> int\nC++: int GetAlign()\n\nForce the line widget to be aligned with one of the x-y-z axes.\nRemember that when the state changes, a ModifiedEvent is invoked.\nThis can be used to snap the line to the axes if it is orginally\nnot aligned.\n"},
  {(char*)"SetAlignToXAxis", PyvtkLineWidget_SetAlignToXAxis, 1,
   (char*)"V.SetAlignToXAxis()\nC++: void SetAlignToXAxis()\n\nForce the line widget to be aligned with one of the x-y-z axes.\nRemember that when the state changes, a ModifiedEvent is invoked.\nThis can be used to snap the line to the axes if it is orginally\nnot aligned.\n"},
  {(char*)"SetAlignToYAxis", PyvtkLineWidget_SetAlignToYAxis, 1,
   (char*)"V.SetAlignToYAxis()\nC++: void SetAlignToYAxis()\n\nForce the line widget to be aligned with one of the x-y-z axes.\nRemember that when the state changes, a ModifiedEvent is invoked.\nThis can be used to snap the line to the axes if it is orginally\nnot aligned.\n"},
  {(char*)"SetAlignToZAxis", PyvtkLineWidget_SetAlignToZAxis, 1,
   (char*)"V.SetAlignToZAxis()\nC++: void SetAlignToZAxis()\n\nForce the line widget to be aligned with one of the x-y-z axes.\nRemember that when the state changes, a ModifiedEvent is invoked.\nThis can be used to snap the line to the axes if it is orginally\nnot aligned.\n"},
  {(char*)"SetAlignToNone", PyvtkLineWidget_SetAlignToNone, 1,
   (char*)"V.SetAlignToNone()\nC++: void SetAlignToNone()\n\nForce the line widget to be aligned with one of the x-y-z axes.\nRemember that when the state changes, a ModifiedEvent is invoked.\nThis can be used to snap the line to the axes if it is orginally\nnot aligned.\n"},
  {(char*)"SetClampToBounds", PyvtkLineWidget_SetClampToBounds, 1,
  ...
  {(char*)"GetClampToBounds", PyvtkLineWidget_GetClampToBounds, 1,
   (char*)"V.GetClampToBounds() -> int\nC++: int GetClampToBounds()\n\nEnable/disable clamping of the point end points to the bounding\nbox of the data. The bounding box is defined from the last\nPlaceWidget() invocation, and includes the effect of the\nPlaceFactor which is used to gram/shrink the bounding box.\n"},
  {(char*)"ClampToBoundsOn", PyvtkLineWidget_ClampToBoundsOn, 1,
   (char*)"V.ClampToBoundsOn()\nC++: void ClampToBoundsOn()\n\nEnable/disable clamping of the point end points to the bounding\nbox of the data. The bounding box is defined from the last\nPlaceWidget() invocation, and includes the effect of the\nPlaceFactor which is used to gram/shrink the bounding box.\n"},
  {(char*)"ClampToBoundsOff", PyvtkLineWidget_ClampToBoundsOff, 1,
   (char*)"V.ClampToBoundsOff()\nC++: void ClampToBoundsOff()\n\nEnable/disable clamping of the point end points to the bounding\nbox of the data. The bounding box is defined from the last\nPlaceWidget() invocation, and includes the effect of the\nPlaceFactor which is used to gram/shrink the bounding box.\n"},
  {(char*)"GetPolyData", PyvtkLineWidget_GetPolyData, 1,
  ...
  {(char*)"GetHandleProperty", PyvtkLineWidget_GetHandleProperty, 1,
   (char*)"V.GetHandleProperty() -> vtkProperty\nC++: vtkProperty *GetHandleProperty()\n\nGet the handle properties (the little balls are the handles). The\nproperties of the handles when selected and normal can be\nmanipulated.\n"},
  {(char*)"GetSelectedHandleProperty", PyvtkLineWidget_GetSelectedHandleProperty, 1,
   (char*)"V.GetSelectedHandleProperty() -> vtkProperty\nC++: vtkProperty *GetSelectedHandleProperty()\n\nGet the handle properties (the little balls are the handles). The\nproperties of the handles when selected and normal can be\nmanipulated.\n"},
  {(char*)"GetLineProperty", PyvtkLineWidget_GetLineProperty, 1,
  ...
  {(char*)"GetSelectedLineProperty", PyvtkLineWidget_GetSelectedLineProperty, 1,
