...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkSeedWidget(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkSeedWidget(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkSeedWidgetNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkSeedWidgetNew(const char *); }
#endif
...
PyvtkSeedWidget_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSeedWidget::GetClassName();
      }
...
PyvtkSeedWidget_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSeedWidget::IsA(temp0);
      }
...
PyvtkSeedWidget_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSeedWidget::NewInstance();
      }
...
PyvtkSeedWidget_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkSeedWidget::SafeDownCast(temp0);
...
PyvtkSeedWidget_GetSeedRepresentation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetSeedRepresentation();
      }
    else
      {
      tempr = op->vtkSeedWidget::GetSeedRepresentation();
      }
...
PyvtkSeedWidget_CreateNewHandle(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->CreateNewHandle();
      }
    else
      {
      tempr = op->vtkSeedWidget::CreateNewHandle();
      }
...
PyvtkSeedWidget_GetSeed(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetSeed(temp0);
      }
    else
      {
      tempr = op->vtkSeedWidget::GetSeed(temp0);
      }
...
static PyMethodDef PyvtkSeedWidget_Methods[] = {
  {(char*)"GetClassName", PyvtkSeedWidget_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\nStandard methods for a VTK class.\n"},
  {(char*)"IsA", PyvtkSeedWidget_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\nStandard methods for a VTK class.\n"},
  {(char*)"NewInstance", PyvtkSeedWidget_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkSeedWidget\nC++: vtkSeedWidget *NewInstance()\n\nStandard methods for a VTK class.\n"},
  {(char*)"SafeDownCast", PyvtkSeedWidget_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkSeedWidget\nC++: vtkSeedWidget *SafeDownCast(vtkObject* o)\n\nStandard methods for a VTK class.\n"},
  {(char*)"SetEnabled", PyvtkSeedWidget_SetEnabled, 1,
  ...
  {(char*)"SetCurrentRenderer", PyvtkSeedWidget_SetCurrentRenderer, 1,
  ...
  {(char*)"SetInteractor", PyvtkSeedWidget_SetInteractor, 1,
  ...
  {(char*)"SetRepresentation", PyvtkSeedWidget_SetRepresentation, 1,
  ...
  {(char*)"GetSeedRepresentation", PyvtkSeedWidget_GetSeedRepresentation, 1,
  ...
  {(char*)"CreateDefaultRepresentation", PyvtkSeedWidget_CreateDefaultRepresentation, 1,
   (char*)"V.CreateDefaultRepresentation()\nC++: void CreateDefaultRepresentation()\n\nCreate the default widget representation if one is not set.\n"},
  {(char*)"SetProcessEvents", PyvtkSeedWidget_SetProcessEvents, 1,
   (char*)"V.SetProcessEvents(int)\nC++: virtual void SetProcessEvents(int)\n\nMethods to change the whether the widget responds to interaction.\nOverridden to pass the state to component widgets.\n"},
  {(char*)"CompleteInteraction", PyvtkSeedWidget_CompleteInteraction, 1,
  ...
  {(char*)"RestartInteraction", PyvtkSeedWidget_RestartInteraction, 1,
  ...
  {(char*)"CreateNewHandle", PyvtkSeedWidget_CreateNewHandle, 1,
  ...
  {(char*)"DeleteSeed", PyvtkSeedWidget_DeleteSeed, 1,
   (char*)"V.DeleteSeed(int)\nC++: void DeleteSeed(int n)\n\nDelete the nth seed.\n"},
  {(char*)"GetSeed", PyvtkSeedWidget_GetSeed, 1,
