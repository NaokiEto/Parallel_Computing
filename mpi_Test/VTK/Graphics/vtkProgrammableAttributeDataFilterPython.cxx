...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkProgrammableAttributeDataFilter(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkProgrammableAttributeDataFilter(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkProgrammableAttributeDataFilterNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkProgrammableAttributeDataFilterNew(const char *); }
#endif
...
PyvtkProgrammableAttributeDataFilter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkProgrammableAttributeDataFilter::GetClassName();
      }
...
PyvtkProgrammableAttributeDataFilter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkProgrammableAttributeDataFilter::IsA(temp0);
      }
...
PyvtkProgrammableAttributeDataFilter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkProgrammableAttributeDataFilter *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkProgrammableAttributeDataFilter::NewInstance();
      }
...
PyvtkProgrammableAttributeDataFilter_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkProgrammableAttributeDataFilter::SafeDownCast(temp0);
...
PyvtkProgrammableAttributeDataFilter_GetInputList(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkProgrammableAttributeDataFilter::GetInputList();
      }
...
static PyMethodDef PyvtkProgrammableAttributeDataFilter_Methods[] = {
  {(char*)"GetClassName", PyvtkProgrammableAttributeDataFilter_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkProgrammableAttributeDataFilter_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkProgrammableAttributeDataFilter_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkProgrammableAttributeDataFilter\nC++: vtkProgrammableAttributeDataFilter *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkProgrammableAttributeDataFilter_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkProgrammableAttributeDataFilter\nC++: vtkProgrammableAttributeDataFilter *SafeDownCast(\n    vtkObject* o)\n\n"},
  {(char*)"AddInput", PyvtkProgrammableAttributeDataFilter_AddInput, 1,
   (char*)"V.AddInput(vtkDataSet)\nC++: void AddInput(vtkDataSet *in)\n\nAdd a dataset to the list of data to process.\n"},
  {(char*)"RemoveInput", PyvtkProgrammableAttributeDataFilter_RemoveInput, 1,
   (char*)"V.RemoveInput(vtkDataSet)\nC++: void RemoveInput(vtkDataSet *in)\n\nRemove a dataset from the list of data to process.\n"},
  {(char*)"GetInputList", PyvtkProgrammableAttributeDataFilter_GetInputList, 1,
   (char*)"V.GetInputList() -> vtkDataSetCollection\nC++: vtkDataSetCollection *GetInputList()\n\nReturn the list of inputs.\n"},
  {(char*)"SetExecuteMethod", PyvtkProgrammableAttributeDataFilter_SetExecuteMethod, 1,
