...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkOBBTree(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkOBBTree(PyObject *, const char *); }
#endif
...
#ifndef DECLARED_PyvtkOBBNode_Type
extern PyTypeObject PyvtkOBBNode_Type;
#define DECLARED_PyvtkOBBNode_Type
#endif
...
static PyMethodDef PyvtkOBBNode_NewMethod = \
{ (char*)"vtkOBBNode", PyvtkOBBNode_vtkOBBNode, 1,
  (char*)"" };
...
PyvtkOBBNode_New(PyTypeObject *, PyObject *args, PyObject *kwds)
{
  ...
  return PyvtkOBBNode_vtkOBBNode(NULL, args);
}
#endif
...
static long PyvtkOBBNode_Hash(PyObject *self)
{
...
PyTypeObject PyvtkOBBNode_Type = {
  PyObject_HEAD_INIT(&PyType_Type)
  0,
  (char*)"vtkOBBNode", // tp_name
  ...
  0, // tp_iter
  0, // tp_iternext
  PyvtkOBBNode_Methods, // tp_methods
  0, // tp_members
  0, // tp_getset
  0, // tp_base
  0, // tp_dict
...
static void *PyvtkOBBNode_CCopy(const void *obj)
{
  if (obj)
    {
    return new vtkOBBNode(*static_cast<const vtkOBBNode*>(obj));
    }
  return 0;
}

static PyObject *PyvtkOBBNode_TypeNew(const char *)
{
  return PyVTKSpecialType_New(
    &PyvtkOBBNode_Type,
    PyvtkOBBNode_Methods,
    PyvtkOBBNode_vtkOBBNode_Methods,
    &PyvtkOBBNode_NewMethod,
    PyvtkOBBNode_Doc(), &PyvtkOBBNode_CCopy);
}

const char **PyvtkOBBNode_Doc()
{
...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkOBBTreeNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkOBBTreeNew(const char *); }
#endif
...
PyvtkOBBTree_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::GetClassName();
      }
...
PyvtkOBBTree_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::NewInstance();
      }
...
PyvtkOBBTree_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkOBBTree::SafeDownCast(temp0);
...
PyvtkOBBTree_IntersectWithLine_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6);
      }
...
PyvtkOBBTree_IntersectWithLine_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(8) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7);
      }
...
PyvtkOBBTree_IntersectWithLine_s3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::IntersectWithLine(temp0, temp1, temp2, temp3);
      }
...
PyvtkOBBTree_IntersectWithLine_s4(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(9) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8);
      }
...
PyvtkOBBTree_FindClosestPointWithinRadius_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(6) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::FindClosestPointWithinRadius(temp0, temp1, temp2, temp3, temp4, temp5);
      }
...
PyvtkOBBTree_FindClosestPointWithinRadius_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::FindClosestPointWithinRadius(temp0, temp1, temp2, temp3, temp4, temp5, temp6);
      }
...
PyvtkOBBTree_FindClosestPointWithinRadius_s3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(8) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkOBBTree::FindClosestPointWithinRadius(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7);
      }
...
static PyMethodDef PyvtkOBBTree_ComputeOBB_Methods[] = {
  {NULL, PyvtkOBBTree_ComputeOBB_s1, 1,
   (char*)"OOOOOO *vtkPoints *d *d *d *d *d"},
  {NULL, PyvtkOBBTree_ComputeOBB_s2, 1,
...
PyvtkOBBTree_InsideOrOutside(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->InsideOrOutside(temp0);
      }
    else
      {
      tempr = op->vtkOBBTree::InsideOrOutside(temp0);
      }
...
static PyMethodDef PyvtkOBBTree_Methods[] = {
  {(char*)"GetClassName", PyvtkOBBTree_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkOBBTree_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkOBBTree_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkOBBTree\nC++: vtkOBBTree *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkOBBTree_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkOBBTree\nC++: vtkOBBTree *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"IntersectWithLine", PyvtkOBBTree_IntersectWithLine, 1,
  ...
  {(char*)"FindClosestPoint", PyvtkOBBTree_FindClosestPoint, 1,
  ...
  {(char*)"FindClosestPointWithinRadius", PyvtkOBBTree_FindClosestPointWithinRadius, 1,
  ...
  {(char*)"ComputeOBB", PyvtkOBBTree_ComputeOBB, 1,
  ...
  {(char*)"InsideOrOutside", PyvtkOBBTree_InsideOrOutside, 1,
  ...
  {(char*)"FreeSearchStructure", PyvtkOBBTree_FreeSearchStructure, 1,
   (char*)"V.FreeSearchStructure()\nC++: void FreeSearchStructure()\n\nSatisfy locator's abstract interface, see vtkLocator.\n"},
  {(char*)"BuildLocator", PyvtkOBBTree_BuildLocator, 1,
   (char*)"V.BuildLocator()\nC++: void BuildLocator()\n\nSatisfy locator's abstract interface, see vtkLocator.\n"},
  {(char*)"GenerateRepresentation", PyvtkOBBTree_GenerateRepresentation, 1,
...
{
  PyObject *o;
  o = PyvtkOBBNode_TypeNew(modulename);

  if (o && PyDict_SetItemString(dict, (char *)"vtkOBBNode", o) != 0)
    {
    Py_DECREF(o);
    }
