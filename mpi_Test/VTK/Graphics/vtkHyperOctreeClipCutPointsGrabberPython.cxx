...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkHyperOctreeClipCutPointsGrabber(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkHyperOctreeClipCutPointsGrabber(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkHyperOctreeClipCutPointsGrabberNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkHyperOctreeClipCutPointsGrabberNew(const char *); }
#endif
...
PyvtkHyperOctreeClipCutPointsGrabber_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkHyperOctreeClipCutPointsGrabber::GetClassName();
      }
...
PyvtkHyperOctreeClipCutPointsGrabber_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkHyperOctreeClipCutPointsGrabber::IsA(temp0);
      }
...
PyvtkHyperOctreeClipCutPointsGrabber_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkHyperOctreeClipCutPointsGrabber *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkHyperOctreeClipCutPointsGrabber::NewInstance();
      }
...
PyvtkHyperOctreeClipCutPointsGrabber_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkHyperOctreeClipCutPointsGrabber::SafeDownCast(temp0);
...
PyvtkHyperOctreeClipCutPointsGrabber_GetTriangulator(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetTriangulator();
      }
    else
      {
      tempr = op->vtkHyperOctreeClipCutPointsGrabber::GetTriangulator();
      }
...
PyvtkHyperOctreeClipCutPointsGrabber_GetPolygon(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkHyperOctreeClipCutPointsGrabber::GetPolygon();
      }
...
static PyMethodDef PyvtkHyperOctreeClipCutPointsGrabber_Methods[] = {
  {(char*)"GetClassName", PyvtkHyperOctreeClipCutPointsGrabber_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkHyperOctreeClipCutPointsGrabber_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkHyperOctreeClipCutPointsGrabber_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkHyperOctreeClipCutPointsGrabber\nC++: vtkHyperOctreeClipCutPointsGrabber *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkHyperOctreeClipCutPointsGrabber_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkHyperOctreeClipCutPointsGrabber\nC++: vtkHyperOctreeClipCutPointsGrabber *SafeDownCast(\n    vtkObject* o)\n\n"},
  {(char*)"SetDimension", PyvtkHyperOctreeClipCutPointsGrabber_SetDimension, 1,
  ...
  {(char*)"InitPointInsertion", PyvtkHyperOctreeClipCutPointsGrabber_InitPointInsertion, 1,
  ...
  {(char*)"InsertPoint", PyvtkHyperOctreeClipCutPointsGrabber_InsertPoint, 1,
  ...
  {(char*)"InsertPointWithMerge", PyvtkHyperOctreeClipCutPointsGrabber_InsertPointWithMerge, 1,
  ...
  {(char*)"InsertPoint2D", PyvtkHyperOctreeClipCutPointsGrabber_InsertPoint2D, 1,
  ...
  {(char*)"GetTriangulator", PyvtkHyperOctreeClipCutPointsGrabber_GetTriangulator, 1,
   (char*)"V.GetTriangulator() -> vtkOrderedTriangulator\nC++: vtkOrderedTriangulator *GetTriangulator()\n\nReturn the ordered triangulator.\n"},
  {(char*)"GetPolygon", PyvtkHyperOctreeClipCutPointsGrabber_GetPolygon, 1,
