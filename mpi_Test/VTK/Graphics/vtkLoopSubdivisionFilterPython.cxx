...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkLoopSubdivisionFilter(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkLoopSubdivisionFilter(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkLoopSubdivisionFilterNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkLoopSubdivisionFilterNew(const char *); }
#endif
...
PyvtkLoopSubdivisionFilter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLoopSubdivisionFilter::GetClassName();
      }
...
PyvtkLoopSubdivisionFilter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLoopSubdivisionFilter::IsA(temp0);
      }
...
PyvtkLoopSubdivisionFilter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkLoopSubdivisionFilter *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLoopSubdivisionFilter::NewInstance();
      }
...
PyvtkLoopSubdivisionFilter_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkLoopSubdivisionFilter::SafeDownCast(temp0);
...
static PyMethodDef PyvtkLoopSubdivisionFilter_Methods[] = {
  {(char*)"GetClassName", PyvtkLoopSubdivisionFilter_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\nConstruct object with NumberOfSubdivisions set to 1.\n"},
  {(char*)"IsA", PyvtkLoopSubdivisionFilter_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\nConstruct object with NumberOfSubdivisions set to 1.\n"},
  {(char*)"NewInstance", PyvtkLoopSubdivisionFilter_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkLoopSubdivisionFilter\nC++: vtkLoopSubdivisionFilter *NewInstance()\n\nConstruct object with NumberOfSubdivisions set to 1.\n"},
  {(char*)"SafeDownCast", PyvtkLoopSubdivisionFilter_SafeDownCast, 1,
