...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkStructuredGridGeometryFilter(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkStructuredGridGeometryFilter(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkStructuredGridGeometryFilterNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkStructuredGridGeometryFilterNew(const char *); }
#endif
...
PyvtkStructuredGridGeometryFilter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridGeometryFilter::GetClassName();
      }
...
PyvtkStructuredGridGeometryFilter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridGeometryFilter::IsA(temp0);
      }
...
PyvtkStructuredGridGeometryFilter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkStructuredGridGeometryFilter *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridGeometryFilter::NewInstance();
      }
...
PyvtkStructuredGridGeometryFilter_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkStructuredGridGeometryFilter::SafeDownCast(temp0);
...
PyvtkStructuredGridGeometryFilter_GetExtent(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkStructuredGridGeometryFilter::GetExtent();
      }
...
static PyMethodDef PyvtkStructuredGridGeometryFilter_Methods[] = {
  {(char*)"GetClassName", PyvtkStructuredGridGeometryFilter_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkStructuredGridGeometryFilter_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkStructuredGridGeometryFilter_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkStructuredGridGeometryFilter\nC++: vtkStructuredGridGeometryFilter *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkStructuredGridGeometryFilter_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkStructuredGridGeometryFilter\nC++: vtkStructuredGridGeometryFilter *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetExtent", PyvtkStructuredGridGeometryFilter_GetExtent, 1,
   (char*)"V.GetExtent() -> (int, int, int, int, int, int)\nC++: int *GetExtent()\n\nGet the extent in topological coordinate range (imin,imax,\njmin,jmax, kmin,kmax).\n"},
  {(char*)"SetExtent", PyvtkStructuredGridGeometryFilter_SetExtent, 1,
