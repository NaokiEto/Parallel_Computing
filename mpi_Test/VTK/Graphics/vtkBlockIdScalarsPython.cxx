...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkBlockIdScalars(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkBlockIdScalars(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkBlockIdScalarsNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkBlockIdScalarsNew(const char *); }
#endif
...
PyvtkBlockIdScalars_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBlockIdScalars::GetClassName();
      }
...
PyvtkBlockIdScalars_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBlockIdScalars::IsA(temp0);
      }
...
PyvtkBlockIdScalars_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBlockIdScalars::NewInstance();
      }
...
PyvtkBlockIdScalars_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkBlockIdScalars::SafeDownCast(temp0);
...
static PyMethodDef PyvtkBlockIdScalars_Methods[] = {
  {(char*)"GetClassName", PyvtkBlockIdScalars_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkBlockIdScalars_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkBlockIdScalars_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkBlockIdScalars\nC++: vtkBlockIdScalars *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkBlockIdScalars_SafeDownCast, 1,
