...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkDensifyPolyData(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkDensifyPolyData(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkDensifyPolyDataNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkDensifyPolyDataNew(const char *); }
#endif
...
PyvtkDensifyPolyData_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDensifyPolyData::GetClassName();
      }
...
PyvtkDensifyPolyData_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDensifyPolyData::IsA(temp0);
      }
...
PyvtkDensifyPolyData_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDensifyPolyData::NewInstance();
      }
...
PyvtkDensifyPolyData_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkDensifyPolyData::SafeDownCast(temp0);
...
PyvtkDensifyPolyData_GetNumberOfSubdivisions(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDensifyPolyData::GetNumberOfSubdivisions();
      }
...
static PyMethodDef PyvtkDensifyPolyData_Methods[] = {
  {(char*)"GetClassName", PyvtkDensifyPolyData_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkDensifyPolyData_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkDensifyPolyData_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkDensifyPolyData\nC++: vtkDensifyPolyData *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkDensifyPolyData_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkDensifyPolyData\nC++: vtkDensifyPolyData *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetNumberOfSubdivisions", PyvtkDensifyPolyData_SetNumberOfSubdivisions, 1,
  ...
  {(char*)"GetNumberOfSubdivisions", PyvtkDensifyPolyData_GetNumberOfSubdivisions, 1,
