...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkSpherePuzzle(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkSpherePuzzle(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkSpherePuzzleNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkSpherePuzzleNew(const char *); }
#endif
...
PyvtkSpherePuzzle_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSpherePuzzle::GetClassName();
      }
...
PyvtkSpherePuzzle_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSpherePuzzle::IsA(temp0);
      }
...
PyvtkSpherePuzzle_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkSpherePuzzle::NewInstance();
      }
...
PyvtkSpherePuzzle_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkSpherePuzzle::SafeDownCast(temp0);
...
PyvtkSpherePuzzle_SetPoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->SetPoint(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkSpherePuzzle::SetPoint(temp0, temp1, temp2);
      }
...
static PyMethodDef PyvtkSpherePuzzle_Methods[] = {
  {(char*)"GetClassName", PyvtkSpherePuzzle_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkSpherePuzzle_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkSpherePuzzle_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkSpherePuzzle\nC++: vtkSpherePuzzle *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkSpherePuzzle_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkSpherePuzzle\nC++: vtkSpherePuzzle *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Reset", PyvtkSpherePuzzle_Reset, 1,
   (char*)"V.Reset()\nC++: void Reset()\n\nReset the state of this puzzle back to its original state.\n"},
  {(char*)"MoveHorizontal", PyvtkSpherePuzzle_MoveHorizontal, 1,
  ...
  {(char*)"MoveVertical", PyvtkSpherePuzzle_MoveVertical, 1,
  ...
  {(char*)"SetPoint", PyvtkSpherePuzzle_SetPoint, 1,
  ...
  {(char*)"MovePoint", PyvtkSpherePuzzle_MovePoint, 1,
