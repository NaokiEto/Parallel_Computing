...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkQuadraturePointsGenerator(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkQuadraturePointsGenerator(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkQuadraturePointsGeneratorNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkQuadraturePointsGeneratorNew(const char *); }
#endif
...
PyvtkQuadraturePointsGenerator_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraturePointsGenerator::GetClassName();
      }
...
PyvtkQuadraturePointsGenerator_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraturePointsGenerator::IsA(temp0);
      }
...
PyvtkQuadraturePointsGenerator_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkQuadraturePointsGenerator *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkQuadraturePointsGenerator::NewInstance();
      }
...
PyvtkQuadraturePointsGenerator_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkQuadraturePointsGenerator::SafeDownCast(temp0);
...
static PyMethodDef PyvtkQuadraturePointsGenerator_Methods[] = {
  {(char*)"GetClassName", PyvtkQuadraturePointsGenerator_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkQuadraturePointsGenerator_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkQuadraturePointsGenerator_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkQuadraturePointsGenerator\nC++: vtkQuadraturePointsGenerator *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkQuadraturePointsGenerator_SafeDownCast, 1,
