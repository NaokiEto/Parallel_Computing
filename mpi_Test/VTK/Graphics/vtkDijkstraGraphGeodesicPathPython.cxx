...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkDijkstraGraphGeodesicPath(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkDijkstraGraphGeodesicPath(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkDijkstraGraphGeodesicPathNew(const char *); }
#else
...
PyvtkDijkstraGraphGeodesicPath_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::GetClassName();
      }
...
PyvtkDijkstraGraphGeodesicPath_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::IsA(temp0);
      }
...
PyvtkDijkstraGraphGeodesicPath_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkDijkstraGraphGeodesicPath *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::NewInstance();
      }
...
PyvtkDijkstraGraphGeodesicPath_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkDijkstraGraphGeodesicPath::SafeDownCast(temp0);
...
PyvtkDijkstraGraphGeodesicPath_GetIdList(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::GetIdList();
      }
...
PyvtkDijkstraGraphGeodesicPath_GetStopWhenEndReached(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetStopWhenEndReached();
      }
    else
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::GetStopWhenEndReached();
      }
...
PyvtkDijkstraGraphGeodesicPath_GetUseScalarWeights(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetUseScalarWeights();
      }
    else
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::GetUseScalarWeights();
      }
...
PyvtkDijkstraGraphGeodesicPath_GetRepelPathFromVertices(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetRepelPathFromVertices();
      }
    else
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::GetRepelPathFromVertices();
      }
...
PyvtkDijkstraGraphGeodesicPath_GetRepelVertices(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetRepelVertices();
      }
    else
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::GetRepelVertices();
      }
...
static PyObject *
PyvtkDijkstraGraphGeodesicPath_GetGeodesicLength(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDijkstraGraphGeodesicPath::GetGeodesicLength();
      }
...
static PyMethodDef PyvtkDijkstraGraphGeodesicPath_Methods[] = {
  {(char*)"GetClassName", PyvtkDijkstraGraphGeodesicPath_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\nStandard methids for printing and determining type information.\n"},
  {(char*)"IsA", PyvtkDijkstraGraphGeodesicPath_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\nStandard methids for printing and determining type information.\n"},
  {(char*)"NewInstance", PyvtkDijkstraGraphGeodesicPath_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkDijkstraGraphGeodesicPath\nC++: vtkDijkstraGraphGeodesicPath *NewInstance()\n\nStandard methids for printing and determining type information.\n"},
  {(char*)"SafeDownCast", PyvtkDijkstraGraphGeodesicPath_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkDijkstraGraphGeodesicPath\nC++: vtkDijkstraGraphGeodesicPath *SafeDownCast(vtkObject* o)\n\nStandard methids for printing and determining type information.\n"},
  {(char*)"GetIdList", PyvtkDijkstraGraphGeodesicPath_GetIdList, 1,
   (char*)"V.GetIdList() -> vtkIdList\nC++: vtkIdList *GetIdList()\n\nThe vertex ids (of the input polydata) on the shortest path\n"},
  {(char*)"SetStopWhenEndReached", PyvtkDijkstraGraphGeodesicPath_SetStopWhenEndReached, 1,
  ...
  {(char*)"GetStopWhenEndReached", PyvtkDijkstraGraphGeodesicPath_GetStopWhenEndReached, 1,
   (char*)"V.GetStopWhenEndReached() -> int\nC++: int GetStopWhenEndReached()\n\nStop when the end vertex is reached or calculate shortest path to\nall vertices\n"},
  {(char*)"StopWhenEndReachedOn", PyvtkDijkstraGraphGeodesicPath_StopWhenEndReachedOn, 1,
   (char*)"V.StopWhenEndReachedOn()\nC++: void StopWhenEndReachedOn()\n\nStop when the end vertex is reached or calculate shortest path to\nall vertices\n"},
  {(char*)"StopWhenEndReachedOff", PyvtkDijkstraGraphGeodesicPath_StopWhenEndReachedOff, 1,
   (char*)"V.StopWhenEndReachedOff()\nC++: void StopWhenEndReachedOff()\n\nStop when the end vertex is reached or calculate shortest path to\nall vertices\n"},
  {(char*)"SetUseScalarWeights", PyvtkDijkstraGraphGeodesicPath_SetUseScalarWeights, 1,
   (char*)"V.SetUseScalarWeights(int)\nC++: void SetUseScalarWeights(int a)\n\nUse scalar values in the edge weight (experimental)\n"},
  {(char*)"GetUseScalarWeights", PyvtkDijkstraGraphGeodesicPath_GetUseScalarWeights, 1,
   (char*)"V.GetUseScalarWeights() -> int\nC++: int GetUseScalarWeights()\n\nUse scalar values in the edge weight (experimental)\n"},
  {(char*)"UseScalarWeightsOn", PyvtkDijkstraGraphGeodesicPath_UseScalarWeightsOn, 1,
   (char*)"V.UseScalarWeightsOn()\nC++: void UseScalarWeightsOn()\n\nUse scalar values in the edge weight (experimental)\n"},
  {(char*)"UseScalarWeightsOff", PyvtkDijkstraGraphGeodesicPath_UseScalarWeightsOff, 1,
   (char*)"V.UseScalarWeightsOff()\nC++: void UseScalarWeightsOff()\n\nUse scalar values in the edge weight (experimental)\n"},
  {(char*)"SetRepelPathFromVertices", PyvtkDijkstraGraphGeodesicPath_SetRepelPathFromVertices, 1,
  ...
  {(char*)"GetRepelPathFromVertices", PyvtkDijkstraGraphGeodesicPath_GetRepelPathFromVertices, 1,
   (char*)"V.GetRepelPathFromVertices() -> int\nC++: int GetRepelPathFromVertices()\n\nUse the input point to repel the path by assigning high costs.\n"},
  {(char*)"RepelPathFromVerticesOn", PyvtkDijkstraGraphGeodesicPath_RepelPathFromVerticesOn, 1,
   (char*)"V.RepelPathFromVerticesOn()\nC++: void RepelPathFromVerticesOn()\n\nUse the input point to repel the path by assigning high costs.\n"},
  {(char*)"RepelPathFromVerticesOff", PyvtkDijkstraGraphGeodesicPath_RepelPathFromVerticesOff, 1,
   (char*)"V.RepelPathFromVerticesOff()\nC++: void RepelPathFromVerticesOff()\n\nUse the input point to repel the path by assigning high costs.\n"},
  {(char*)"SetRepelVertices", PyvtkDijkstraGraphGeodesicPath_SetRepelVertices, 1,
  ...
  {(char*)"GetRepelVertices", PyvtkDijkstraGraphGeodesicPath_GetRepelVertices, 1,
   (char*)"V.GetRepelVertices() -> vtkPoints\nC++: vtkPoints *GetRepelVertices()\n\nSpecify vtkPoints to use to repel the path from.\n"},
  {(char*)"GetGeodesicLength", PyvtkDijkstraGraphGeodesicPath_GetGeodesicLength, 1,
   (char*)"V.GetGeodesicLength() -> float\nC++: virtual double GetGeodesicLength()\n\nTODO: Get the total geodesic length.\n"},
  {(char*)"GetCumulativeWeights", PyvtkDijkstraGraphGeodesicPath_GetCumulativeWeights, 1,
