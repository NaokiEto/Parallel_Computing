...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkAxes(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkAxes(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkAxesNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkAxesNew(const char *); }
#endif
...
PyvtkAxes_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkAxes::SafeDownCast(temp0);
...
PyvtkAxes_GetScaleFactor(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkAxes::GetScaleFactor();
      }
...
PyvtkAxes_GetComputeNormals(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkAxes::GetComputeNormals();
      }
