...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkDashedStreamLine(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkDashedStreamLine(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkDashedStreamLineNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkDashedStreamLineNew(const char *); }
#endif
...
PyvtkDashedStreamLine_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDashedStreamLine::GetClassName();
      }
...
PyvtkDashedStreamLine_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDashedStreamLine::IsA(temp0);
      }
...
PyvtkDashedStreamLine_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDashedStreamLine::NewInstance();
      }
...
PyvtkDashedStreamLine_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkDashedStreamLine::SafeDownCast(temp0);
...
PyvtkDashedStreamLine_GetDashFactorMinValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDashFactorMinValue();
      }
    else
      {
      tempr = op->vtkDashedStreamLine::GetDashFactorMinValue();
      }
...
PyvtkDashedStreamLine_GetDashFactorMaxValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDashFactorMaxValue();
      }
    else
      {
      tempr = op->vtkDashedStreamLine::GetDashFactorMaxValue();
      }
...
PyvtkDashedStreamLine_GetDashFactor(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDashFactor();
      }
    else
      {
      tempr = op->vtkDashedStreamLine::GetDashFactor();
      }
...
static PyMethodDef PyvtkDashedStreamLine_Methods[] = {
  {(char*)"GetClassName", PyvtkDashedStreamLine_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkDashedStreamLine_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkDashedStreamLine_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkDashedStreamLine\nC++: vtkDashedStreamLine *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkDashedStreamLine_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkDashedStreamLine\nC++: vtkDashedStreamLine *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetDashFactor", PyvtkDashedStreamLine_SetDashFactor, 1,
  ...
  {(char*)"GetDashFactorMinValue", PyvtkDashedStreamLine_GetDashFactorMinValue, 1,
   (char*)"V.GetDashFactorMinValue() -> float\nC++: double GetDashFactorMinValue()\n\nFor each dash, specify the fraction of the dash that is \"on\". A\nfactor of 1.0 will result in a continuous line, a factor of 0.5\nwill result in dashed that are half on and half off.\n"},
  {(char*)"GetDashFactorMaxValue", PyvtkDashedStreamLine_GetDashFactorMaxValue, 1,
   (char*)"V.GetDashFactorMaxValue() -> float\nC++: double GetDashFactorMaxValue()\n\nFor each dash, specify the fraction of the dash that is \"on\". A\nfactor of 1.0 will result in a continuous line, a factor of 0.5\nwill result in dashed that are half on and half off.\n"},
  {(char*)"GetDashFactor", PyvtkDashedStreamLine_GetDashFactor, 1,
