...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkArrayWeights(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkArrayWeights(PyObject *, const char *); }
#endif
...
static PyMethodDef PyvtkArrayWeights_Methods[] = {
  {(char*)"GetCount", PyvtkArrayWeights_GetCount, 1,
   (char*)"V.GetCount() -> int\nC++: vtkIdType GetCount()\n\nReturns the number of weights stored in this container.\n"},
  {(char*)"SetCount", PyvtkArrayWeights_SetCount, 1,
...
extern PyTypeObject PyvtkArrayWeights_Type;
...
static PyMethodDef PyvtkArrayWeights_vtkArrayWeights_Methods[] = {
  {NULL, PyvtkArrayWeights_vtkArrayWeights_s2, 1,
   (char*)"d"},
  {NULL, PyvtkArrayWeights_vtkArrayWeights_s6, 1,
...
PyvtkArrayWeights_vtkArrayWeights(PyObject *self, PyObject *args)
{
  ...
  switch(nargs)
    ...
    case 2:
      return PyvtkArrayWeights_vtkArrayWeights_s3(self, args);
    case 3:
