...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkParametricEnneper(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkParametricEnneper(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkParametricEnneperNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkParametricEnneperNew(const char *); }
#endif
...
PyvtkParametricEnneper_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricEnneper::GetClassName();
      }
...
PyvtkParametricEnneper_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricEnneper::IsA(temp0);
      }
...
PyvtkParametricEnneper_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricEnneper::NewInstance();
      }
...
PyvtkParametricEnneper_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkParametricEnneper::SafeDownCast(temp0);
...
PyvtkParametricEnneper_GetDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricEnneper::GetDimension();
      }
...
PyvtkParametricEnneper_EvaluateScalar(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricEnneper::EvaluateScalar(temp0, temp1, temp2);
      }
...
static PyMethodDef PyvtkParametricEnneper_Methods[] = {
  {(char*)"GetClassName", PyvtkParametricEnneper_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkParametricEnneper_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkParametricEnneper_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkParametricEnneper\nC++: vtkParametricEnneper *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkParametricEnneper_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkParametricEnneper\nC++: vtkParametricEnneper *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetDimension", PyvtkParametricEnneper_GetDimension, 1,
   (char*)"V.GetDimension() -> int\nC++: virtual int GetDimension()\n\n"},
  {(char*)"Evaluate", PyvtkParametricEnneper_Evaluate, 1,
  ...
  {(char*)"EvaluateScalar", PyvtkParametricEnneper_EvaluateScalar, 1,
