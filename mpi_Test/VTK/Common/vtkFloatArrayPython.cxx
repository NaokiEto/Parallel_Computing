...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkFloatArray(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkFloatArray(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkFloatArrayNew(const char *); }
#else
...
PyvtkFloatArray_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::GetClassName();
      }
...
PyvtkFloatArray_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::IsA(temp0);
      }
...
PyvtkFloatArray_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::NewInstance();
      }
...
PyvtkFloatArray_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkFloatArray::SafeDownCast(temp0);
...
PyvtkFloatArray_GetDataType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::GetDataType();
      }
...
PyvtkFloatArray_InsertNextTupleValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::InsertNextTupleValue(temp0);
      }
...
PyvtkFloatArray_GetValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::GetValue(temp0);
      }
...
PyvtkFloatArray_InsertNextValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::InsertNextValue(temp0);
      }
...
PyvtkFloatArray_GetValueRange_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::GetValueRange(temp0);
      }
...
PyvtkFloatArray_GetValueRange_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkFloatArray::GetValueRange(temp0, temp1);
      }
...
static PyObject *
PyvtkFloatArray_GetValueRange_s3(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetValueRange");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkFloatArray *op = static_cast<vtkFloatArray *>(vp);
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFloatArray::GetValueRange();
      }
...
static PyObject *
PyvtkFloatArray_GetValueRange_s4(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetValueRange");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkFloatArray *op = static_cast<vtkFloatArray *>(vp);
...
static PyMethodDef PyvtkFloatArray_GetValueRange_Methods[] = {
  {NULL, PyvtkFloatArray_GetValueRange_s1, 1,
   (char*)"@i"},
  {NULL, PyvtkFloatArray_GetValueRange_s4, 1,
   (char*)"@O *f"},
  {NULL, NULL, 0, NULL}
};
...
{
  PyMethodDef *methods = PyvtkFloatArray_GetValueRange_Methods;
  ...
  switch(nargs)
    ...
    case 0:
      return PyvtkFloatArray_GetValueRange_s3(self, args);
    case 1:
...
PyvtkFloatArray_GetDataTypeValueMin(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(0))
    {
    tempr = vtkFloatArray::GetDataTypeValueMin();
...
PyvtkFloatArray_GetDataTypeValueMax(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(0))
    {
    tempr = vtkFloatArray::GetDataTypeValueMax();
...
static PyMethodDef PyvtkFloatArray_Methods[] = {
  {(char*)"GetClassName", PyvtkFloatArray_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkFloatArray_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkFloatArray_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkFloatArray\nC++: vtkFloatArray *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkFloatArray_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkFloatArray\nC++: vtkFloatArray *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetDataType", PyvtkFloatArray_GetDataType, 1,
   (char*)"V.GetDataType() -> int\nC++: int GetDataType()\n\nGet the data type.\n"},
  {(char*)"GetTupleValue", PyvtkFloatArray_GetTupleValue, 1,
   (char*)"V.GetTupleValue(int, [float, ...])\nC++: void GetTupleValue(vtkIdType i, float *tuple)\n\nCopy the tuple value into a user-provided array.\n"},
  {(char*)"SetTupleValue", PyvtkFloatArray_SetTupleValue, 1,
   (char*)"V.SetTupleValue(int, (float, ...))\nC++: void SetTupleValue(vtkIdType i, const float *tuple)\n\nSet the tuple value at the ith location in the array.\n"},
  {(char*)"InsertTupleValue", PyvtkFloatArray_InsertTupleValue, 1,
  ...
  {(char*)"InsertNextTupleValue", PyvtkFloatArray_InsertNextTupleValue, 1,
  ...
  {(char*)"GetValue", PyvtkFloatArray_GetValue, 1,
   (char*)"V.GetValue(int) -> float\nC++: float GetValue(vtkIdType id)\n\nGet the data at a particular index.\n"},
  {(char*)"SetValue", PyvtkFloatArray_SetValue, 1,
  ...
  {(char*)"SetNumberOfValues", PyvtkFloatArray_SetNumberOfValues, 1,
  ...
  {(char*)"InsertValue", PyvtkFloatArray_InsertValue, 1,
   (char*)"V.InsertValue(int, float)\nC++: void InsertValue(vtkIdType id, float f)\n\nInsert data at a specified position in the array.\n"},
  {(char*)"InsertNextValue", PyvtkFloatArray_InsertNextValue, 1,
