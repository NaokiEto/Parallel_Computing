...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkParametricTorus(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkParametricTorus(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkParametricTorusNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkParametricTorusNew(const char *); }
#endif
...
PyvtkParametricTorus_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricTorus::GetClassName();
      }
...
PyvtkParametricTorus_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricTorus::IsA(temp0);
      }
...
PyvtkParametricTorus_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricTorus::NewInstance();
      }
...
PyvtkParametricTorus_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkParametricTorus::SafeDownCast(temp0);
...
PyvtkParametricTorus_GetRingRadius(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricTorus::GetRingRadius();
      }
...
PyvtkParametricTorus_GetCrossSectionRadius(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricTorus::GetCrossSectionRadius();
      }
...
PyvtkParametricTorus_GetDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricTorus::GetDimension();
      }
...
PyvtkParametricTorus_EvaluateScalar(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricTorus::EvaluateScalar(temp0, temp1, temp2);
      }
...
static PyMethodDef PyvtkParametricTorus_Methods[] = {
  {(char*)"GetClassName", PyvtkParametricTorus_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkParametricTorus_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkParametricTorus_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkParametricTorus\nC++: vtkParametricTorus *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkParametricTorus_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkParametricTorus\nC++: vtkParametricTorus *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetRingRadius", PyvtkParametricTorus_SetRingRadius, 1,
  ...
  {(char*)"GetRingRadius", PyvtkParametricTorus_GetRingRadius, 1,
   (char*)"V.GetRingRadius() -> float\nC++: double GetRingRadius()\n\nSet/Get the radius from the center to the middle of the ring of\nthe torus.  The default value is 1.0.\n"},
  {(char*)"SetCrossSectionRadius", PyvtkParametricTorus_SetCrossSectionRadius, 1,
  ...
  {(char*)"GetCrossSectionRadius", PyvtkParametricTorus_GetCrossSectionRadius, 1,
   (char*)"V.GetCrossSectionRadius() -> float\nC++: double GetCrossSectionRadius()\n\nSet/Get the radius of the cross section of ring of the torus. \nThe default value is 0.5.\n"},
  {(char*)"GetDimension", PyvtkParametricTorus_GetDimension, 1,
   (char*)"V.GetDimension() -> int\nC++: virtual int GetDimension()\n\n"},
  {(char*)"Evaluate", PyvtkParametricTorus_Evaluate, 1,
  ...
  {(char*)"EvaluateScalar", PyvtkParametricTorus_EvaluateScalar, 1,
