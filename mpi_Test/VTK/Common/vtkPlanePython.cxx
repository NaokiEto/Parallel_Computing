...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPlane(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPlane(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPlaneNew(const char *); }
#else
...
PyvtkPlane_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPlane::GetClassName();
      }
...
PyvtkPlane_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPlane::SafeDownCast(temp0);
...
PyvtkPlane_EvaluateFunction_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPlane::EvaluateFunction(temp0);
      }
...
PyvtkPlane_EvaluateFunction_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPlane::EvaluateFunction(temp0, temp1, temp2);
      }
...
PyvtkPlane_Evaluate(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(3) &&
    ...
    tempr = vtkPlane::Evaluate(temp0, temp1, temp2);
...
PyvtkPlane_DistanceToPlane_s1(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(3) &&
    ...
    tempr = vtkPlane::DistanceToPlane(temp0, temp1, temp2);
...
PyvtkPlane_DistanceToPlane_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->DistanceToPlane(temp0);
      }
    else
      {
      tempr = op->vtkPlane::DistanceToPlane(temp0);
      }
...
PyvtkPlane_IntersectWithLine_s1(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(6) &&
    ...
    tempr = vtkPlane::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5);
...
PyvtkPlane_IntersectWithLine_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPlane::IntersectWithLine(temp0, temp1, temp2, temp3);
      }
...
static PyMethodDef PyvtkPlane_Methods[] = {
  {(char*)"GetClassName", PyvtkPlane_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPlane_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPlane_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPlane\nC++: vtkPlane *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPlane_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPlane\nC++: vtkPlane *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"EvaluateFunction", PyvtkPlane_EvaluateFunction, 1,
  ...
  {(char*)"GeneralizedProjectPoint", PyvtkPlane_GeneralizedProjectPoint, 1,
  ...
  {(char*)"Evaluate", PyvtkPlane_Evaluate, 1,
  ...
  {(char*)"DistanceToPlane", PyvtkPlane_DistanceToPlane, 1,
  ...
  {(char*)"IntersectWithLine", PyvtkPlane_IntersectWithLine, 1,
