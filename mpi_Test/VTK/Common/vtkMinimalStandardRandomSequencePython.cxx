...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkMinimalStandardRandomSequence(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkMinimalStandardRandomSequence(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkMinimalStandardRandomSequenceNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkMinimalStandardRandomSequenceNew(const char *); }
#endif
...
PyvtkMinimalStandardRandomSequence_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMinimalStandardRandomSequence::GetClassName();
      }
...
PyvtkMinimalStandardRandomSequence_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMinimalStandardRandomSequence::IsA(temp0);
      }
...
PyvtkMinimalStandardRandomSequence_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkMinimalStandardRandomSequence *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMinimalStandardRandomSequence::NewInstance();
      }
...
PyvtkMinimalStandardRandomSequence_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkMinimalStandardRandomSequence::SafeDownCast(temp0);
...
PyvtkMinimalStandardRandomSequence_GetSeed(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMinimalStandardRandomSequence::GetSeed();
      }
...
PyvtkMinimalStandardRandomSequence_GetValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMinimalStandardRandomSequence::GetValue();
      }
...
PyvtkMinimalStandardRandomSequence_GetRangeValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetRangeValue(temp0, temp1);
      }
    else
      {
      tempr = op->vtkMinimalStandardRandomSequence::GetRangeValue(temp0, temp1);
      }
...
static PyMethodDef PyvtkMinimalStandardRandomSequence_Methods[] = {
  {(char*)"GetClassName", PyvtkMinimalStandardRandomSequence_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkMinimalStandardRandomSequence_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkMinimalStandardRandomSequence_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkMinimalStandardRandomSequence\nC++: vtkMinimalStandardRandomSequence *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkMinimalStandardRandomSequence_SafeDownCast, 1,
  ...
  {(char*)"SetSeed", PyvtkMinimalStandardRandomSequence_SetSeed, 1,
  ...
  {(char*)"SetSeedOnly", PyvtkMinimalStandardRandomSequence_SetSeedOnly, 1,
  ...
  {(char*)"GetSeed", PyvtkMinimalStandardRandomSequence_GetSeed, 1,
   (char*)"V.GetSeed() -> int\nC++: int GetSeed()\n\nGet the seed of the random sequence. Only useful for writing\ncorrectness test.\n"},
  {(char*)"GetValue", PyvtkMinimalStandardRandomSequence_GetValue, 1,
   (char*)"V.GetValue() -> float\nC++: virtual double GetValue()\n\nCurrent value\n\\post unit_range: result>=0.0 && result<=1.0\n"},
  {(char*)"Next", PyvtkMinimalStandardRandomSequence_Next, 1,
   (char*)"V.Next()\nC++: virtual void Next()\n\nMove to the next number in the random sequence.\n"},
  {(char*)"GetRangeValue", PyvtkMinimalStandardRandomSequence_GetRangeValue, 1,
