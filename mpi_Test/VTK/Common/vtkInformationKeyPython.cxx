...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkInformationKey(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkInformationKey(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkInformationKeyNew(const char *); }
#else
...
PyvtkInformationKey_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInformationKey::GetClassName();
      }
...
PyvtkInformationKey_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInformationKey::IsA(temp0);
      }
...
PyvtkInformationKey_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInformationKey::NewInstance();
      }
...
PyvtkInformationKey_GetName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInformationKey::GetName();
      }
...
PyvtkInformationKey_GetLocation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInformationKey::GetLocation();
      }
...
PyvtkInformationKey_Has(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkInformationKey::Has(temp0);
      }
...
static PyMethodDef PyvtkInformationKey_Methods[] = {
  {(char*)"GetClassName", PyvtkInformationKey_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkInformationKey_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkInformationKey_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkInformationKey\nC++: vtkInformationKey *NewInstance()\n\n"},
  {(char*)"GetName", PyvtkInformationKey_GetName, 1,
  ...
  {(char*)"GetLocation", PyvtkInformationKey_GetLocation, 1,
  ...
  {(char*)"ShallowCopy", PyvtkInformationKey_ShallowCopy, 1,
  ...
  {(char*)"DeepCopy", PyvtkInformationKey_DeepCopy, 1,
  ...
  {(char*)"Has", PyvtkInformationKey_Has, 1,
