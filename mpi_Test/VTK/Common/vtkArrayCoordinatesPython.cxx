...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkArrayCoordinates(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkArrayCoordinates(PyObject *, const char *); }
#endif
...
static PyMethodDef PyvtkArrayCoordinates_Methods[] = {
  {(char*)"GetDimensions", PyvtkArrayCoordinates_GetDimensions, 1,
   (char*)"V.GetDimensions() -> int\nC++: DimensionT GetDimensions()\n\nReturn the number of dimensions contained in the coordinates.\n"},
  {(char*)"SetDimensions", PyvtkArrayCoordinates_SetDimensions, 1,
...
extern PyTypeObject PyvtkArrayCoordinates_Type;
...
static PyMethodDef PyvtkArrayCoordinates_vtkArrayCoordinates_Methods[] = {
  {NULL, PyvtkArrayCoordinates_vtkArrayCoordinates_s2, 1,
   (char*)"-L"},
  {NULL, PyvtkArrayCoordinates_vtkArrayCoordinates_s5, 1,
