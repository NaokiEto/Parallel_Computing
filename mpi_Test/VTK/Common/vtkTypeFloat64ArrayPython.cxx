...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkTypeFloat64Array(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkTypeFloat64Array(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkTypeFloat64ArrayNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkTypeFloat64ArrayNew(const char *); }
#endif
...
PyvtkTypeFloat64Array_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTypeFloat64Array::GetClassName();
      }
...
PyvtkTypeFloat64Array_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTypeFloat64Array::IsA(temp0);
      }
...
PyvtkTypeFloat64Array_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkTypeFloat64Array::NewInstance();
      }
...
PyvtkTypeFloat64Array_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkTypeFloat64Array::SafeDownCast(temp0);
...
static PyMethodDef PyvtkTypeFloat64Array_Methods[] = {
  {(char*)"GetClassName", PyvtkTypeFloat64Array_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkTypeFloat64Array_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkTypeFloat64Array_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkTypeFloat64Array\nC++: vtkTypeFloat64Array *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkTypeFloat64Array_SafeDownCast, 1,
