...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkPerspectiveTransform(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkPerspectiveTransform(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkPerspectiveTransformNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkPerspectiveTransformNew(const char *); }
#endif
...
PyvtkPerspectiveTransform_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::GetClassName();
      }
...
PyvtkPerspectiveTransform_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::IsA(temp0);
      }
...
PyvtkPerspectiveTransform_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::NewInstance();
      }
...
PyvtkPerspectiveTransform_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkPerspectiveTransform::SafeDownCast(temp0);
...
static PyMethodDef PyvtkPerspectiveTransform_SetMatrix_Methods[] = {
  {NULL, PyvtkPerspectiveTransform_SetMatrix_s1, 1,
   (char*)"@O *vtkMatrix4x4"},
  {NULL, PyvtkPerspectiveTransform_SetMatrix_s2, 1,
   (char*)"@O *d"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkPerspectiveTransform_Concatenate_Methods[] = {
  {NULL, PyvtkPerspectiveTransform_Concatenate_s1, 1,
   (char*)"@O *vtkMatrix4x4"},
  {NULL, PyvtkPerspectiveTransform_Concatenate_s2, 1,
   (char*)"@O *d"},
  {NULL, PyvtkPerspectiveTransform_Concatenate_s3, 1,
...
PyvtkPerspectiveTransform_GetNumberOfConcatenatedTransforms(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::GetNumberOfConcatenatedTransforms();
      }
...
PyvtkPerspectiveTransform_GetConcatenatedTransform(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::GetConcatenatedTransform(temp0);
      }
...
PyvtkPerspectiveTransform_GetInput(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::GetInput();
      }
...
PyvtkPerspectiveTransform_GetInverseFlag(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::GetInverseFlag();
      }
...
PyvtkPerspectiveTransform_MakeTransform(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::MakeTransform();
      }
...
PyvtkPerspectiveTransform_CircuitCheck(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::CircuitCheck(temp0);
      }
...
PyvtkPerspectiveTransform_GetMTime(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkPerspectiveTransform::GetMTime();
      }
...
static PyMethodDef PyvtkPerspectiveTransform_Methods[] = {
  {(char*)"GetClassName", PyvtkPerspectiveTransform_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPerspectiveTransform_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPerspectiveTransform_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkPerspectiveTransform\nC++: vtkPerspectiveTransform *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPerspectiveTransform_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPerspectiveTransform\nC++: vtkPerspectiveTransform *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Identity", PyvtkPerspectiveTransform_Identity, 1,
  ...
  {(char*)"Inverse", PyvtkPerspectiveTransform_Inverse, 1,
  ...
  {(char*)"AdjustViewport", PyvtkPerspectiveTransform_AdjustViewport, 1,
  ...
  {(char*)"AdjustZBuffer", PyvtkPerspectiveTransform_AdjustZBuffer, 1,
  ...
  {(char*)"Ortho", PyvtkPerspectiveTransform_Ortho, 1,
  ...
  {(char*)"Frustum", PyvtkPerspectiveTransform_Frustum, 1,
  ...
  {(char*)"Perspective", PyvtkPerspectiveTransform_Perspective, 1,
  ...
  {(char*)"Shear", PyvtkPerspectiveTransform_Shear, 1,
  ...
  {(char*)"Stereo", PyvtkPerspectiveTransform_Stereo, 1,
  ...
  {(char*)"SetupCamera", PyvtkPerspectiveTransform_SetupCamera, 1,
  ...
  {(char*)"Translate", PyvtkPerspectiveTransform_Translate, 1,
  ...
  {(char*)"RotateWXYZ", PyvtkPerspectiveTransform_RotateWXYZ, 1,
  ...
  {(char*)"RotateX", PyvtkPerspectiveTransform_RotateX, 1,
  ...
  {(char*)"RotateY", PyvtkPerspectiveTransform_RotateY, 1,
   (char*)"V.RotateY(float)\nC++: void RotateY(double angle)\n\nCreate a rotation matrix about the X, Y, or Z axis and\nconcatenate it with the current transformation according to\nPreMultiply or PostMultiply semantics.  The angle is expressed in\ndegrees.\n"},
  {(char*)"RotateZ", PyvtkPerspectiveTransform_RotateZ, 1,
   (char*)"V.RotateZ(float)\nC++: void RotateZ(double angle)\n\nCreate a rotation matrix about the X, Y, or Z axis and\nconcatenate it with the current transformation according to\nPreMultiply or PostMultiply semantics.  The angle is expressed in\ndegrees.\n"},
  {(char*)"Scale", PyvtkPerspectiveTransform_Scale, 1,
  ...
  {(char*)"SetMatrix", PyvtkPerspectiveTransform_SetMatrix, 1,
  ...
  {(char*)"Concatenate", PyvtkPerspectiveTransform_Concatenate, 1,
  ...
  {(char*)"PreMultiply", PyvtkPerspectiveTransform_PreMultiply, 1,
  ...
  {(char*)"PostMultiply", PyvtkPerspectiveTransform_PostMultiply, 1,
  ...
  {(char*)"GetNumberOfConcatenatedTransforms", PyvtkPerspectiveTransform_GetNumberOfConcatenatedTransforms, 1,
  ...
  {(char*)"GetConcatenatedTransform", PyvtkPerspectiveTransform_GetConcatenatedTransform, 1,
   (char*)"V.GetConcatenatedTransform(int) -> vtkHomogeneousTransform\nC++: vtkHomogeneousTransform *GetConcatenatedTransform(int i)\n\n"},
  {(char*)"SetInput", PyvtkPerspectiveTransform_SetInput, 1,
  ...
  {(char*)"GetInput", PyvtkPerspectiveTransform_GetInput, 1,
   (char*)"V.GetInput() -> vtkHomogeneousTransform\nC++: vtkHomogeneousTransform *GetInput()\n\nSet the input for this transformation.  This will be used as the\nbase transformation if it is set.  This method allows you to\nbuild a transform pipeline: if the input is modified, then this\ntransformation will automatically update accordingly.  Note that\nthe InverseFlag, controlled via Inverse(), determines whether\nthis transformation will use the Input or the inverse of the\nInput.\n"},
  {(char*)"GetInverseFlag", PyvtkPerspectiveTransform_GetInverseFlag, 1,
  ...
  {(char*)"Push", PyvtkPerspectiveTransform_Push, 1,
   (char*)"V.Push()\nC++: void Push()\n\nPushes the current transformation onto the transformation stack.\n"},
  {(char*)"Pop", PyvtkPerspectiveTransform_Pop, 1,
   (char*)"V.Pop()\nC++: void Pop()\n\nDeletes the transformation on the top of the stack and sets the\ntop to the next transformation on the stack.\n"},
  {(char*)"MakeTransform", PyvtkPerspectiveTransform_MakeTransform, 1,
  ...
  {(char*)"CircuitCheck", PyvtkPerspectiveTransform_CircuitCheck, 1,
  ...
  {(char*)"GetMTime", PyvtkPerspectiveTransform_GetMTime, 1,
