...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkEdgeTable(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkEdgeTable(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkEdgeTableNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkEdgeTableNew(const char *); }
#endif
...
PyvtkEdgeTable_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEdgeTable::GetClassName();
      }
...
PyvtkEdgeTable_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEdgeTable::IsA(temp0);
      }
...
PyvtkEdgeTable_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEdgeTable::NewInstance();
      }
...
PyvtkEdgeTable_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkEdgeTable::SafeDownCast(temp0);
...
PyvtkEdgeTable_InitEdgeInsertion(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1, 2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->InitEdgeInsertion(temp0, temp1);
      }
    else
      {
      tempr = op->vtkEdgeTable::InitEdgeInsertion(temp0, temp1);
      }
...
PyvtkEdgeTable_InsertEdge_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->InsertEdge(temp0, temp1);
      }
    else
      {
      tempr = op->vtkEdgeTable::InsertEdge(temp0, temp1);
      }
...
static PyMethodDef PyvtkEdgeTable_InsertEdge_Methods[] = {
  {NULL, PyvtkEdgeTable_InsertEdge_s2, 1,
   (char*)"@LLL"},
  {NULL, PyvtkEdgeTable_InsertEdge_s3, 1,
   (char*)"@LLs#"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkEdgeTable_IsEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEdgeTable::IsEdge(temp0, temp1);
      }
...
PyvtkEdgeTable_InitPointInsertion(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEdgeTable::InitPointInsertion(temp0, temp1);
      }
...
PyvtkEdgeTable_InsertUniquePoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->InsertUniquePoint(temp0, temp1, temp2, temp3);
      }
    else
      {
      tempr = op->vtkEdgeTable::InsertUniquePoint(temp0, temp1, temp2, temp3);
      }
...
PyvtkEdgeTable_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkEdgeTable::GetNumberOfEdges();
      }
...
PyvtkEdgeTable_GetNextEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNextEdge(temp0, temp1);
      }
    else
      {
      tempr = op->vtkEdgeTable::GetNextEdge(temp0, temp1);
      }
...
static PyMethodDef PyvtkEdgeTable_Methods[] = {
  {(char*)"GetClassName", PyvtkEdgeTable_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkEdgeTable_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkEdgeTable_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkEdgeTable\nC++: vtkEdgeTable *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkEdgeTable_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkEdgeTable\nC++: vtkEdgeTable *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Initialize", PyvtkEdgeTable_Initialize, 1,
   (char*)"V.Initialize()\nC++: void Initialize()\n\nFree memory and return to the initially instantiated state.\n"},
  {(char*)"InitEdgeInsertion", PyvtkEdgeTable_InitEdgeInsertion, 1,
  ...
  {(char*)"InsertEdge", PyvtkEdgeTable_InsertEdge, 1,
  ...
  {(char*)"IsEdge", PyvtkEdgeTable_IsEdge, 1,
  ...
  {(char*)"InitPointInsertion", PyvtkEdgeTable_InitPointInsertion, 1,
  ...
  {(char*)"InsertUniquePoint", PyvtkEdgeTable_InsertUniquePoint, 1,
  ...
  {(char*)"Reset", PyvtkEdgeTable_Reset, 1,
