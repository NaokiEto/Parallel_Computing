...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkArrayRange(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkArrayRange(PyObject *, const char *); }
#endif
...
static PyMethodDef PyvtkArrayRange_Contains_Methods[] = {
  {NULL, PyvtkArrayRange_Contains_s1, 1,
   (char*)"O &vtkArrayRange"},
  {NULL, PyvtkArrayRange_Contains_s2, 1,
   (char*)"L"},
  {NULL, NULL, 0, NULL}
};
...
extern PyTypeObject PyvtkArrayRange_Type;
...
static PyMethodDef PyvtkArrayRange_vtkArrayRange_Methods[] = {
  {NULL, PyvtkArrayRange_vtkArrayRange_s3, 1,
   (char*)"O &vtkArrayRange"},
  {NULL, NULL, 0, NULL}
};
