...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkTimeStamp(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkTimeStamp(PyObject *, const char *); }
#endif
...
static PyMethodDef PyvtkTimeStamp_Methods[] = {
  {(char*)"Modified", PyvtkTimeStamp_Modified, 1,
  ...
  {(char*)"GetMTime", PyvtkTimeStamp_GetMTime, 1,
   (char*)"V.GetMTime() -> int\nC++: unsigned long GetMTime()\n\nReturn this object's Modified time.\n"},
  {NULL, NULL, 0, NULL}
};

#ifndef DECLARED_PyvtkTimeStamp_Type
extern PyTypeObject PyvtkTimeStamp_Type;
...
static PyMethodDef PyvtkTimeStamp_vtkTimeStamp_Methods[] = {
  {NULL, PyvtkTimeStamp_vtkTimeStamp_s2, 1,
   (char*)"O &vtkTimeStamp"},
  {NULL, NULL, 0, NULL}
};
