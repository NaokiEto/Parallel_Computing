...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkArrayExtents(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkArrayExtents(PyObject *, const char *); }
#endif
...
PyvtkArrayExtents_Uniform(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(2) &&
      ...
      ap.GetValue(temp1))
    {
    tempr = vtkArrayExtents::Uniform(temp0, temp1);
...
static PyMethodDef PyvtkArrayExtents_Methods[] = {
  {(char*)"Uniform", PyvtkArrayExtents_Uniform, 1,
  ...
  {(char*)"Append", PyvtkArrayExtents_Append, 1,
  ...
  {(char*)"GetDimensions", PyvtkArrayExtents_GetDimensions, 1,
   (char*)"V.GetDimensions() -> int\nC++: DimensionT GetDimensions()\n\nReturn the current number of dimensions.\n"},
  {(char*)"GetSize", PyvtkArrayExtents_GetSize, 1,
  ...
  {(char*)"SetDimensions", PyvtkArrayExtents_SetDimensions, 1,
  ...
  {(char*)"ZeroBased", PyvtkArrayExtents_ZeroBased, 1,
  ...
  {(char*)"SameShape", PyvtkArrayExtents_SameShape, 1,
  ...
  {(char*)"GetLeftToRightCoordinatesN", PyvtkArrayExtents_GetLeftToRightCoordinatesN, 1,
  ...
  {(char*)"GetRightToLeftCoordinatesN", PyvtkArrayExtents_GetRightToLeftCoordinatesN, 1,
  ...
  {(char*)"Contains", PyvtkArrayExtents_Contains, 1,
...
extern PyTypeObject PyvtkArrayExtents_Type;
...
static PyMethodDef PyvtkArrayExtents_vtkArrayExtents_Methods[] = {
  {NULL, PyvtkArrayExtents_vtkArrayExtents_s2, 1,
   (char*)"-L"},
  {NULL, PyvtkArrayExtents_vtkArrayExtents_s3, 1,
   (char*)"-O &vtkArrayRange"},
  {NULL, PyvtkArrayExtents_vtkArrayExtents_s4, 1,
   (char*)"LL"},
  {NULL, PyvtkArrayExtents_vtkArrayExtents_s5, 1,
   (char*)"OO &vtkArrayRange &vtkArrayRange"},
  {NULL, PyvtkArrayExtents_vtkArrayExtents_s6, 1,
   (char*)"LLL"},
  {NULL, PyvtkArrayExtents_vtkArrayExtents_s7, 1,
   (char*)"OOO &vtkArrayRange &vtkArrayRange &vtkArrayRange"},
  {NULL, PyvtkArrayExtents_vtkArrayExtents_s8, 1,
