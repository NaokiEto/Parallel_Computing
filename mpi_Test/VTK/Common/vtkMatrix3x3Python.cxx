...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkMatrix3x3(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkMatrix3x3(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkMatrix3x3New(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkMatrix3x3New(const char *); }
#endif
...
PyvtkMatrix3x3_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix3x3::GetClassName();
      }
...
PyvtkMatrix3x3_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix3x3::IsA(temp0);
      }
...
PyvtkMatrix3x3_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix3x3::NewInstance();
      }
...
PyvtkMatrix3x3_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkMatrix3x3::SafeDownCast(temp0);
...
static PyMethodDef PyvtkMatrix3x3_DeepCopy_Methods[] = {
  {NULL, PyvtkMatrix3x3_DeepCopy_s1, 1,
   (char*)"@O *vtkMatrix3x3"},
  {NULL, PyvtkMatrix3x3_DeepCopy_s2, 1,
   (char*)"OO *d *vtkMatrix3x3"},
  {NULL, PyvtkMatrix3x3_DeepCopy_s3, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix3x3_DeepCopy_s4, 1,
   (char*)"@O *d"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMatrix3x3_Invert_Methods[] = {
  {NULL, PyvtkMatrix3x3_Invert_s1, 1,
   (char*)"OO *vtkMatrix3x3 *vtkMatrix3x3"},
  {NULL, PyvtkMatrix3x3_Invert_s3, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix3x3_Invert_s4, 1,
   (char*)"@OO &vtkMatrix3x3 &vtkMatrix3x3"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMatrix3x3_Transpose_Methods[] = {
  {NULL, PyvtkMatrix3x3_Transpose_s1, 1,
   (char*)"OO *vtkMatrix3x3 *vtkMatrix3x3"},
  {NULL, PyvtkMatrix3x3_Transpose_s3, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix3x3_Transpose_s4, 1,
   (char*)"@OO &vtkMatrix3x3 &vtkMatrix3x3"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMatrix3x3_Multiply3x3_Methods[] = {
  {NULL, PyvtkMatrix3x3_Multiply3x3_s1, 1,
   (char*)"OOO *vtkMatrix3x3 *vtkMatrix3x3 *vtkMatrix3x3"},
  {NULL, PyvtkMatrix3x3_Multiply3x3_s2, 1,
   (char*)"OOO *d *d *d"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMatrix3x3_Adjoint_Methods[] = {
  {NULL, PyvtkMatrix3x3_Adjoint_s1, 1,
   (char*)"@OO *vtkMatrix3x3 *vtkMatrix3x3"},
  {NULL, PyvtkMatrix3x3_Adjoint_s2, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix3x3_Adjoint_s3, 1,
   (char*)"@OO &vtkMatrix3x3 &vtkMatrix3x3"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkMatrix3x3_Determinant_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix3x3::Determinant();
      }
...
PyvtkMatrix3x3_Determinant_s2(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetArray(temp0, size0))
    {
    tempr = vtkMatrix3x3::Determinant(temp0);
...
PyvtkMatrix3x3_Determinant_s3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix3x3::Determinant(*temp0);
      }
...
static PyMethodDef PyvtkMatrix3x3_Determinant_Methods[] = {
  {NULL, PyvtkMatrix3x3_Determinant_s2, 1,
   (char*)"O *d"},
  {NULL, PyvtkMatrix3x3_Determinant_s3, 1,
   (char*)"@O &vtkMatrix3x3"},
  {NULL, PyvtkMatrix3x3_Determinant_s4, 1,
   (char*)"@O *vtkMatrix3x3"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkMatrix3x3_GetElement(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix3x3::GetElement(temp0, temp1);
      }
...
PyvtkMatrix3x3_IsIdentity(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix3x3::IsIdentity();
      }
...
static PyMethodDef PyvtkMatrix3x3_Methods[] = {
  {(char*)"GetClassName", PyvtkMatrix3x3_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkMatrix3x3_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkMatrix3x3_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkMatrix3x3\nC++: vtkMatrix3x3 *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkMatrix3x3_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkMatrix3x3\nC++: vtkMatrix3x3 *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"DeepCopy", PyvtkMatrix3x3_DeepCopy, 1,
  ...
  {(char*)"Transpose", PyvtkMatrix3x3_Transpose, 1,
  ...
  {(char*)"MultiplyPoint", PyvtkMatrix3x3_MultiplyPoint, 1,
  ...
  {(char*)"Multiply3x3", PyvtkMatrix3x3_Multiply3x3, 1,
  ...
  {(char*)"Adjoint", PyvtkMatrix3x3_Adjoint, 1,
  ...
  {(char*)"Determinant", PyvtkMatrix3x3_Determinant, 1,
