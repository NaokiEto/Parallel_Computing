...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkArraySort(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkArraySort(PyObject *, const char *); }
#endif
...
static PyMethodDef PyvtkArraySort_Methods[] = {
  {(char*)"GetDimensions", PyvtkArraySort_GetDimensions, 1,
   (char*)"V.GetDimensions() -> int\nC++: DimensionT GetDimensions()\n\nReturn the number of dimensions for sorting.\n"},
  {(char*)"SetDimensions", PyvtkArraySort_SetDimensions, 1,
...
extern PyTypeObject PyvtkArraySort_Type;
...
static PyMethodDef PyvtkArraySort_vtkArraySort_Methods[] = {
  {NULL, PyvtkArraySort_vtkArraySort_s2, 1,
   (char*)"-L"},
  {NULL, PyvtkArraySort_vtkArraySort_s5, 1,
   (char*)"O &vtkArraySort"},
  {NULL, NULL, 0, NULL}
};
