...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkDataArray(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkDataArray(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkDataArrayNew(const char *); }
#else
...
PyvtkDataArray_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::GetClassName();
      }
...
PyvtkDataArray_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::IsA(temp0);
      }
...
PyvtkDataArray_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::NewInstance();
      }
...
PyvtkDataArray_IsNumeric(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::IsNumeric();
      }
...
PyvtkDataArray_GetElementComponentSize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::GetElementComponentSize();
      }
...
PyvtkDataArray_GetTuple1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetTuple1(temp0);
      }
    else
      {
      tempr = op->vtkDataArray::GetTuple1(temp0);
      }
...
PyvtkDataArray_GetTuple2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetTuple2(temp0);
      }
    else
      {
      tempr = op->vtkDataArray::GetTuple2(temp0);
      }
...
PyvtkDataArray_GetTuple3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetTuple3(temp0);
      }
    else
      {
      tempr = op->vtkDataArray::GetTuple3(temp0);
      }
...
PyvtkDataArray_GetTuple4(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetTuple4(temp0);
      }
    else
      {
      tempr = op->vtkDataArray::GetTuple4(temp0);
      }
...
PyvtkDataArray_GetTuple9(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetTuple9(temp0);
      }
    else
      {
      tempr = op->vtkDataArray::GetTuple9(temp0);
      }
...
PyvtkDataArray_GetComponent(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::GetComponent(temp0, temp1);
      }
...
static PyMethodDef PyvtkDataArray_DeepCopy_Methods[] = {
  {NULL, PyvtkDataArray_DeepCopy_s1, 1,
   (char*)"@O *vtkAbstractArray"},
  {NULL, PyvtkDataArray_DeepCopy_s2, 1,
   (char*)"@O *vtkDataArray"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkDataArray_GetActualMemorySize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::GetActualMemorySize();
      }
...
PyvtkDataArray_GetLookupTable(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::GetLookupTable();
      }
...
PyvtkDataArray_GetRange_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetRange(temp0);
      }
    else
      {
      tempr = op->vtkDataArray::GetRange(temp0);
      }
...
PyvtkDataArray_GetRange_s3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::GetRange();
      }
...
static PyMethodDef PyvtkDataArray_GetRange_Methods[] = {
  {NULL, PyvtkDataArray_GetRange_s2, 1,
   (char*)"@i"},
  {NULL, PyvtkDataArray_GetRange_s4, 1,
   (char*)"@O *d"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkDataArray_GetDataTypeMin_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDataTypeMin();
      }
    else
      {
      tempr = op->vtkDataArray::GetDataTypeMin();
      }
...
PyvtkDataArray_GetDataTypeMin_s2(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    tempr = vtkDataArray::GetDataTypeMin(temp0);
...
PyvtkDataArray_GetDataTypeMax_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetDataTypeMax();
      }
    else
      {
      tempr = op->vtkDataArray::GetDataTypeMax();
      }
...
PyvtkDataArray_GetDataTypeMax_s2(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    tempr = vtkDataArray::GetDataTypeMax(temp0);
...
PyvtkDataArray_GetMaxNorm(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::GetMaxNorm();
      }
...
PyvtkDataArray_CreateDataArray(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    tempr = vtkDataArray::CreateDataArray(temp0);
...
static PyObject *
PyvtkDataArray_PER_COMPONENT(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(0))
    {
    tempr = vtkDataArray::PER_COMPONENT();
...
PyvtkDataArray_COMPONENT_RANGE(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(0))
    {
    tempr = vtkDataArray::COMPONENT_RANGE();
...
PyvtkDataArray_L2_NORM_RANGE(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(0))
    {
    tempr = vtkDataArray::L2_NORM_RANGE();
...
PyvtkDataArray_CopyInformation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1, 2) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkDataArray::CopyInformation(temp0, temp1);
      }
...
static PyMethodDef PyvtkDataArray_Methods[] = {
  {(char*)"GetClassName", PyvtkDataArray_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkDataArray_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkDataArray_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkDataArray\nC++: vtkDataArray *NewInstance()\n\n"},
  {(char*)"IsNumeric", PyvtkDataArray_IsNumeric, 1,
  ...
  {(char*)"GetElementComponentSize", PyvtkDataArray_GetElementComponentSize, 1,
   (char*)"V.GetElementComponentSize() -> int\nC++: virtual int GetElementComponentSize()\n\nReturn the size, in bytes, of the lowest-level element of an\narray.  For vtkDataArray and subclasses this is the size of the\ndata type.\n"},
  {(char*)"SetTuple", PyvtkDataArray_SetTuple, 1,
  ...
  {(char*)"InsertTuple", PyvtkDataArray_InsertTuple, 1,
  ...
  {(char*)"InsertNextTuple", PyvtkDataArray_InsertNextTuple, 1,
  ...
  {(char*)"GetTuples", PyvtkDataArray_GetTuples, 1,
  ...
  {(char*)"InterpolateTuple", PyvtkDataArray_InterpolateTuple, 1,
  ...
  {(char*)"GetTuple", PyvtkDataArray_GetTuple, 1,
  ...
  {(char*)"GetTuple1", PyvtkDataArray_GetTuple1, 1,
  ...
  {(char*)"InsertTuple1", PyvtkDataArray_InsertTuple1, 1,
  ...
  {(char*)"RemoveTuple", PyvtkDataArray_RemoveTuple, 1,
  ...
  {(char*)"RemoveFirstTuple", PyvtkDataArray_RemoveFirstTuple, 1,
   (char*)"V.RemoveFirstTuple()\nC++: virtual void RemoveFirstTuple()\n\nThese methods remove tuples from the data array. They shift data\nand resize array, so the data array is still valid after this\noperation. Note, this operation is fairly slow.\n"},
  {(char*)"RemoveLastTuple", PyvtkDataArray_RemoveLastTuple, 1,
   (char*)"V.RemoveLastTuple()\nC++: virtual void RemoveLastTuple()\n\nThese methods remove tuples from the data array. They shift data\nand resize array, so the data array is still valid after this\noperation. Note, this operation is fairly slow.\n"},
  {(char*)"GetComponent", PyvtkDataArray_GetComponent, 1,
  ...
  {(char*)"SetComponent", PyvtkDataArray_SetComponent, 1,
  ...
  {(char*)"InsertComponent", PyvtkDataArray_InsertComponent, 1,
  ...
  {(char*)"GetData", PyvtkDataArray_GetData, 1,
  ...
  {(char*)"DeepCopy", PyvtkDataArray_DeepCopy, 1,
  ...
  {(char*)"FillComponent", PyvtkDataArray_FillComponent, 1,
  ...
  {(char*)"CopyComponent", PyvtkDataArray_CopyComponent, 1,
  ...
  {(char*)"WriteVoidPointer", PyvtkDataArray_WriteVoidPointer, 1,
  ...
  {(char*)"GetActualMemorySize", PyvtkDataArray_GetActualMemorySize, 1,
  ...
  {(char*)"CreateDefaultLookupTable", PyvtkDataArray_CreateDefaultLookupTable, 1,
   (char*)"V.CreateDefaultLookupTable()\nC++: void CreateDefaultLookupTable()\n\nCreate default lookup table. Generally used to create one when\nnone is available.\n"},
  {(char*)"SetLookupTable", PyvtkDataArray_SetLookupTable, 1,
  ...
  {(char*)"GetLookupTable", PyvtkDataArray_GetLookupTable, 1,
   (char*)"V.GetLookupTable() -> vtkLookupTable\nC++: vtkLookupTable *GetLookupTable()\n\nSet/get the lookup table associated with this scalar data, if\nany.\n"},
  {(char*)"GetRange", PyvtkDataArray_GetRange, 1,
  ...
  {(char*)"GetDataTypeRange", PyvtkDataArray_GetDataTypeRange, 1,
  ...
  {(char*)"PER_COMPONENT", PyvtkDataArray_PER_COMPONENT, 1,
  ...
  {(char*)"COMPONENT_RANGE", PyvtkDataArray_COMPONENT_RANGE, 1,
  ...
  {(char*)"L2_NORM_RANGE", PyvtkDataArray_L2_NORM_RANGE, 1,
  ...
  {(char*)"CopyInformation", PyvtkDataArray_CopyInformation, 1,
