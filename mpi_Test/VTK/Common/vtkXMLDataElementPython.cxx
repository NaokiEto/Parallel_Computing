...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkXMLDataElement(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkXMLDataElement(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkXMLDataElementNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkXMLDataElementNew(const char *); }
#endif
...
PyvtkXMLDataElement_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetClassName();
      }
...
PyvtkXMLDataElement_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::IsA(temp0);
      }
...
PyvtkXMLDataElement_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::NewInstance();
      }
...
PyvtkXMLDataElement_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkXMLDataElement::SafeDownCast(temp0);
...
PyvtkXMLDataElement_GetName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetName();
      }
...
PyvtkXMLDataElement_GetId(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetId();
      }
...
PyvtkXMLDataElement_GetAttribute(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetAttribute(temp0);
      }
...
PyvtkXMLDataElement_GetCharacterData(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetCharacterData();
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetCharacterData();
      }
...
PyvtkXMLDataElement_GetScalarAttribute_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetScalarAttribute(temp0, temp1);
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetScalarAttribute(temp0, temp1);
      }
...
static PyMethodDef PyvtkXMLDataElement_GetScalarAttribute_Methods[] = {
  {NULL, PyvtkXMLDataElement_GetScalarAttribute_s1, 1,
   (char*)"@zi"},
  {NULL, PyvtkXMLDataElement_GetScalarAttribute_s2, 1,
   (char*)"@zd"},
  {NULL, PyvtkXMLDataElement_GetScalarAttribute_s3, 1,
   (char*)"@zk"},
  {NULL, PyvtkXMLDataElement_GetScalarAttribute_s4, 1,
   (char*)"@zL"},
  {NULL, NULL, 0, NULL}
};
...
static PyObject *
PyvtkXMLDataElement_SetIdTypeAttribute(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SetIdTypeAttribute");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkXMLDataElement *op = static_cast<vtkXMLDataElement *>(vp);
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      op->SetIdTypeAttribute(temp0, temp1);
      }
    else
      {
      op->vtkXMLDataElement::SetIdTypeAttribute(temp0, temp1);
      }
...
PyvtkXMLDataElement_GetWordTypeAttribute(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetWordTypeAttribute(temp0, temp1);
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetWordTypeAttribute(temp0, temp1);
      }
...
PyvtkXMLDataElement_GetNumberOfAttributes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetNumberOfAttributes();
      }
...
PyvtkXMLDataElement_GetAttributeName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetAttributeName(temp0);
      }
...
PyvtkXMLDataElement_GetAttributeValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetAttributeValue(temp0);
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetAttributeValue(temp0);
      }
...
PyvtkXMLDataElement_GetParent(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetParent();
      }
...
PyvtkXMLDataElement_GetRoot(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkXMLDataElement::GetRoot();
      }
...
PyvtkXMLDataElement_GetNumberOfNestedElements(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNumberOfNestedElements();
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetNumberOfNestedElements();
      }
...
PyvtkXMLDataElement_GetNestedElement(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNestedElement(temp0);
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetNestedElement(temp0);
      }
...
PyvtkXMLDataElement_FindNestedElement(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->FindNestedElement(temp0);
      }
    else
      {
      tempr = op->vtkXMLDataElement::FindNestedElement(temp0);
      }
...
PyvtkXMLDataElement_FindNestedElementWithName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->FindNestedElementWithName(temp0);
      }
    else
      {
      tempr = op->vtkXMLDataElement::FindNestedElementWithName(temp0);
      }
...
PyvtkXMLDataElement_FindNestedElementWithNameAndId(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->FindNestedElementWithNameAndId(temp0, temp1);
      }
    else
      {
      tempr = op->vtkXMLDataElement::FindNestedElementWithNameAndId(temp0, temp1);
      }
...
PyvtkXMLDataElement_FindNestedElementWithNameAndAttribute(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->FindNestedElementWithNameAndAttribute(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkXMLDataElement::FindNestedElementWithNameAndAttribute(temp0, temp1, temp2);
      }
...
PyvtkXMLDataElement_LookupElementWithName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->LookupElementWithName(temp0);
      }
    else
      {
      tempr = op->vtkXMLDataElement::LookupElementWithName(temp0);
      }
...
PyvtkXMLDataElement_LookupElement(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->LookupElement(temp0);
      }
    else
      {
      tempr = op->vtkXMLDataElement::LookupElement(temp0);
      }
...
PyvtkXMLDataElement_GetXMLByteIndex(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetXMLByteIndex();
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetXMLByteIndex();
      }
...
PyvtkXMLDataElement_IsEqualTo(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->IsEqualTo(temp0);
      }
    else
      {
      tempr = op->vtkXMLDataElement::IsEqualTo(temp0);
      }
...
PyvtkXMLDataElement_GetAttributeEncodingMinValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetAttributeEncodingMinValue();
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetAttributeEncodingMinValue();
      }
...
PyvtkXMLDataElement_GetAttributeEncodingMaxValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetAttributeEncodingMaxValue();
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetAttributeEncodingMaxValue();
      }
...
PyvtkXMLDataElement_GetAttributeEncoding(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetAttributeEncoding();
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetAttributeEncoding();
      }
...
PyvtkXMLDataElement_GetCharacterDataWidth(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetCharacterDataWidth();
      }
    else
      {
      tempr = op->vtkXMLDataElement::GetCharacterDataWidth();
      }
...
static PyMethodDef PyvtkXMLDataElement_Methods[] = {
  {(char*)"GetClassName", PyvtkXMLDataElement_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkXMLDataElement_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkXMLDataElement_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkXMLDataElement\nC++: vtkXMLDataElement *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkXMLDataElement_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkXMLDataElement\nC++: vtkXMLDataElement *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetName", PyvtkXMLDataElement_GetName, 1,
   (char*)"V.GetName() -> string\nC++: char *GetName()\n\nSet/Get the name of the element.  This is its XML tag.\n"},
  {(char*)"SetName", PyvtkXMLDataElement_SetName, 1,
   (char*)"V.SetName(string)\nC++: virtual void SetName(const char *_arg)\n\nSet/Get the name of the element.  This is its XML tag.\n"},
  {(char*)"GetId", PyvtkXMLDataElement_GetId, 1,
   (char*)"V.GetId() -> string\nC++: char *GetId()\n\nSet/Get the value of the id attribute of the element, if any.\n"},
  {(char*)"SetId", PyvtkXMLDataElement_SetId, 1,
   (char*)"V.SetId(string)\nC++: void SetId(char *)\n\nSet/Get the value of the id attribute of the element, if any.\n"},
  {(char*)"GetAttribute", PyvtkXMLDataElement_GetAttribute, 1,
  ...
  {(char*)"SetAttribute", PyvtkXMLDataElement_SetAttribute, 1,
  ...
  {(char*)"SetCharacterData", PyvtkXMLDataElement_SetCharacterData, 1,
  ...
  {(char*)"AddCharacterData", PyvtkXMLDataElement_AddCharacterData, 1,
   (char*)"V.AddCharacterData(string, int)\nC++: void AddCharacterData(const char *c, size_t length)\n\nSet/Get the character data between XML start/end tags.\n"},
  {(char*)"GetCharacterData", PyvtkXMLDataElement_GetCharacterData, 1,
   (char*)"V.GetCharacterData() -> string\nC++: char *GetCharacterData()\n\nSet/Get the character data between XML start/end tags.\n"},
  {(char*)"GetScalarAttribute", PyvtkXMLDataElement_GetScalarAttribute, 1,
  ...
  {(char*)"SetIntAttribute", PyvtkXMLDataElement_SetIntAttribute, 1,
  ...
  {(char*)"SetFloatAttribute", PyvtkXMLDataElement_SetFloatAttribute, 1,
   (char*)"V.SetFloatAttribute(string, float)\nC++: void SetFloatAttribute(const char *name, float value)\n\nSet the attribute with the given name. We can not use the same\nGetScalarAttribute() construct since the compiler will not be\nable to resolve between SetAttribute(..., int) and\nSetAttribute(..., unsigned long).\n"},
  {(char*)"SetDoubleAttribute", PyvtkXMLDataElement_SetDoubleAttribute, 1,
   (char*)"V.SetDoubleAttribute(string, float)\nC++: void SetDoubleAttribute(const char *name, double value)\n\nSet the attribute with the given name. We can not use the same\nGetScalarAttribute() construct since the compiler will not be\nable to resolve between SetAttribute(..., int) and\nSetAttribute(..., unsigned long).\n"},
  {(char*)"SetUnsignedLongAttribute", PyvtkXMLDataElement_SetUnsignedLongAttribute, 1,
   (char*)"V.SetUnsignedLongAttribute(string, int)\nC++: void SetUnsignedLongAttribute(const char *name,\n    unsigned long value)\n\nSet the attribute with the given name. We can not use the same\nGetScalarAttribute() construct since the compiler will not be\nable to resolve between SetAttribute(..., int) and\nSetAttribute(..., unsigned long).\n"},
  {(char*)"SetIdTypeAttribute", PyvtkXMLDataElement_SetIdTypeAttribute, 1,
   (char*)"V.SetIdTypeAttribute(string, int)\nC++: void SetIdTypeAttribute(const char *name, vtkIdType value)\n\n"},
  {(char*)"GetWordTypeAttribute", PyvtkXMLDataElement_GetWordTypeAttribute, 1,
  ...
  {(char*)"GetNumberOfAttributes", PyvtkXMLDataElement_GetNumberOfAttributes, 1,
   (char*)"V.GetNumberOfAttributes() -> int\nC++: int GetNumberOfAttributes()\n\nGet the number of attributes.\n"},
  {(char*)"GetAttributeName", PyvtkXMLDataElement_GetAttributeName, 1,
  ...
  {(char*)"GetAttributeValue", PyvtkXMLDataElement_GetAttributeValue, 1,
  ...
  {(char*)"FindNestedElementWithName", PyvtkXMLDataElement_FindNestedElementWithName, 1,
   (char*)"V.FindNestedElementWithName(string) -> vtkXMLDataElement\nC++: vtkXMLDataElement *FindNestedElementWithName(\n    const char *name)\n\nFind the first nested element with the given id, given name, or\ngiven name and id. WARNING: the search is only performed on the\nchildren, not the grand-children.\n"},
  {(char*)"FindNestedElementWithNameAndId", PyvtkXMLDataElement_FindNestedElementWithNameAndId, 1,
   (char*)"V.FindNestedElementWithNameAndId(string, string)\n    -> vtkXMLDataElement\nC++: vtkXMLDataElement *FindNestedElementWithNameAndId(\n    const char *name, const char *id)\n\nFind the first nested element with the given id, given name, or\ngiven name and id. WARNING: the search is only performed on the\nchildren, not the grand-children.\n"},
  {(char*)"FindNestedElementWithNameAndAttribute", PyvtkXMLDataElement_FindNestedElementWithNameAndAttribute, 1,
  ...
  {(char*)"LookupElementWithName", PyvtkXMLDataElement_LookupElementWithName, 1,
  ...
  {(char*)"LookupElement", PyvtkXMLDataElement_LookupElement, 1,
  ...
  {(char*)"GetXMLByteIndex", PyvtkXMLDataElement_GetXMLByteIndex, 1,
   (char*)"V.GetXMLByteIndex() -> int\nC++: unsigned long GetXMLByteIndex()\n\nSet/Get the offset from the beginning of the XML document to this\nelement.\n"},
  {(char*)"SetXMLByteIndex", PyvtkXMLDataElement_SetXMLByteIndex, 1,
   (char*)"V.SetXMLByteIndex(int)\nC++: void SetXMLByteIndex(unsigned long a)\n\nSet/Get the offset from the beginning of the XML document to this\nelement.\n"},
  {(char*)"IsEqualTo", PyvtkXMLDataElement_IsEqualTo, 1,
  ...
  {(char*)"DeepCopy", PyvtkXMLDataElement_DeepCopy, 1,
  ...
  {(char*)"SetAttributeEncoding", PyvtkXMLDataElement_SetAttributeEncoding, 1,
  ...
  {(char*)"GetAttributeEncodingMinValue", PyvtkXMLDataElement_GetAttributeEncodingMinValue, 1,
   (char*)"V.GetAttributeEncodingMinValue() -> int\nC++: int GetAttributeEncodingMinValue()\n\nGet/Set the internal character encoding of the attributes.\nDefault type is VTK_ENCODING_UTF_8. Note that a vtkXMLDataParser\nhas its own AttributesEncoding ivar. If this ivar is set to\nsomething other than VTK_ENCODING_NONE, it will be used to set\nthe attribute encoding of each vtkXMLDataElement created by this\nvtkXMLDataParser.\n"},
  {(char*)"GetAttributeEncodingMaxValue", PyvtkXMLDataElement_GetAttributeEncodingMaxValue, 1,
   (char*)"V.GetAttributeEncodingMaxValue() -> int\nC++: int GetAttributeEncodingMaxValue()\n\nGet/Set the internal character encoding of the attributes.\nDefault type is VTK_ENCODING_UTF_8. Note that a vtkXMLDataParser\nhas its own AttributesEncoding ivar. If this ivar is set to\nsomething other than VTK_ENCODING_NONE, it will be used to set\nthe attribute encoding of each vtkXMLDataElement created by this\nvtkXMLDataParser.\n"},
  {(char*)"GetAttributeEncoding", PyvtkXMLDataElement_GetAttributeEncoding, 1,
   (char*)"V.GetAttributeEncoding() -> int\nC++: int GetAttributeEncoding()\n\nGet/Set the internal character encoding of the attributes.\nDefault type is VTK_ENCODING_UTF_8. Note that a vtkXMLDataParser\nhas its own AttributesEncoding ivar. If this ivar is set to\nsomething other than VTK_ENCODING_NONE, it will be used to set\nthe attribute encoding of each vtkXMLDataElement created by this\nvtkXMLDataParser.\n"},
  {(char*)"PrintXML", PyvtkXMLDataElement_PrintXML, 1,
   (char*)"V.PrintXML(string)\nC++: void PrintXML(const char *fname)\n\nPrints element tree as XML.\n"},
  {(char*)"GetCharacterDataWidth", PyvtkXMLDataElement_GetCharacterDataWidth, 1,
  ...
  {(char*)"SetCharacterDataWidth", PyvtkXMLDataElement_SetCharacterDataWidth, 1,
