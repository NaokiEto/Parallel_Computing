...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkGarbageCollector(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkGarbageCollector(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkGarbageCollectorNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkGarbageCollectorNew(const char *); }
#endif
...
PyvtkGarbageCollector_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGarbageCollector::GetClassName();
      }
...
PyvtkGarbageCollector_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGarbageCollector::IsA(temp0);
      }
...
PyvtkGarbageCollector_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGarbageCollector::NewInstance();
      }
...
PyvtkGarbageCollector_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkGarbageCollector::SafeDownCast(temp0);
...
PyvtkGarbageCollector_GetGlobalDebugFlag(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(0))
    {
    tempr = vtkGarbageCollector::GetGlobalDebugFlag();
...
static PyMethodDef PyvtkGarbageCollector_Methods[] = {
  {(char*)"GetClassName", PyvtkGarbageCollector_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkGarbageCollector_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkGarbageCollector_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkGarbageCollector\nC++: vtkGarbageCollector *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkGarbageCollector_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkGarbageCollector\nC++: vtkGarbageCollector *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Collect", PyvtkGarbageCollector_Collect, 1,
  ...
  {(char*)"DeferredCollectionPush", PyvtkGarbageCollector_DeferredCollectionPush, 1,
  ...
  {(char*)"DeferredCollectionPop", PyvtkGarbageCollector_DeferredCollectionPop, 1,
   (char*)"V.DeferredCollectionPop()\nC++: static void DeferredCollectionPop()\n\nPush/Pop whether to do deferred collection.  Whenever the total\nnumber of pushes exceeds the total number of pops collection will\nbe deferred.  Code can call the Collect method directly to force\ncollection.\n"},
  {(char*)"SetGlobalDebugFlag", PyvtkGarbageCollector_SetGlobalDebugFlag, 1,
  ...
  {(char*)"GetGlobalDebugFlag", PyvtkGarbageCollector_GetGlobalDebugFlag, 1,
