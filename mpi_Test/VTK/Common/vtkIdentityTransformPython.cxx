...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkIdentityTransform(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkIdentityTransform(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkIdentityTransformNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkIdentityTransformNew(const char *); }
#endif
...
PyvtkIdentityTransform_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIdentityTransform::GetClassName();
      }
...
PyvtkIdentityTransform_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIdentityTransform::IsA(temp0);
      }
...
PyvtkIdentityTransform_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIdentityTransform::NewInstance();
      }
...
PyvtkIdentityTransform_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkIdentityTransform::SafeDownCast(temp0);
...
PyvtkIdentityTransform_MakeTransform(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkIdentityTransform::MakeTransform();
      }
...
static PyMethodDef PyvtkIdentityTransform_Methods[] = {
  ...
  {(char*)"Inverse", PyvtkIdentityTransform_Inverse, 1,
   (char*)"V.Inverse()\nC++: void Inverse()\n\n"},
  {(char*)"InternalTransformPoint", PyvtkIdentityTransform_InternalTransformPoint, 1,
  ...
  {(char*)"InternalTransformNormal", PyvtkIdentityTransform_InternalTransformNormal, 1,
   (char*)"V.InternalTransformNormal((float, float, float), [float, float,\n    float])\nC++: void InternalTransformNormal(const double in[3],\n    double out[3])\n\nThis will calculate the transformation without calling Update.\nMeant for use only within other VTK classes.\n"},
  {(char*)"InternalTransformVector", PyvtkIdentityTransform_InternalTransformVector, 1,
   (char*)"V.InternalTransformVector((float, float, float), [float, float,\n    float])\nC++: void InternalTransformVector(const double in[3],\n    double out[3])\n\nThis will calculate the transformation without calling Update.\nMeant for use only within other VTK classes.\n"},
  {(char*)"InternalTransformDerivative", PyvtkIdentityTransform_InternalTransformDerivative, 1,
  ...
  {(char*)"MakeTransform", PyvtkIdentityTransform_MakeTransform, 1,
