...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkFastNumericConversion(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkFastNumericConversion(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkFastNumericConversionNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkFastNumericConversionNew(const char *); }
#endif
...
PyvtkFastNumericConversion_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFastNumericConversion::GetClassName();
      }
...
PyvtkFastNumericConversion_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFastNumericConversion::IsA(temp0);
      }
...
PyvtkFastNumericConversion_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkFastNumericConversion *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkFastNumericConversion::NewInstance();
      }
...
PyvtkFastNumericConversion_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkFastNumericConversion::SafeDownCast(temp0);
...
PyvtkFastNumericConversion_TestQuickFloor(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TestQuickFloor(temp0);
      }
    else
      {
      tempr = op->vtkFastNumericConversion::TestQuickFloor(temp0);
      }
...
PyvtkFastNumericConversion_TestSafeFloor(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TestSafeFloor(temp0);
      }
    else
      {
      tempr = op->vtkFastNumericConversion::TestSafeFloor(temp0);
      }
...
PyvtkFastNumericConversion_TestRound(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TestRound(temp0);
      }
    else
      {
      tempr = op->vtkFastNumericConversion::TestRound(temp0);
      }
...
PyvtkFastNumericConversion_TestConvertFixedPointIntPart(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TestConvertFixedPointIntPart(temp0);
      }
    else
      {
      tempr = op->vtkFastNumericConversion::TestConvertFixedPointIntPart(temp0);
      }
...
PyvtkFastNumericConversion_TestConvertFixedPointFracPart(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TestConvertFixedPointFracPart(temp0);
      }
    else
      {
      tempr = op->vtkFastNumericConversion::TestConvertFixedPointFracPart(temp0);
      }
...
PyvtkFastNumericConversion_RoundingTieBreaker(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(0))
    {
    tempr = vtkFastNumericConversion::RoundingTieBreaker();
...
PyvtkFastNumericConversion_QuickFloor(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    tempr = vtkFastNumericConversion::QuickFloor(temp0);
...
PyvtkFastNumericConversion_SafeFloor(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    tempr = vtkFastNumericConversion::SafeFloor(temp0);
...
PyvtkFastNumericConversion_Round(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    tempr = vtkFastNumericConversion::Round(temp0);
...
PyvtkFastNumericConversion_ConvertFixedPoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->ConvertFixedPoint(temp0, temp1);
      }
    else
      {
      tempr = op->vtkFastNumericConversion::ConvertFixedPoint(temp0, temp1);
      }
...
static PyMethodDef PyvtkFastNumericConversion_Methods[] = {
  {(char*)"GetClassName", PyvtkFastNumericConversion_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkFastNumericConversion_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkFastNumericConversion_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkFastNumericConversion\nC++: vtkFastNumericConversion *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkFastNumericConversion_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkFastNumericConversion\nC++: vtkFastNumericConversion *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"TestQuickFloor", PyvtkFastNumericConversion_TestQuickFloor, 1,
   (char*)"V.TestQuickFloor(float) -> int\nC++: int TestQuickFloor(double val)\n\n"},
  {(char*)"TestSafeFloor", PyvtkFastNumericConversion_TestSafeFloor, 1,
   (char*)"V.TestSafeFloor(float) -> int\nC++: int TestSafeFloor(double val)\n\n"},
  {(char*)"TestRound", PyvtkFastNumericConversion_TestRound, 1,
   (char*)"V.TestRound(float) -> int\nC++: int TestRound(double val)\n\n"},
  {(char*)"TestConvertFixedPointIntPart", PyvtkFastNumericConversion_TestConvertFixedPointIntPart, 1,
   (char*)"V.TestConvertFixedPointIntPart(float) -> int\nC++: int TestConvertFixedPointIntPart(double val)\n\n"},
  {(char*)"TestConvertFixedPointFracPart", PyvtkFastNumericConversion_TestConvertFixedPointFracPart, 1,
   (char*)"V.TestConvertFixedPointFracPart(float) -> int\nC++: int TestConvertFixedPointFracPart(double val)\n\n"},
  {(char*)"RoundingTieBreaker", PyvtkFastNumericConversion_RoundingTieBreaker, 1,
  ...
  {(char*)"SetReservedFracBits", PyvtkFastNumericConversion_SetReservedFracBits, 1,
  ...
  {(char*)"QuickFloor", PyvtkFastNumericConversion_QuickFloor, 1,
  ...
  {(char*)"SafeFloor", PyvtkFastNumericConversion_SafeFloor, 1,
  ...
  {(char*)"Round", PyvtkFastNumericConversion_Round, 1,
  ...
  {(char*)"ConvertFixedPoint", PyvtkFastNumericConversion_ConvertFixedPoint, 1,
  ...
  PyObject *dict, const char *modulename)
{
  ...
  Py_INCREF(Py_None);
  o = Py_None;
  if (o && PyDict_SetItemString(dict, (char *)"VTK_EXT_PREC", o) != 0)
    {
    Py_DECREF(o);
    }
