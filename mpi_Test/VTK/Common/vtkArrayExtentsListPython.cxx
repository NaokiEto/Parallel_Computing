...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkArrayExtentsList(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkArrayExtentsList(PyObject *, const char *); }
#endif
...
static PyMethodDef PyvtkArrayExtentsList_Methods[] = {
  {(char*)"GetCount", PyvtkArrayExtentsList_GetCount, 1,
   (char*)"V.GetCount() -> int\nC++: vtkIdType GetCount()\n\nReturns the number of slices stored in this collection.\n"},
  {(char*)"SetCount", PyvtkArrayExtentsList_SetCount, 1,
...
extern PyTypeObject PyvtkArrayExtentsList_Type;
...
static PyMethodDef PyvtkArrayExtentsList_vtkArrayExtentsList_Methods[] = {
  {NULL, PyvtkArrayExtentsList_vtkArrayExtentsList_s2, 1,
   (char*)"O &vtkArrayExtents"},
  {NULL, PyvtkArrayExtentsList_vtkArrayExtentsList_s6, 1,
