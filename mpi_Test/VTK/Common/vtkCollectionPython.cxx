...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkCollection(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkCollection(PyObject *, const char *); }
#endif
...
extern PyTypeObject PyvtkCollectionElement_Type;
...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkCollectionNew(const char *); }
#else
...
PyvtkCollection_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkCollection::GetClassName();
      }
...
PyvtkCollection_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkCollection::IsA(temp0);
      }
...
PyvtkCollection_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkCollection::NewInstance();
      }
...
PyvtkCollection_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkCollection::SafeDownCast(temp0);
...
static PyMethodDef PyvtkCollection_RemoveItem_Methods[] = {
  {NULL, PyvtkCollection_RemoveItem_s1, 1,
   (char*)"@i"},
  {NULL, PyvtkCollection_RemoveItem_s2, 1,
   (char*)"@O *vtkObject"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkCollection_IsItemPresent(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkCollection::IsItemPresent(temp0);
      }
...
PyvtkCollection_GetNumberOfItems(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkCollection::GetNumberOfItems();
      }
...
PyvtkCollection_GetNextItemAsObject(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetNextItemAsObject();
      }
    else
      {
      tempr = op->vtkCollection::GetNextItemAsObject();
      }
...
PyvtkCollection_GetItemAsObject(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetItemAsObject(temp0);
      }
    else
      {
      tempr = op->vtkCollection::GetItemAsObject(temp0);
      }
...
PyvtkCollection_NewIterator(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkCollection::NewIterator();
      }
...
static PyMethodDef PyvtkCollection_Methods[] = {
  {(char*)"GetClassName", PyvtkCollection_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkCollection_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkCollection_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkCollection\nC++: vtkCollection *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkCollection_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkCollection\nC++: vtkCollection *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"AddItem", PyvtkCollection_AddItem, 1,
   (char*)"V.AddItem(vtkObject)\nC++: void AddItem(vtkObject *)\n\nAdd an object to the list. Does not prevent duplicate entries.\n"},
  {(char*)"InsertItem", PyvtkCollection_InsertItem, 1,
  ...
  {(char*)"ReplaceItem", PyvtkCollection_ReplaceItem, 1,
   (char*)"V.ReplaceItem(int, vtkObject)\nC++: void ReplaceItem(int i, vtkObject *)\n\nReplace the i'th item in the collection with a\n"},
  {(char*)"RemoveItem", PyvtkCollection_RemoveItem, 1,
  ...
  {(char*)"RemoveAllItems", PyvtkCollection_RemoveAllItems, 1,
   (char*)"V.RemoveAllItems()\nC++: void RemoveAllItems()\n\nRemove all objects from the list.\n"},
  {(char*)"IsItemPresent", PyvtkCollection_IsItemPresent, 1,
  ...
  {(char*)"GetNumberOfItems", PyvtkCollection_GetNumberOfItems, 1,
   (char*)"V.GetNumberOfItems() -> int\nC++: int GetNumberOfItems()\n\nReturn the number of objects in the list.\n"},
  {(char*)"InitTraversal", PyvtkCollection_InitTraversal, 1,
  ...
  {(char*)"GetNextItemAsObject", PyvtkCollection_GetNextItemAsObject, 1,
  ...
  {(char*)"GetItemAsObject", PyvtkCollection_GetItemAsObject, 1,
  ...
  {(char*)"NewIterator", PyvtkCollection_NewIterator, 1,
