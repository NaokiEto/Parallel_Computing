...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkLinearTransform(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkLinearTransform(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkLinearTransformNew(const char *); }
#else
...
PyvtkLinearTransform_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLinearTransform::GetClassName();
      }
...
PyvtkLinearTransform_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLinearTransform::IsA(temp0);
      }
...
PyvtkLinearTransform_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkLinearTransform::NewInstance();
      }
...
PyvtkLinearTransform_TransformNormal_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformNormal(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformNormal(temp0, temp1, temp2);
      }
...
PyvtkLinearTransform_TransformNormal_s3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformNormal(temp0);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformNormal(temp0);
      }
...
PyvtkLinearTransform_TransformFloatNormal_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformFloatNormal(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformFloatNormal(temp0, temp1, temp2);
      }
...
PyvtkLinearTransform_TransformFloatNormal_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformFloatNormal(temp0);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformFloatNormal(temp0);
      }
...
PyvtkLinearTransform_TransformDoubleNormal_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformDoubleNormal(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformDoubleNormal(temp0, temp1, temp2);
      }
...
PyvtkLinearTransform_TransformDoubleNormal_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformDoubleNormal(temp0);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformDoubleNormal(temp0);
      }
...
PyvtkLinearTransform_TransformVector_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformVector(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformVector(temp0, temp1, temp2);
      }
...
PyvtkLinearTransform_TransformVector_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformVector(temp0);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformVector(temp0);
      }
...
PyvtkLinearTransform_TransformFloatVector_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformFloatVector(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformFloatVector(temp0, temp1, temp2);
      }
...
PyvtkLinearTransform_TransformFloatVector_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformFloatVector(temp0);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformFloatVector(temp0);
      }
...
PyvtkLinearTransform_TransformDoubleVector_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformDoubleVector(temp0, temp1, temp2);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformDoubleVector(temp0, temp1, temp2);
      }
...
PyvtkLinearTransform_TransformDoubleVector_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->TransformDoubleVector(temp0);
      }
    else
      {
      tempr = op->vtkLinearTransform::TransformDoubleVector(temp0);
      }
...
PyvtkLinearTransform_GetLinearInverse(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->GetLinearInverse();
      }
    else
      {
      tempr = op->vtkLinearTransform::GetLinearInverse();
      }
...
static PyMethodDef PyvtkLinearTransform_Methods[] = {
  {(char*)"GetClassName", PyvtkLinearTransform_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkLinearTransform_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkLinearTransform_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkLinearTransform\nC++: vtkLinearTransform *NewInstance()\n\n"},
  {(char*)"TransformNormal", PyvtkLinearTransform_TransformNormal, 1,
  ...
  {(char*)"TransformFloatNormal", PyvtkLinearTransform_TransformFloatNormal, 1,
  ...
  {(char*)"TransformDoubleNormal", PyvtkLinearTransform_TransformDoubleNormal, 1,
  ...
  {(char*)"TransformVector", PyvtkLinearTransform_TransformVector, 1,
  ...
  {(char*)"TransformFloatVector", PyvtkLinearTransform_TransformFloatVector, 1,
  ...
  {(char*)"TransformDoubleVector", PyvtkLinearTransform_TransformDoubleVector, 1,
  ...
  {(char*)"GetLinearInverse", PyvtkLinearTransform_GetLinearInverse, 1,
  ...
  {(char*)"InternalTransformPoint", PyvtkLinearTransform_InternalTransformPoint, 1,
  ...
  {(char*)"InternalTransformNormal", PyvtkLinearTransform_InternalTransformNormal, 1,
   (char*)"V.InternalTransformNormal((float, float, float), [float, float,\n    float])\nC++: virtual void InternalTransformNormal(const double in[3],\n    double out[3])\n\nThis will calculate the transformation without calling Update.\nMeant for use only within other VTK classes.\n"},
  {(char*)"InternalTransformVector", PyvtkLinearTransform_InternalTransformVector, 1,
   (char*)"V.InternalTransformVector((float, float, float), [float, float,\n    float])\nC++: virtual void InternalTransformVector(const double in[3],\n    double out[3])\n\nThis will calculate the transformation without calling Update.\nMeant for use only within other VTK classes.\n"},
  {(char*)"InternalTransformDerivative", PyvtkLinearTransform_InternalTransformDerivative, 1,
