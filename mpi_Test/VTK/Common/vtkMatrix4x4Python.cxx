...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkMatrix4x4(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkMatrix4x4(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkMatrix4x4New(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkMatrix4x4New(const char *); }
#endif
...
PyvtkMatrix4x4_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix4x4::GetClassName();
      }
...
PyvtkMatrix4x4_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix4x4::IsA(temp0);
      }
...
PyvtkMatrix4x4_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkMatrix4x4::NewInstance();
      }
...
PyvtkMatrix4x4_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkMatrix4x4::SafeDownCast(temp0);
...
static PyMethodDef PyvtkMatrix4x4_DeepCopy_Methods[] = {
  {NULL, PyvtkMatrix4x4_DeepCopy_s1, 1,
   (char*)"@O *vtkMatrix4x4"},
  {NULL, PyvtkMatrix4x4_DeepCopy_s2, 1,
   (char*)"OO *d *vtkMatrix4x4"},
  {NULL, PyvtkMatrix4x4_DeepCopy_s3, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix4x4_DeepCopy_s4, 1,
   (char*)"@O *d"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMatrix4x4_Invert_Methods[] = {
  {NULL, PyvtkMatrix4x4_Invert_s1, 1,
   (char*)"OO *vtkMatrix4x4 *vtkMatrix4x4"},
  {NULL, PyvtkMatrix4x4_Invert_s3, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix4x4_Invert_s4, 1,
   (char*)"@OO &vtkMatrix4x4 &vtkMatrix4x4"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMatrix4x4_Transpose_Methods[] = {
  {NULL, PyvtkMatrix4x4_Transpose_s1, 1,
   (char*)"OO *vtkMatrix4x4 *vtkMatrix4x4"},
  {NULL, PyvtkMatrix4x4_Transpose_s3, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix4x4_Transpose_s4, 1,
   (char*)"@OO &vtkMatrix4x4 &vtkMatrix4x4"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkMatrix4x4_MultiplyPoint_s3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->MultiplyPoint(temp0);
      }
    else
      {
      tempr = op->vtkMatrix4x4::MultiplyPoint(temp0);
      }
...
static PyMethodDef PyvtkMatrix4x4_MultiplyPoint_Methods[] = {
  {NULL, PyvtkMatrix4x4_MultiplyPoint_s1, 1,
   (char*)"@OO *d *d"},
  {NULL, PyvtkMatrix4x4_MultiplyPoint_s2, 1,
   (char*)"OOO *d *d *d"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkMatrix4x4_MultiplyFloatPoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->MultiplyFloatPoint(temp0);
      }
    else
      {
      tempr = op->vtkMatrix4x4::MultiplyFloatPoint(temp0);
      }
...
PyvtkMatrix4x4_MultiplyDoublePoint(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->MultiplyDoublePoint(temp0);
      }
    else
      {
      tempr = op->vtkMatrix4x4::MultiplyDoublePoint(temp0);
      }
...
static PyMethodDef PyvtkMatrix4x4_Multiply4x4_Methods[] = {
  {NULL, PyvtkMatrix4x4_Multiply4x4_s1, 1,
   (char*)"OOO *vtkMatrix4x4 *vtkMatrix4x4 *vtkMatrix4x4"},
  {NULL, PyvtkMatrix4x4_Multiply4x4_s2, 1,
   (char*)"OOO *d *d *d"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkMatrix4x4_Adjoint_Methods[] = {
  {NULL, PyvtkMatrix4x4_Adjoint_s1, 1,
   (char*)"@OO *vtkMatrix4x4 *vtkMatrix4x4"},
  {NULL, PyvtkMatrix4x4_Adjoint_s2, 1,
   (char*)"OO *d *d"},
  {NULL, PyvtkMatrix4x4_Adjoint_s3, 1,
   (char*)"@OO &vtkMatrix4x4 &vtkMatrix4x4"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkMatrix4x4_Determinant_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      {
      tempr = op->Determinant();
      }
    else
      {
      tempr = op->vtkMatrix4x4::Determinant();
      }
...
PyvtkMatrix4x4_Determinant_s2(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetArray(temp0, size0))
    {
    tempr = vtkMatrix4x4::Determinant(temp0);
...
PyvtkMatrix4x4_Determinant_s3(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->Determinant(*temp0);
      }
    else
      {
      tempr = op->vtkMatrix4x4::Determinant(*temp0);
      }
...
static PyMethodDef PyvtkMatrix4x4_Determinant_Methods[] = {
  {NULL, PyvtkMatrix4x4_Determinant_s2, 1,
   (char*)"O *d"},
  {NULL, PyvtkMatrix4x4_Determinant_s3, 1,
   (char*)"@O &vtkMatrix4x4"},
  {NULL, PyvtkMatrix4x4_Determinant_s4, 1,
   (char*)"@O *vtkMatrix4x4"},
  {NULL, NULL, 0, NULL}
};
...
PyvtkMatrix4x4_GetElement(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      {
      tempr = op->GetElement(temp0, temp1);
      }
    else
      {
      tempr = op->vtkMatrix4x4::GetElement(temp0, temp1);
      }
...
static PyMethodDef PyvtkMatrix4x4_Methods[] = {
  {(char*)"GetClassName", PyvtkMatrix4x4_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkMatrix4x4_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkMatrix4x4_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkMatrix4x4\nC++: vtkMatrix4x4 *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkMatrix4x4_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkMatrix4x4\nC++: vtkMatrix4x4 *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"DeepCopy", PyvtkMatrix4x4_DeepCopy, 1,
  ...
  {(char*)"Transpose", PyvtkMatrix4x4_Transpose, 1,
  ...
  {(char*)"MultiplyPoint", PyvtkMatrix4x4_MultiplyPoint, 1,
  ...
  {(char*)"MultiplyFloatPoint", PyvtkMatrix4x4_MultiplyFloatPoint, 1,
  ...
  {(char*)"MultiplyDoublePoint", PyvtkMatrix4x4_MultiplyDoublePoint, 1,
   (char*)"V.MultiplyDoublePoint((float, float, float, float)) -> (float,\n    float, float, float)\nC++: double *MultiplyDoublePoint(const double in[4])\n\nFor use in Java, Python or Tcl.  The default MultiplyPoint() uses\na single-precision point.\n"},
  {(char*)"Multiply4x4", PyvtkMatrix4x4_Multiply4x4, 1,
  ...
  {(char*)"Adjoint", PyvtkMatrix4x4_Adjoint, 1,
  ...
  {(char*)"Determinant", PyvtkMatrix4x4_Determinant, 1,
