...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkRect(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkRect(PyObject *, const char *); }
#endif
...
static PyMethodDef PyvtkRect_IdE_vtkRect_Methods[] = {
  {NULL, PyvtkRect_IdE_vtkRect_s1, 1,
   (char*)"|dddd"},
  {NULL, PyvtkRect_IdE_vtkRect_s2, 1,
   (char*)"-O *d"},
  {NULL, PyvtkRect_IdE_vtkRect_s3, 1,
   (char*)"O &vtkRect_IdE"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkRect_IfE_Methods[] = {
  {(char*)"Set", PyvtkRect_IfE_Set, 1,
   (char*)"V.Set(float, float, float, float)\nC++: void Set(const float &x, const float &y, const float &width,\n    const float &height)\n\nSet the x, y components of the rectangle, and the width/height.\n"},
  {(char*)"SetX", PyvtkRect_IfE_SetX, 1,
   (char*)"V.SetX(float)\nC++: void SetX(const float &x)\n\nSet the x component of the rectangle bottom corner, i.e. element\n0.\n"},
  {(char*)"GetX", PyvtkRect_IfE_GetX, 1,
   (char*)"V.GetX() -> float\nC++: const float &GetX()\n\nGet the x component of the rectangle bottom corner, i.e. element\n0.\n"},
  {(char*)"X", PyvtkRect_IfE_X, 1,
   (char*)"V.X() -> float\nC++: const float &X()\n\nGet the x component of the rectangle bottom corner, i.e. element\n0.\n"},
  {(char*)"SetY", PyvtkRect_IfE_SetY, 1,
   (char*)"V.SetY(float)\nC++: void SetY(const float &y)\n\nSet the y component of the rectangle bottom corner, i.e. element\n1.\n"},
  {(char*)"GetY", PyvtkRect_IfE_GetY, 1,
   (char*)"V.GetY() -> float\nC++: const float &GetY()\n\nGet the y component of the rectangle bottom corner, i.e. element\n1.\n"},
  {(char*)"Y", PyvtkRect_IfE_Y, 1,
   (char*)"V.Y() -> float\nC++: const float &Y()\n\nGet the y component of the rectangle bottom corner, i.e. element\n1.\n"},
  {(char*)"SetWidth", PyvtkRect_IfE_SetWidth, 1,
   (char*)"V.SetWidth(float)\nC++: void SetWidth(const float &width)\n\nSet the width of the rectanle, i.e. element 2.\n"},
  {(char*)"GetWidth", PyvtkRect_IfE_GetWidth, 1,
   (char*)"V.GetWidth() -> float\nC++: const float &GetWidth()\n\nGet the width of the rectangle, i.e. element 2.\n"},
  {(char*)"Width", PyvtkRect_IfE_Width, 1,
   (char*)"V.Width() -> float\nC++: const float &Width()\n\nGet the width of the rectangle, i.e. element 2.\n"},
  {(char*)"SetHeight", PyvtkRect_IfE_SetHeight, 1,
   (char*)"V.SetHeight(float)\nC++: void SetHeight(const float &height)\n\nSet the height of the rectangle, i.e. element 3.\n"},
  {(char*)"GetHeight", PyvtkRect_IfE_GetHeight, 1,
   (char*)"V.GetHeight() -> float\nC++: const float &GetHeight()\n\nGet the height of the rectangle, i.e. element 3.\n"},
  {(char*)"Height", PyvtkRect_IfE_Height, 1,
   (char*)"V.Height() -> float\nC++: const float &Height()\n\nGet the height of the rectangle, i.e. element 3.\n"},
  {NULL, NULL, 0, NULL}
};

#ifndef DECLARED_PyvtkRect_IfE_Type
extern PyTypeObject PyvtkRect_IfE_Type;
...
static PyMethodDef PyvtkRect_IfE_vtkRect_Methods[] = {
  {NULL, PyvtkRect_IfE_vtkRect_s1, 1,
   (char*)"|ffff"},
  {NULL, PyvtkRect_IfE_vtkRect_s2, 1,
   (char*)"-O *f"},
  {NULL, PyvtkRect_IfE_vtkRect_s3, 1,
   (char*)"O &vtkRect_IfE"},
  {NULL, NULL, 0, NULL}
};
...
static PyMethodDef PyvtkRect_IiE_Methods[] = {
  {(char*)"Set", PyvtkRect_IiE_Set, 1,
   (char*)"V.Set(int, int, int, int)\nC++: void Set(const int &x, const int &y, const int &width,\n    const int &height)\n\nSet the x, y components of the rectangle, and the width/height.\n"},
  {(char*)"SetX", PyvtkRect_IiE_SetX, 1,
   (char*)"V.SetX(int)\nC++: void SetX(const int &x)\n\nSet the x component of the rectangle bottom corner, i.e. element\n0.\n"},
  {(char*)"GetX", PyvtkRect_IiE_GetX, 1,
   (char*)"V.GetX() -> int\nC++: const int &GetX()\n\nGet the x component of the rectangle bottom corner, i.e. element\n0.\n"},
  {(char*)"X", PyvtkRect_IiE_X, 1,
   (char*)"V.X() -> int\nC++: const int &X()\n\nGet the x component of the rectangle bottom corner, i.e. element\n0.\n"},
  {(char*)"SetY", PyvtkRect_IiE_SetY, 1,
   (char*)"V.SetY(int)\nC++: void SetY(const int &y)\n\nSet the y component of the rectangle bottom corner, i.e. element\n1.\n"},
  {(char*)"GetY", PyvtkRect_IiE_GetY, 1,
   (char*)"V.GetY() -> int\nC++: const int &GetY()\n\nGet the y component of the rectangle bottom corner, i.e. element\n1.\n"},
  {(char*)"Y", PyvtkRect_IiE_Y, 1,
   (char*)"V.Y() -> int\nC++: const int &Y()\n\nGet the y component of the rectangle bottom corner, i.e. element\n1.\n"},
  {(char*)"SetWidth", PyvtkRect_IiE_SetWidth, 1,
   (char*)"V.SetWidth(int)\nC++: void SetWidth(const int &width)\n\nSet the width of the rectanle, i.e. element 2.\n"},
  {(char*)"GetWidth", PyvtkRect_IiE_GetWidth, 1,
   (char*)"V.GetWidth() -> int\nC++: const int &GetWidth()\n\nGet the width of the rectangle, i.e. element 2.\n"},
  {(char*)"Width", PyvtkRect_IiE_Width, 1,
   (char*)"V.Width() -> int\nC++: const int &Width()\n\nGet the width of the rectangle, i.e. element 2.\n"},
  {(char*)"SetHeight", PyvtkRect_IiE_SetHeight, 1,
   (char*)"V.SetHeight(int)\nC++: void SetHeight(const int &height)\n\nSet the height of the rectangle, i.e. element 3.\n"},
  {(char*)"GetHeight", PyvtkRect_IiE_GetHeight, 1,
   (char*)"V.GetHeight() -> int\nC++: const int &GetHeight()\n\nGet the height of the rectangle, i.e. element 3.\n"},
  {(char*)"Height", PyvtkRect_IiE_Height, 1,
   (char*)"V.Height() -> int\nC++: const int &Height()\n\nGet the height of the rectangle, i.e. element 3.\n"},
  {NULL, NULL, 0, NULL}
};

#ifndef DECLARED_PyvtkRect_IiE_Type
extern PyTypeObject PyvtkRect_IiE_Type;
...
static PyMethodDef PyvtkRect_IiE_vtkRect_Methods[] = {
  {NULL, PyvtkRect_IiE_vtkRect_s1, 1,
   (char*)"|iiii"},
  {NULL, PyvtkRect_IiE_vtkRect_s2, 1,
   (char*)"-O *i"},
  {NULL, PyvtkRect_IiE_vtkRect_s3, 1,
   (char*)"O &vtkRect_IiE"},
  {NULL, NULL, 0, NULL}
};
...
extern PyTypeObject PyvtkRecti_Type;
...
static PyMethodDef PyvtkRecti_vtkRecti_Methods[] = {
  {NULL, PyvtkRecti_vtkRecti_s1, 1,
   (char*)"|iiii"},
  {NULL, PyvtkRecti_vtkRecti_s2, 1,
   (char*)"-O *i"},
  {NULL, PyvtkRecti_vtkRecti_s3, 1,
   (char*)"O &vtkRecti"},
  {NULL, NULL, 0, NULL}
};
...
extern PyTypeObject PyvtkRectf_Type;
...
static PyMethodDef PyvtkRectf_vtkRectf_Methods[] = {
  {NULL, PyvtkRectf_vtkRectf_s1, 1,
   (char*)"|ffff"},
  {NULL, PyvtkRectf_vtkRectf_s2, 1,
   (char*)"-O *f"},
  {NULL, PyvtkRectf_vtkRectf_s3, 1,
   (char*)"O &vtkRectf"},
  {NULL, NULL, 0, NULL}
};
...
extern PyTypeObject PyvtkRectd_Type;
...
static PyMethodDef PyvtkRectd_vtkRectd_Methods[] = {
  {NULL, PyvtkRectd_vtkRectd_s1, 1,
   (char*)"|dddd"},
  {NULL, PyvtkRectd_vtkRectd_s2, 1,
   (char*)"-O *d"},
  {NULL, PyvtkRectd_vtkRectd_s3, 1,
   (char*)"O &vtkRectd"},
  {NULL, NULL, 0, NULL}
};
