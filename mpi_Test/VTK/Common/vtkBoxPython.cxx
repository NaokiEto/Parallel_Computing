...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkBox(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkBox(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkBoxNew(const char *); }
#else
...
PyvtkBox_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkBox::SafeDownCast(temp0);
...
PyvtkBox_EvaluateFunction_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBox::EvaluateFunction(temp0);
      }
...
PyvtkBox_EvaluateFunction_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkBox::EvaluateFunction(temp0, temp1, temp2);
      }
...
PyvtkBox_IntersectBox(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(5) &&
    ...
    tempr = vtkBox::IntersectBox(temp0, temp1, temp2, temp3, temp4);
...
PyvtkBox_IntersectWithLine(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(9) &&
    ...
    tempr = vtkBox::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8);
...
static PyMethodDef PyvtkBox_Methods[] = {
  {(char*)"GetClassName", PyvtkBox_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkBox_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkBox_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkBox\nC++: vtkBox *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkBox_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkBox\nC++: vtkBox *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"EvaluateFunction", PyvtkBox_EvaluateFunction, 1,
  ...
  {(char*)"GetXMin", PyvtkBox_GetXMin, 1,
  ...
  {(char*)"SetXMax", PyvtkBox_SetXMax, 1,
  ...
  {(char*)"GetXMax", PyvtkBox_GetXMax, 1,
  ...
  {(char*)"SetBounds", PyvtkBox_SetBounds, 1,
  ...
  {(char*)"IntersectBox", PyvtkBox_IntersectBox, 1,
  ...
  {(char*)"IntersectWithLine", PyvtkBox_IntersectWithLine, 1,
