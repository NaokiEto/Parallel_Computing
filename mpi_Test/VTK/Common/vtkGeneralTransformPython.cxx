...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkGeneralTransform(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkGeneralTransform(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkGeneralTransformNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkGeneralTransformNew(const char *); }
#endif
...
PyvtkGeneralTransform_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::GetClassName();
      }
...
PyvtkGeneralTransform_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::IsA(temp0);
      }
...
PyvtkGeneralTransform_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::NewInstance();
      }
...
PyvtkGeneralTransform_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkGeneralTransform::SafeDownCast(temp0);
...
static PyMethodDef PyvtkGeneralTransform_Concatenate_Methods[] = {
  {NULL, PyvtkGeneralTransform_Concatenate_s1, 1,
   (char*)"@O *vtkMatrix4x4"},
  {NULL, PyvtkGeneralTransform_Concatenate_s2, 1,
   (char*)"@O *d"},
  {NULL, PyvtkGeneralTransform_Concatenate_s3, 1,
...
PyvtkGeneralTransform_GetNumberOfConcatenatedTransforms(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::GetNumberOfConcatenatedTransforms();
      }
...
PyvtkGeneralTransform_GetConcatenatedTransform(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::GetConcatenatedTransform(temp0);
      }
...
PyvtkGeneralTransform_GetInput(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::GetInput();
      }
...
PyvtkGeneralTransform_GetInverseFlag(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::GetInverseFlag();
      }
...
PyvtkGeneralTransform_CircuitCheck(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::CircuitCheck(temp0);
      }
...
PyvtkGeneralTransform_MakeTransform(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::MakeTransform();
      }
...
PyvtkGeneralTransform_GetMTime(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkGeneralTransform::GetMTime();
      }
...
static PyMethodDef PyvtkGeneralTransform_Methods[] = {
  {(char*)"GetClassName", PyvtkGeneralTransform_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkGeneralTransform_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkGeneralTransform_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkGeneralTransform\nC++: vtkGeneralTransform *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkGeneralTransform_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkGeneralTransform\nC++: vtkGeneralTransform *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"Identity", PyvtkGeneralTransform_Identity, 1,
  ...
  {(char*)"Inverse", PyvtkGeneralTransform_Inverse, 1,
  ...
  {(char*)"Translate", PyvtkGeneralTransform_Translate, 1,
  ...
  {(char*)"RotateWXYZ", PyvtkGeneralTransform_RotateWXYZ, 1,
  ...
  {(char*)"RotateX", PyvtkGeneralTransform_RotateX, 1,
  ...
  {(char*)"RotateY", PyvtkGeneralTransform_RotateY, 1,
   (char*)"V.RotateY(float)\nC++: void RotateY(double angle)\n\nCreate a rotation matrix about the X, Y, or Z axis and\nconcatenate it with the current transformation according to\nPreMultiply or PostMultiply semantics.  The angle is expressed in\ndegrees.\n"},
  {(char*)"RotateZ", PyvtkGeneralTransform_RotateZ, 1,
   (char*)"V.RotateZ(float)\nC++: void RotateZ(double angle)\n\nCreate a rotation matrix about the X, Y, or Z axis and\nconcatenate it with the current transformation according to\nPreMultiply or PostMultiply semantics.  The angle is expressed in\ndegrees.\n"},
  {(char*)"Scale", PyvtkGeneralTransform_Scale, 1,
  ...
  {(char*)"Concatenate", PyvtkGeneralTransform_Concatenate, 1,
  ...
  {(char*)"PreMultiply", PyvtkGeneralTransform_PreMultiply, 1,
  ...
  {(char*)"PostMultiply", PyvtkGeneralTransform_PostMultiply, 1,
  ...
  {(char*)"GetNumberOfConcatenatedTransforms", PyvtkGeneralTransform_GetNumberOfConcatenatedTransforms, 1,
  ...
  {(char*)"GetConcatenatedTransform", PyvtkGeneralTransform_GetConcatenatedTransform, 1,
   (char*)"V.GetConcatenatedTransform(int) -> vtkAbstractTransform\nC++: vtkAbstractTransform *GetConcatenatedTransform(int i)\n\n"},
  {(char*)"SetInput", PyvtkGeneralTransform_SetInput, 1,
  ...
  {(char*)"GetInput", PyvtkGeneralTransform_GetInput, 1,
   (char*)"V.GetInput() -> vtkAbstractTransform\nC++: vtkAbstractTransform *GetInput()\n\nSet the input for this transformation.  This will be used as the\nbase transformation if it is set.  This method allows you to\nbuild a transform pipeline: if the input is modified, then this\ntransformation will automatically update accordingly.  Note that\nthe InverseFlag, controlled via Inverse(), determines whether\nthis transformation will use the Input or the inverse of the\nInput.\n"},
  {(char*)"GetInverseFlag", PyvtkGeneralTransform_GetInverseFlag, 1,
  ...
  {(char*)"Push", PyvtkGeneralTransform_Push, 1,
   (char*)"V.Push()\nC++: void Push()\n\nPushes the current transformation onto the transformation stack.\n"},
  {(char*)"Pop", PyvtkGeneralTransform_Pop, 1,
   (char*)"V.Pop()\nC++: void Pop()\n\nDeletes the transformation on the top of the stack and sets the\ntop to the next transformation on the stack.\n"},
  {(char*)"InternalTransformPoint", PyvtkGeneralTransform_InternalTransformPoint, 1,
  ...
  {(char*)"InternalTransformDerivative", PyvtkGeneralTransform_InternalTransformDerivative, 1,
  ...
  {(char*)"CircuitCheck", PyvtkGeneralTransform_CircuitCheck, 1,
  ...
  {(char*)"MakeTransform", PyvtkGeneralTransform_MakeTransform, 1,
   (char*)"V.MakeTransform() -> vtkAbstractTransform\nC++: vtkAbstractTransform *MakeTransform()\n\nMake another transform of the same type.\n"},
  {(char*)"GetMTime", PyvtkGeneralTransform_GetMTime, 1,
