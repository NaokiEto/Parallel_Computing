...
#if defined(WIN32)
extern "C" { __declspec( dllexport ) void PyVTKAddFile_vtkParametricSuperEllipsoid(PyObject *, const char *); }
#else
extern "C" { void PyVTKAddFile_vtkParametricSuperEllipsoid(PyObject *, const char *); }
#endif
#if defined(WIN32)
extern "C" { __declspec( dllexport ) PyObject *PyVTKClass_vtkParametricSuperEllipsoidNew(const char *); }
#else
extern "C" { PyObject *PyVTKClass_vtkParametricSuperEllipsoidNew(const char *); }
#endif
...
PyvtkParametricSuperEllipsoid_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::GetClassName();
      }
...
PyvtkParametricSuperEllipsoid_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::IsA(temp0);
      }
...
PyvtkParametricSuperEllipsoid_NewInstance(PyObject *self, PyObject *args)
{
  ...
  vtkParametricSuperEllipsoid *tempr;
  PyObject *result = NULL;
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::NewInstance();
      }
...
PyvtkParametricSuperEllipsoid_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    tempr = vtkParametricSuperEllipsoid::SafeDownCast(temp0);
...
PyvtkParametricSuperEllipsoid_GetDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::GetDimension();
      }
...
PyvtkParametricSuperEllipsoid_GetXRadius(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::GetXRadius();
      }
...
PyvtkParametricSuperEllipsoid_GetYRadius(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::GetYRadius();
      }
...
PyvtkParametricSuperEllipsoid_GetZRadius(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::GetZRadius();
      }
...
PyvtkParametricSuperEllipsoid_GetN1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::GetN1();
      }
...
PyvtkParametricSuperEllipsoid_GetN2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::GetN2();
      }
...
PyvtkParametricSuperEllipsoid_EvaluateScalar(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    if (ap.IsBound())
      ...
      {
      tempr = op->vtkParametricSuperEllipsoid::EvaluateScalar(temp0, temp1, temp2);
      }
...
static PyMethodDef PyvtkParametricSuperEllipsoid_Methods[] = {
  {(char*)"GetClassName", PyvtkParametricSuperEllipsoid_GetClassName, 1,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkParametricSuperEllipsoid_IsA, 1,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkParametricSuperEllipsoid_NewInstance, 1,
   (char*)"V.NewInstance() -> vtkParametricSuperEllipsoid\nC++: vtkParametricSuperEllipsoid *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkParametricSuperEllipsoid_SafeDownCast, 1,
   (char*)"V.SafeDownCast(vtkObject) -> vtkParametricSuperEllipsoid\nC++: vtkParametricSuperEllipsoid *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetDimension", PyvtkParametricSuperEllipsoid_GetDimension, 1,
   (char*)"V.GetDimension() -> int\nC++: virtual int GetDimension()\n\n"},
  {(char*)"SetXRadius", PyvtkParametricSuperEllipsoid_SetXRadius, 1,
   (char*)"V.SetXRadius(float)\nC++: void SetXRadius(double a)\n\nSet/Get the scaling factor for the x-axis. Default = 1.\n"},
  {(char*)"GetXRadius", PyvtkParametricSuperEllipsoid_GetXRadius, 1,
   (char*)"V.GetXRadius() -> float\nC++: double GetXRadius()\n\nSet/Get the scaling factor for the x-axis. Default = 1.\n"},
  {(char*)"SetYRadius", PyvtkParametricSuperEllipsoid_SetYRadius, 1,
   (char*)"V.SetYRadius(float)\nC++: void SetYRadius(double a)\n\nSet/Get the scaling factor for the y-axis. Default = 1.\n"},
  {(char*)"GetYRadius", PyvtkParametricSuperEllipsoid_GetYRadius, 1,
   (char*)"V.GetYRadius() -> float\nC++: double GetYRadius()\n\nSet/Get the scaling factor for the y-axis. Default = 1.\n"},
  {(char*)"SetZRadius", PyvtkParametricSuperEllipsoid_SetZRadius, 1,
   (char*)"V.SetZRadius(float)\nC++: void SetZRadius(double a)\n\nSet/Get the scaling factor for the z-axis. Default = 1.\n"},
  {(char*)"GetZRadius", PyvtkParametricSuperEllipsoid_GetZRadius, 1,
   (char*)"V.GetZRadius() -> float\nC++: double GetZRadius()\n\nSet/Get the scaling factor for the z-axis. Default = 1.\n"},
  {(char*)"SetN1", PyvtkParametricSuperEllipsoid_SetN1, 1,
   (char*)"V.SetN1(float)\nC++: void SetN1(double a)\n\nSet/Get the \"squareness\" parameter in the z axis.  Default = 1.\n"},
  {(char*)"GetN1", PyvtkParametricSuperEllipsoid_GetN1, 1,
   (char*)"V.GetN1() -> float\nC++: double GetN1()\n\nSet/Get the \"squareness\" parameter in the z axis.  Default = 1.\n"},
  {(char*)"SetN2", PyvtkParametricSuperEllipsoid_SetN2, 1,
   (char*)"V.SetN2(float)\nC++: void SetN2(double a)\n\nSet/Get the \"squareness\" parameter in the x-y plane. Default = 1.\n"},
  {(char*)"GetN2", PyvtkParametricSuperEllipsoid_GetN2, 1,
   (char*)"V.GetN2() -> float\nC++: double GetN2()\n\nSet/Get the \"squareness\" parameter in the x-y plane. Default = 1.\n"},
  {(char*)"Evaluate", PyvtkParametricSuperEllipsoid_Evaluate, 1,
  ...
  {(char*)"EvaluateScalar", PyvtkParametricSuperEllipsoid_EvaluateScalar, 1,
