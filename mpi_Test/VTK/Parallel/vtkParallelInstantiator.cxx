...
extern vtkObject* vtkInstantiatorvtkClientServerSynchronizedRenderersNew();
...
extern vtkObject* vtkInstantiatorvtkCompositedSynchronizedRenderersNew();
...
extern vtkObject* vtkInstantiatorvtkPHardwareSelectorNew();
...
extern vtkObject* vtkInstantiatorvtkClientServerCompositePassNew();
...
extern vtkObject* vtkInstantiatorvtkSynchronizedRenderersNew();
extern vtkObject* vtkInstantiatorvtkSynchronizedRenderWindowsNew();
extern vtkObject* vtkInstantiatorvtkTreeCompositerNew();
extern vtkObject* vtkInstantiatorvtkExodusIIWriterNew();
extern vtkObject* vtkInstantiatorvtkMPICommunicatorNew();
extern vtkObject* vtkInstantiatorvtkMPIControllerNew();
...
void vtkParallelInstantiator::ClassInitialize()
{
  ...
  vtkInstantiator::RegisterInstantiator("vtkClientServerSynchronizedRenderers", vtkInstantiatorvtkClientServerSynchronizedRenderersNew);
  ...
  vtkInstantiator::RegisterInstantiator("vtkCompositedSynchronizedRenderers", vtkInstantiatorvtkCompositedSynchronizedRenderersNew);
  ...
  vtkInstantiator::RegisterInstantiator("vtkPHardwareSelector", vtkInstantiatorvtkPHardwareSelectorNew);
  ...
  vtkInstantiator::RegisterInstantiator("vtkClientServerCompositePass", vtkInstantiatorvtkClientServerCompositePassNew);
  ...
  vtkInstantiator::RegisterInstantiator("vtkSynchronizedRenderers", vtkInstantiatorvtkSynchronizedRenderersNew);
  vtkInstantiator::RegisterInstantiator("vtkSynchronizedRenderWindows", vtkInstantiatorvtkSynchronizedRenderWindowsNew);
  ...
  vtkInstantiator::RegisterInstantiator("vtkMPICommunicator", vtkInstantiatorvtkMPICommunicatorNew);
  vtkInstantiator::RegisterInstantiator("vtkMPIController", vtkInstantiatorvtkMPIControllerNew);
...
{ 
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkClientServerSynchronizedRenderers", vtkInstantiatorvtkClientServerSynchronizedRenderersNew);
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkCompositedSynchronizedRenderers", vtkInstantiatorvtkCompositedSynchronizedRenderersNew);
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkPHardwareSelector", vtkInstantiatorvtkPHardwareSelectorNew);
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkClientServerCompositePass", vtkInstantiatorvtkClientServerCompositePassNew);
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkSynchronizedRenderers", vtkInstantiatorvtkSynchronizedRenderersNew);
  vtkInstantiator::UnRegisterInstantiator("vtkSynchronizedRenderWindows", vtkInstantiatorvtkSynchronizedRenderWindowsNew);
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkMPICommunicator", vtkInstantiatorvtkMPICommunicatorNew);
  vtkInstantiator::UnRegisterInstantiator("vtkMPIController", vtkInstantiatorvtkMPIControllerNew);
